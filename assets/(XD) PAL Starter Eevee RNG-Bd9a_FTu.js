...
`,n.jsx(e.p,{children:`本教程介绍了两种在 PAL 版宝可梦 XD 中乱数初始伊布的方法。
根据你的需求选择使用哪一种：`}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:"方法 1：只使用 PAL-Pal 工具，适合找任意一只伊布（但不可预知性较高，个体可能不好）"}),`
`,n.jsx(e.li,{children:"方法 2：使用已知的异色伊布种子列表，通过初始种子乱数获取高素质个体"}),`
`]}),`
`,n.jsx(e.p,{children:"本教程默认你已了解基本的模拟器设置及 PAL XD 的初始种子乱数方法。"}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{children:`注意：本教程只适用于 PAL 版的 XD，不适用于 NTSC（美版）！
`})}),`
