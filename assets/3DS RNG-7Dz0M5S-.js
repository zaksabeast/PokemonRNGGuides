import{ic as h,j as e}from"./index-T2lIfxcP.js";const a=[{title:"HeartGold and Soulsilver 3DS RNG",navDrawerTitle:"3DS RNG",description:"Learn how to RNG using a 3DS in HeartGold and SoulSilver for shiny, high-IV Pokémon.",slug:"hgss-3ds-rng",category:"HeartGold and SoulSilver",section:"technical_info",addedOn:"2025-07-03"},{title:"Diamond, Pearl, and Platinum 3DS RNG",navDrawerTitle:"3DS RNG",description:"Learn how to RNG using a 3DS in Diamond, Pearl, and Platinum for shiny, high-IV Pokémon.",slug:"dppt-3ds-rng",category:"Diamond, Pearl, and Platinum",section:"technical_info",addedOn:"2025-07-03"}];function r(s){const n={a:"a",h2:"h2",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...h(),...s.components},{Gist:t,YouTubeTable:i}=n;return t||o("Gist"),i||o("YouTubeTable"),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:e.jsx(n.p,{children:"This page explains why NDS RNG on 3DS can be inconsistent and how to fix it."})}),`
`,e.jsx(n.h2,{children:"Video info"}),`
`,e.jsx(i,{videos:[{title:"Why 3DS RNG is Inconsistent",id:"-ayvPKWNkNw"}]}),`
...
`]})]})}function c(s={}){const{wrapper:n}={...h(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}function o(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default,a as frontmatter};
