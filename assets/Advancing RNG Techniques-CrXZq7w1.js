...
- Advances before painting: Advances to the RNG state before doing the Painting Reseeding technique
...
- Advances before painting: 44,572 (which sets RNG state to 99,966,396 advances)
...
After performing it, players need to validate whether they successfully hit their target advances before painting. If succesful, players then create a Battle Video to save and restore their RNG state in case they miss their target advances after painting for the Pokémon encounter. Battle Video can also be used to help the target advances before painting.

Here's an example to understand Painting Reseeding with Battle Video for the target advance 100,000,000, which has "Advances before painting: 44,572" and "Advances after painting: 33,604".

1.  You wait 10.5 minutes (~42K advances), then create a Battle Video.
1.  You go in front of the painting.
1.  You watch your Battle Video. The RNG state is now at ~42K advances.
1.  You wait 0.5 minutes and try to perform Painting Reseeding at advance 44,572.
1.  You fly to Victory Road and catch a Pokemon. Based on the Pokémon stats, you determine whether you hit the target advances before painting. (Whether the caught Pokemon exists near the RNG advance 99,966,396).
1.  If you failed, you calibrate, and go back to step 2.
1.  If you succeed to hit your target advances before painting, you wait until the advance is close to the target (ex: ~99,998,000), and make a new Battle Video.
1.  You go to the map where you want to encounter your wanted Pokémon.
