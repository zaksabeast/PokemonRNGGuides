...
`,t.jsx(e.li,{children:"Frames before painting: Visual frames before doing the Painting Reseeding technique"}),`
...
`,t.jsxs(e.ul,{children:[`
`,t.jsx(e.li,{children:"Frames before painting: 44,572 (which sets RNG state to 99,966,396 advances)"}),`
...
`,t.jsx(e.p,{children:"After performing it, players need to validate whether they successfully hit their target frames before painting. If succesful, players then create a Battle Video to save and restore their RNG state in case they miss their target advances after painting for the Pokémon encounter. Note that the Battle Video can't also be used to speed up hitting the target frames before painting, because Battle Video only alters the RNG state, not the frame counter."}),`
`,t.jsx(e.p,{children:`Here's an example to understand Painting Reseeding with Battle Video for the target advance 100,000,000, which has "Frames before painting: 44,572" and "Advances after painting: 33,604".`}),`
`,t.jsxs(e.ol,{children:[`
`,t.jsx(e.li,{children:"You go in front of the painting."}),`
`,t.jsx(e.li,{children:"You wait ~12 minutes and try to perform Painting Reseeding at frame 44,572."}),`
`,t.jsx(e.li,{children:"You fly to Victory Road and catch a Pokemon. Based on the Pokémon stats, you determine whether you hit the target frames before painting. (Whether the caught Pokemon exists near the RNG advance 99,966,396)."}),`
`,t.jsx(e.li,{children:"If you failed, you calibrate, and go back to step 1."}),`
`,t.jsx(e.li,{children:"If you succeed to hit your target frames before painting, you wait until the advance is close to the target (ex: ~99,998,000), and make a Battle Video."}),`
`,t.jsx(e.li,{children:"You go to the map where you want to encounter your wanted Pokémon."}),`
...
`]}),`
`,t.jsxs(e.p,{children:["Check out the ",t.jsx(e.a,{href:"/emerald-painting-rng",children:"Painting Reseeding detailed guide and webtool"}),"."]}),`
`,t.jsx(e.h2,{children:"Credits"}),`
`,t.jsxs(e.ul,{children:[`
`,t.jsx(e.li,{children:"German translation: Parasite."}),`
`]})]})}function h(n={}){const{wrapper:e}={...o(),...n.components};return e?t.jsx(e,{...n,children:t.jsx(i,{...n})}):i(n)}function s(n,e){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,d as frontmatter};
