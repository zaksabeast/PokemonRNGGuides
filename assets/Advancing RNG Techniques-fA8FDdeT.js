import{w as r,j as n}from"./index-BKW_koWY.js";const u=[{title:"Übersicht der RNG-Advancing-Techniken",navDrawerTitle:"Übersicht der RNG-Advancing-Techniken",description:"Verständnis der wichtigsten Konzepte zur Beschleunigung von RNG-Manipulationen mit Painting Reseeding und Kampfaufzeichnungs-Reseeding.",slug:"de-emerald-advancing-rng-techniques",translation:{enSlug:"emerald-advancing-rng-techniques",language:"de"}}];function s(i){const e={a:"a",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...r(),...i.components},{Gist:d}=e;return d||t("Gist"),n.jsxs(n.Fragment,{children:[n.jsx(d,{children:n.jsx(e.p,{children:`Gist: Verständnis der wichtigsten Konzepte zur Beschleunigung von
