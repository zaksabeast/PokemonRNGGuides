import{ga as i,j as e}from"./index-uFjPzSoK.js";const s={title:"Advancing the RNG in HeartGold and SoulSilver",navDrawerTitle:"Advancing the RNG",description:"Learn how to advance the RNG in HeartGold and SoulSilver. This guide explains different methods like Chatot chatters, radio, and NPC actions.",slug:"hgss-rng-advance",category:"HeartGold and SoulSilver",section:"guide",variant:["retail","cfw-emu"],guideKey:"advance-rng"};function t(a){const n={code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...i(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"This explains how the RNG can be advanced and influenced in HeartGold and SoulSilver. The preferred method to advance the RNG is using Chatot or the Radio, but there are other methods if those are unavailable."}),`
