import{u as s,j as e}from"./index-CdUmV78P.js";const o={title:"Advancing the RNG",description:"The different methods the RNG can be advanced and events that influence the RNG",slug:"dppt-advance-rng",subCategory:"Basic Knowledge",tag:"any"};function a(t){const n={code:"code",h2:"h2",img:"img",li:"li",p:"p",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"This explains the different ways to advance the RNG in Diamond, Pearl, and Platinum. The best methods are using Chatot or the Journal, but there are other options if those are not available."}),`
...
`]})]})}function i(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{i as default,o as frontmatter};
