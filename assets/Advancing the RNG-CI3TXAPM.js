import{u as t,j as e}from"./index-DOVRflpI.js";const o=[{title:"Advancing the RNG in Diamond, Pearl, and Platinum",navDrawerTitle:"Advancing the RNG",description:"The different methods the RNG can be advanced and events that influence the RNG",slug:"dppt-advance-rng",category:"Diamond, Pearl, and Platinum",tag:"any"},{title:"乱数的帧数推进方法",description:"推进乱数帧数的不同方法及影响帧数的事件机制",slug:"zh-dppt-advance-rng",category:"Diamond, Pearl, and Platinum",tag:"any",translation:{enSlug:"dppt-advance-rng",language:"zh"}}];function a(i){const n={code:"code",h2:"h2",img:"img",li:"li",p:"p",ul:"ul",...t(),...i.components},{ShowIf:s}=n;return s||r("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(s,{slug:"/dppt-advance-rng",children:[e.jsx(n.p,{children:"This explains the different ways to advance the RNG in Diamond, Pearl, and Platinum. The best methods are using Chatot or the Journal, but there are other options if those are not available."}),e.jsx(n.h2,{children:"Chatot Chatter"}),e.jsxs(n.ul,{children:[`
...
`]})]})]})}function h(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}function r(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,o as frontmatter};
