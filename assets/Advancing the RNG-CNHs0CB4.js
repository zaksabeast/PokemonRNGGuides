import{ga as s,j as e}from"./index-C0QdZ5Ks.js";const r=[{title:"Advancing the RNG in Diamond, Pearl, and Platinum",navDrawerTitle:"Advancing the RNG",description:"Learn how to advance the RNG in Diamond, Pearl, and Platinum. This guide explains different methods like journal flips, Chatot chatters, and NPC actions.",slug:"dppt-advance-rng",category:"Diamond, Pearl, and Platinum",section:"info"}];function t(a){const n={code:"code",h2:"h2",img:"img",li:"li",p:"p",ul:"ul",...s(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"This explains the different ways to advance the RNG in Diamond, Pearl, and Platinum. The best methods are using Chatot or the Journal, but there are other options if those are not available."}),`
...
`]})]})}function o(a={}){const{wrapper:n}={...s(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(t,{...a})}):t(a)}export{o as default,r as frontmatter};
