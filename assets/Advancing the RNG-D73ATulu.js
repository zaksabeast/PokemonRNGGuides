import{w as s,j as n}from"./index-BmhIYDEc.js";const c={title:"推进乱数",description:"乱数推进的方法及影响乱数的机制",slug:"zh-hgss-rng-advance",translation:{enSlug:"hgss-rng-advance",language:"zh"}};function e(i){const l={code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(l.p,{children:"本教程介绍了在《心金 / 魂银》中帧数的推进方式及影响乱数的因素。推荐的方法是使用聒噪鸟或收音机，但如果无法使用这些方法，也有其他方式可以推进帧数。"}),`
