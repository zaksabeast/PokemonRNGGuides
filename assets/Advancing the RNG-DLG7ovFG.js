import{u as l,j as e}from"./index-CUhmAcZS.js";const h=[{title:"Advancing the RNG",description:"The different methods the RNG can be advanced and events that influence the RNG",slug:"dppt-advance-rng",category:"Diamond, Pearl, and Platinum",tag:"any"},{title:"乱数的帧数推进方法",description:"推进乱数帧数的不同方法及影响帧数的事件机制",slug:"zh-dppt-advance-rng",category:"Diamond, Pearl, and Platinum",tag:"any",hideFromNavDrawer:!0}];function a(i){const n={code:"code",h2:"h2",img:"img",li:"li",p:"p",ul:"ul",...l(),...i.components},{LanguageButton:t,ShowIf:s}=n;return t||r("LanguageButton"),s||r("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsx(t,{enSlug:"/dppt-advance-rng",zhSlug:"/zh-dppt-advance-rng"}),`
`,e.jsxs(s,{slug:"/dppt-advance-rng",children:[e.jsx(n.p,{children:"This explains the different ways to advance the RNG in Diamond, Pearl, and Platinum. The best methods are using Chatot or the Journal, but there are other options if those are not available."}),e.jsx(n.h2,{children:"Chatot Chatter"}),e.jsxs(n.ul,{children:[`
...
`]})]}),`
`,e.jsxs(s,{slug:"/zh-dppt-advance-rng",children:[e.jsx(n.p,{children:"本文阐述《宝可梦 钻石/珍珠/白金》中推进乱数帧数的多种方法。其中使用聒噪鸟或冒险笔记最为高效，但如果这些方法不可用，还有其他替代方案。"}),e.jsx(n.h2,{children:"聒噪鸟叫声"}),e.jsxs(n.ul,{children:[`
...
`]})]})]})}function d(i={}){const{wrapper:n}={...l(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}function r(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as default,h as frontmatter};
