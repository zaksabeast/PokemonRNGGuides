import{u as l,j as e}from"./index-ojmfz2wl.js";const h=[{title:"Advancing the RNG",description:"The different methods the RNG can be advanced and events that influence the RNG",slug:"dppt-advance-rng",subCategory:"Basic Knowledge",tag:"any"},{title:"乱数的帧数推进方法",description:"推进乱数帧数的不同方法及影响帧数的事件机制",slug:"zh-dppt-advance-rng",tag:"any",hideFromNavDrawer:!0}];function r(s){const n={code:"code",h2:"h2",img:"img",li:"li",p:"p",ul:"ul",...l(),...s.components},{LanguageButton:t,ShowIf:i}=n;return t||a("LanguageButton"),i||a("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsx(t,{enSlug:"/dppt-advance-rng",zhSlug:"/zh-dppt-advance-rng"}),`
`,e.jsxs(i,{slug:"/dppt-advance-rng",children:[e.jsx(n.p,{children:"This explains the different ways to advance the RNG in Diamond, Pearl, and Platinum. The best methods are using Chatot or the Journal, but there are other options if those are not available."}),e.jsx(n.h2,{children:"Chatot Chatter"}),e.jsxs(n.ul,{children:[`
...
`]})]}),`
`,e.jsxs(i,{slug:"/zh-dppt-advance-rng",children:[e.jsx(n.p,{children:"本文阐述《宝可梦 钻石/珍珠/白金》中推进乱数帧数的多种方法。其中使用聒噪鸟或冒险笔记最为高效，但如果这些方法不可用，还有其他替代方案。"}),e.jsx(n.h2,{children:"聒噪鸟叫声"}),e.jsxs(n.ul,{children:[`
...
`]})]})]})}function d(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}function a(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as default,h as frontmatter};
