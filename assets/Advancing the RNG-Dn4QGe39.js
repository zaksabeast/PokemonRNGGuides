import{u as a,j as e}from"./index-D-8zJ8GY.js";const o=[{title:"Advancing the RNG",description:"The different methods the RNG can be advanced and events that influence the RNG",slug:"dppt-advance-rng",category:"Diamond, Pearl, and Platinum",tag:"any"},{title:"乱数的帧数推进方法",description:"推进乱数帧数的不同方法及影响帧数的事件机制",slug:"zh-dppt-advance-rng",category:"Diamond, Pearl, and Platinum",tag:"any",translation:{enSlug:"dppt-advance-rng",language:"zh"}}];function t(s){const n={code:"code",h2:"h2",img:"img",li:"li",p:"p",ul:"ul",...a(),...s.components},{ShowIf:i}=n;return i||r("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(i,{slug:"/dppt-advance-rng",children:[e.jsx(n.p,{children:"This explains the different ways to advance the RNG in Diamond, Pearl, and Platinum. The best methods are using Chatot or the Journal, but there are other options if those are not available."}),e.jsx(n.h2,{children:"Chatot Chatter"}),e.jsxs(n.ul,{children:[`
...
`]})]})]})}function h(s={}){const{wrapper:n}={...a(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}function r(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,o as frontmatter};
