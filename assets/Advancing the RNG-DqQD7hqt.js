import{t as e}from"./jsx-runtime-DE3yYTa1.js";import{d as t}from"./index-apNQcKw8.js";var n=e(),r=[{title:`Avanzar el RNG en Diamante, Perla y Platino`,navDrawerTitle:`Avanzar el RNG`,description:`Aprende cómo avanzar el RNG en Diamante, Perla y Platino. Esta guía explica diferentes métodos como pasar páginas del diario, los “chatters” de Chatot y las acciones de los NPC.`,slug:`es-dppt-advance-rng`,translation:{enSlug:`dppt-advance-rng`,language:`es`}}];function i(e){let r={a:`a`,code:`code`,h2:`h2`,img:`img`,li:`li`,p:`p`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.p,{children:`Esto explica las diferentes formas de avanzar el RNG en Diamante, Perla y Platino. Los mejores métodos son usar a Chatot o el diario, pero hay otras opciones si no están disponibles.`}),`
