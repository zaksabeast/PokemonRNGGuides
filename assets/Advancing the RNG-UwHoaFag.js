import{u as l,j as e}from"./index-BW1P0pDd.js";const h=[{title:"Advancing the RNG",description:"The different methods the RNG can be advanced and events that influence the RNG",slug:"dppt-advance-rng",subCategory:"Basic Knowledge",tag:"any"},{title:"乱数的帧数推进方法",description:"推进乱数帧数的不同方法及影响帧数的事件机制",slug:"zh-dppt-advance-rng",tag:"any",hideFromNavDrawer:!0}];function r(s){const n={code:"code",h2:"h2",img:"img",li:"li",p:"p",ul:"ul",...l(),...s.components},{LanguageButton:t,ShowIf:i}=n;return t||a("LanguageButton"),i||a("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsx(t,{enSlug:"/dppt-advance-rng",zhSlug:"/zh-dppt-advance-rng"}),`
