import{u as i,j as e}from"./index-Df4k8dKg.js";const s={title:"Advancing the RNG in HeartGold and SoulSilver",navDrawerTitle:"Advancing the RNG",description:"The different methods the RNG can be advanced and events that influence the RNG",slug:"hgss-rng-advance",category:"HeartGold and SoulSilver",tag:"any"};function t(a){const n={code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",...i(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"This explains how the RNG can be advanced and influenced in HeartGold and SoulSilver. The preferred method to advance the RNG is using Chatot or the Radio, but there are other methods if those are unavailable."}),`
