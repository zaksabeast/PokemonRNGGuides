import{A as s,j as n}from"./index-CMpSM2Kx.js";const c=[{title:"乱数的帧数推进方法",description:"推进乱数帧数的不同方法及影响帧数的事件机制",slug:"zh-dppt-advance-rng",translation:{enSlug:"dppt-advance-rng",language:"zh"}}];function e(i){const l={h2:"h2",img:"img",li:"li",p:"p",ul:"ul",...s(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(l.p,{children:"本文阐述《宝可梦 钻石/珍珠/白金》中推进乱数帧数的多种方法。其中使用聒噪鸟或冒险笔记最为高效，但如果这些方法不可用，还有其他替代方案。"}),`
