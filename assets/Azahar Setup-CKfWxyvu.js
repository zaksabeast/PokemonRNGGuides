...
6. Exit GodMode9 and copy the files in \`/gm9/out\` to your computer.
...
5. Exit GodMode9 and transfer files from \`/gm9/out\` to your computer.
...
7. Exit GodMode9 and copy the files in \`/gm9/out\` to your computer.
...
4. Install both the game and update \`.cia\` files.
