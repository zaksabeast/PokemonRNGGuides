import{x as d,j as e}from"./index-DS5oTPfz.js";const r={title:"Azahar Setup - Install Pokemon CIAs",navDrawerTitle:"Azahar Setup",description:"Learn how to dump and install Pokemon CIAs on Azahar.",slug:"azahar-setup",category:"3DS Tools",tag:"emu",hideFromNavDrawer:!0};function l(s){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...d(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"This guide helps you install Pokemon CIAs on Azahar. You need an updated Custom Firmware 3DS console to dump the CIA from a cartridge or digitally purchased game."}),`
