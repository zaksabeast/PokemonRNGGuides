import{u as s,j as e}from"./index-Dqb6kI9x.js";const l={title:"Set up Yuzu/Ryujinx & CheatEngine",description:"How to set up Yuzu/Ryujinx and Cheat Engine to RNG in Brilliant Diamond and Shining Pearl using lua scripts.",slug:"bdsp-emulator-setup",category:"Brilliant Diamond and Shining Pearl",isRoughDraft:!0,tag:"emu"};function i(t){const n={a:"a",code:"code",h2:"h2",li:"li",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
