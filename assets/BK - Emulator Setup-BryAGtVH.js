import{ic as s,j as e}from"./index-oHVXayJ2.js";const o={title:"How to set up Ryujinx & CheatEngine",navDrawerTitle:"Ryujinx Set Up",description:"How to set up Ryujinx or Yuzu and Cheat Engine to RNG in Brilliant Diamond and Shining Pearl using lua scripts.",slug:"bdsp-emulator-setup",category:"Brilliant Diamond and Shining Pearl",section:"tool"};function t(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsxs(n.p,{children:["Try to RNG for a shiny starter or legendary! ",e.jsx(n.a,{href:"/cfw-bdsp-stationary",children:"BDSP Static RNG Guide"})]})]})}function r(i={}){const{wrapper:n}={...s(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{r as default,o as frontmatter};
