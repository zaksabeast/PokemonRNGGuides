import{u as r,j as e}from"./index-B1VKQ_Ga.js";const s={title:"PokeFinder Setup",description:"How to set up PokeFinder to RNG in Brilliant Diamond and Shining Pearl",slug:"bdsp-pokefinder",category:"Brilliant Diamond and Shining Pearl",tag:"any"};function o(i){const n={a:"a",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsxs(n.li,{children:["For Custom Firmware use ",e.jsx(n.a,{href:"https://www.pokemonrng.com/install-capturesight",children:"CaptureSight"})]}),`
`]}),`
