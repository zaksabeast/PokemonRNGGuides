import{u as t,j as e}from"./index-VB2BNfLm.js";const s={title:"PokeFinder Setup",description:"How to set up PokeFinder to RNG in Brilliant Diamond and Shining Pearl",slug:"bdsp-pokefinder",subCategory:"Basic Knowledge",isRoughDraft:!0};function o(i){const n={a:"a",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`]})]})}function l(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(o,{...i})}):o(i)}export{l as default,s as frontmatter};
