import{u as o,j as e}from"./index-B7H-cgmt.js";const r={title:"How to Use Chatot",description:"How to use the chatot.pokemonrng.com website for RNG in BDSP",slug:"bdsp-chatot",subCategory:"Basic Knowledge",isRoughDraft:!0,tag:"any"};function s(n){const t={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...o(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"This guide will help you use the Chatot website to set up RNG Abuse in Brilliant Diamond and Shining Pearl."}),`
...
`,e.jsx(t.p,{children:"Now you're ready to advance your frames and complete your RNG!"})]})}function a(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}export{a as default,r as frontmatter};
