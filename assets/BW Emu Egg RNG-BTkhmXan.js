import{ii as r,j as e}from"./index-CXw3cuDA.js";const a=[{title:"Black and White Egg RNG",navDrawerTitle:"Egg RNG",description:"Learn how to RNG eggs from the Daycare in Black and White for shiny, high-IV Pokémon.",slug:"emu-bw-egg",category:"Black and White",section:"pokemon_rng",variant:"cfw-emu",guideKey:"egg",addedOn:"2026-03-24"}];function t(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
