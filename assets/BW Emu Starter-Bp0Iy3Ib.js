import{w as i,j as e}from"./index-m1a04MGk.js";const a=[{title:"Black and White Starter RNG",navDrawerTitle:"Starter RNG",description:"Learn how to RNG starters in Black and White for shiny, high-IV Pokémon.",slug:"bw-emu-starter",category:"Black and White",section:"pokemon_rng",variant:"cfw-emu",guideKey:"starter",addedOn:"2026-03-25"}];function r(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
