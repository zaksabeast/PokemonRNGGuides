import{u as r,j as e}from"./index-CONmjEDC.js";const a={title:"Egg RNG",description:"How to RNG egg in BW2 based on the recent discoveries",slug:"bw2-egg",category:"Black 2 and White 2",tag:"any"};function i(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`})}),`
`,e.jsx(n.p,{children:"You should now have the egg with everything you wanted!"})]})}function l(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{l as default,a as frontmatter};
