import{g9 as r,j as e}from"./index-1b6yQU6r.js";const l=[{title:"Black 2 and White 2 Egg RNG",navDrawerTitle:"Egg RNG",description:"Learn how to RNG eggs from the Daycare in Black 2 and White 2 for shiny, high-IV Pokémon.",slug:"bw2-egg",category:"Black 2 and White 2",section:"pokemon_rng",variant:["retail","cfw-emu"],guideKey:"egg"}];function i(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
