import{ih as r,j as n}from"./index-DGbmpVsq.js";const l={title:"乱数介绍",description:"如何推进乱数以及提高稳定性的技巧",slug:"zh-e-tips-rng",translation:{enSlug:"e-tips-rng",language:"zh"}};function i(s){const e={a:"a",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...r(),...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"生成方式"}),`
...
`,n.jsxs(e.p,{children:["绘画乱数是一种极佳的方法，可以获得任意所需的初始种子。这是一项更高级的技巧，具体内容请参考",n.jsx(e.a,{href:"/emerald-painting-rng",children:"本教程"}),"。"]}),`
...
`]})]})}function t(s={}){const{wrapper:e}={...r(),...s.components};return e?n.jsx(e,{...s,children:n.jsx(i,{...s})}):i(s)}export{t as default,l as frontmatter};
