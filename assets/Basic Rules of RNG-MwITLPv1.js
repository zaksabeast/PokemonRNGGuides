import{ih as a,j as e}from"./index-C_tA-Z0O.js";const r={title:"Emerald RNG Info",navDrawerTitle:"RNG Info",description:"Learn how to advance the RNG and improve stability in Pokemon Emerald for consistent results.",slug:"e-tips-rng",category:"Emerald",section:"rng_technique",variant:["retail","cfw-emu"]};function i(t){const n={a:"a",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"RNG Methods"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"For stationary Pokemon: Method 1."}),`
`,e.jsx(n.li,{children:"For wild encounters: Method H-2."}),`
`]}),`
`,e.jsxs(n.p,{children:["The different methods for wild encounters are caused by ",e.jsx(n.a,{href:"/gba-vblank",children:"vblank"}),", though H-2 is the most commonly seen."]}),`
...
`,e.jsx(n.p,{children:"Being in battle advances RNG twice as fast. This is particularly helpful for wild Pokemon RNG."}),`
...
`]})]})}function l(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{l as default,r as frontmatter};
