import{u as l,j as e}from"./index-xbVE49t9.js";const r={title:"How to Install CaptureSight",description:"Installing a tool on your Switch to help RNG Pokemon",slug:"install-capturesight",category:"Tools and Emulators",tag:"cfw"};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",ul:"ul",...l(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`]}),`
`]}),`
`]})]})}function o(t={}){const{wrapper:n}={...l(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{o as default,r as frontmatter};
