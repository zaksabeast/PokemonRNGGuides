import{u as i,j as e}from"./index-D0Qe-G4V.js";const r={title:"How to Install CaptureSight",description:"Installing a tool on your Switch to help RNG Pokemon",slug:"install-capturesight",subCategory:"Switch"};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["If you see this error, you are not using Atmosphere (the Custom Firmware) or it is not installed correctly. Follow ",e.jsx(n.a,{href:"https://switchgui.de/switch-guide/extras/updating/",children:"this guide"})," to update Atmosphere to the latest version."]}),`
`]}),`
