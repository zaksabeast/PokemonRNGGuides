import{u as d,j as e}from"./index-BcYYhHNf.js";const a={title:"Celebi",description:"How to get a shiny Fairy",slug:"gen2-celebi",subCategory:"Emulator",tag:"cfw",addedOn:"2025-03-02"};function l(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",pre:"pre",strong:"strong",ul:"ul",...d(),...t.components},{Alert:i,Gen2StarterRng:s,YouTubeVideo:r}=n;return i||o("Alert"),s||o("Gen2StarterRng"),r||o("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(i,{showIcon:!0,type:"warning",message:"Highly experimental!",description:"Gen 2 RNG is still in its early days. Expect to need multiple attempts!"}),`
...
`,e.jsx(s,{type:"celebi"})]})}function h(t={}){const{wrapper:n}={...d(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(l,{...t})}):l(t)}function o(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,a as frontmatter};
