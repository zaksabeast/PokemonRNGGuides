import{u as d,j as e}from"./index-iu2Cn0za.js";const a={title:"Celebi",description:"How to get a shiny Fairy",slug:"gen2-celebi",subCategory:"Emulator",tag:"cfw",addedOn:"2025-03-02"};function l(o){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",pre:"pre",strong:"strong",ul:"ul",...d(),...o.components},{Alert:i,Gen2PokemonRng:s,YouTubeVideo:r}=n;return i||t("Alert"),s||t("Gen2PokemonRng"),r||t("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(i,{showIcon:!0,type:"warning",message:"Highly experimental!",description:"Gen 2 RNG is still in its early days. Expect to need multiple attempts!"}),`
...
`,e.jsx(s,{type:"celebi"})]})}function h(o={}){const{wrapper:n}={...d(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(l,{...o})}):l(o)}function t(o,n){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,a as frontmatter};
