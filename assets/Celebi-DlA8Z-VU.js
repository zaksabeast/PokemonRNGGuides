import{u as d,j as e}from"./index-DDwjI0CZ.js";const c={title:"Celebi",description:"How to get a shiny Fairy",slug:"gen2-celebi",subCategory:"Emulator",tag:"cfw",addedOn:"2025-03-02"};function l(o){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",pre:"pre",strong:"strong",ul:"ul",...d(),...o.components},{Alert:t,Gen2PokemonRng:s,YouTubeVideo:r}=n;return t||i("Alert"),s||i("Gen2PokemonRng"),r||i("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(t,{showIcon:!0,type:"warning",message:"Highly experimental!",description:"Gen 2 RNG is still in its early days. Expect to need multiple attempts!"}),`
...
`,e.jsx(r,{src:"https://www.youtube.com/embed/wTpI7MV_f4U?si=0qF9bFb0HrDyv2zw"}),`
...
`,e.jsx(s,{type:"celebi",language:"en"}),`
...
`]})]})}function h(o={}){const{wrapper:n}={...d(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(l,{...o})}):l(o)}function i(o,n){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,c as frontmatter};
