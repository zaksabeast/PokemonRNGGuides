import{bF as t,j as e}from"./index-DXZ5ShUP.js";const r={title:"(PAL) Channel RNG",description:"Step-by-step guide to RNG the Channel Jirachi.",slug:"channel-jirachi",category:"Gamecube",tag:"emu"};function a(i){const n={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:'Note: If you see "Reload Menu," go to Options and press `B`.\n'})})]})}function s(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}export{s as default,r as frontmatter};
