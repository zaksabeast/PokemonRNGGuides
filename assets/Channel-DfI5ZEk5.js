import{ii as r,j as n}from"./index-CLgpAzd3.js";const h={title:"(PAL) Channel 乱数",description:"一步步教你乱数出 Channel 基拉祈",slug:"zh-channel-jirachi",translation:{enSlug:"channel-jirachi",language:"zh"}};function l(i){const e={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
...
`,n.jsx(e.p,{children:"在第三世代中，有两种方式能获取基拉祈：Wishmaker（美版 Bonus Disc）和 Channel（欧版 Bonus Disc）。Wishmaker 的乱数较简单，但能获取的个体值组合较少。本教程聚焦于通过 PAL 欧版 Channel 获取基拉祈，使用 Dolphin 模拟器配合更新后的工具简化流程。本教程默认你已掌握 GameCube 初始种子乱数的基础知识，特别是如何命中初始种子。"}),`
...
`]})]})}function c(i={}){const{wrapper:e}={...r(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(l,{...i})}):l(i)}export{c as default,h as frontmatter};
