import{u as d,j as e}from"./index-DPL8gWl_.js";const r={title:"3DS Emulator Setup (Azahar/Lime3DS/Citra)",description:"Setup a 3DS emulator for RNG",slug:"citrarng-setup",subCategory:"3DS",tag:"emu"};function s(l){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...d(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"This guide helps you set up a 3DS emulator to RNG on a PC. You need an updated Custom Firmware 3DS console to dump the game data."}),`
