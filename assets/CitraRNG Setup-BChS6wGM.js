import{ic as i,j as e}from"./index-oHVXayJ2.js";const r={title:"3DS Emulator Setup (Azahar/Lime3DS/Citra)",navDrawerTitle:"Azahar Setup",description:"Set up Azahar, Lime3DS, or Citra for 3DS RNG, including cart dumping and installing game updates.",slug:"citrarng-setup",category:"3DS Tools",section:"tool"};function s(l){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...i(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"This guide helps you set up a 3DS emulator to RNG on a PC. You need an updated Custom Firmware 3DS console to dump the game data."}),`
...
`,e.jsxs(n.p,{children:["Follow the ",e.jsx(n.a,{href:"/install-pokereader-emu",children:"install PokeReader guide"}),"."]})]})}function t(l={}){const{wrapper:n}={...i(),...l.components};return n?e.jsx(n,{...l,children:e.jsx(s,{...l})}):s(l)}export{t as default,r as frontmatter};
