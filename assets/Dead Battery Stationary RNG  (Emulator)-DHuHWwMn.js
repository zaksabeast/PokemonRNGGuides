import{u as t,j as e}from"./index-ufF5IZ5h.js";const o={title:"Dead Battery Stationary RNG",description:"Dead Battery Stationary RNG",slug:"emulator-rs-dead-battery-stationary",subCategory:"Emulator",isRoughDraft:!0};function i(r){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"You can refer to my FRLG guide for most of the content. This guide is BEFORE the update with Real's scripts."}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://github.com/TASVideos/vba-rerecording/releases",children:"VBA-RR"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://github.com/Admiral-Fish/PokeFinder/releases",children:"PokeFinder"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://pokerng.forumcommunity.net/?t=56443955&p=396434940",children:"The Ruby/Sapphire Lua Scripts for your language"}),", password is ",e.jsx(n.code,{children:"allyouneedisnoob"}),"."]}),`
`]}),`
`,e.jsx(n.hr,{}),`
