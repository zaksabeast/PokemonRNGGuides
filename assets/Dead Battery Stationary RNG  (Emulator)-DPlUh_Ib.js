import{g5 as t,j as e}from"./index-DDYWERCb.js";const o={title:"Ruby and Sapphire Dead Battery Static RNG",navDrawerTitle:"Static Dead Battery RNG",description:"Learn how to RNG static Pokémon in Ruby and Sapphire for perfect IVs, natures, and shinies.",slug:"emulator-rs-dead-battery-stationary",category:"Ruby and Sapphire",isRoughDraft:!0,tag:"emu"};function i(r){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"You can refer to my FRLG guide for most of the content. This guide is BEFORE the update with Real's scripts."}),`
