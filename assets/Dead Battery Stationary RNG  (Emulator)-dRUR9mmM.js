import{u as i,j as e}from"./index-C0BzNlYd.js";const o={title:"Ruby and Sapphire Dead Battery Stationary RNG",navDrawerTitle:"Stationary Dead Battery RNG",description:"Dead Battery Stationary RNG",slug:"emulator-rs-dead-battery-stationary",subCategory:"Emulator",isRoughDraft:!0,tag:"emu"};function t(r){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"You can refer to my FRLG guide for most of the content. This guide is BEFORE the update with Real's scripts."}),`
...
`]}),`
`]}),`
`,e.jsx(n.p,{children:"![](pic of the pokemon)"})]})}function l(r={}){const{wrapper:n}={...i(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{l as default,o as frontmatter};
