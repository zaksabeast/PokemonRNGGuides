import{t as e}from"./jsx-runtime-MrBVUj-r.js";import{d as t}from"./index--csf9qTw.js";var n=e(),r={title:`设置 Desmume`,description:`学习如何设置用于乱数操作的 DeSmuME，包括游戏卡带提取、存档导出以及 Lua 脚本的使用。`,slug:`zh-desmume-setup`,translation:{enSlug:`desmume-setup`,language:`zh`}};function i(e){let r={a:`a`,code:`code`,h2:`h2`,h3:`h3`,img:`img`,li:`li`,ol:`ol`,p:`p`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.p,{children:`本教程将帮助你在 Windows 电脑上设置 DeSmuME 模拟器。Mac 与 Linux 用户可尝试使用 Wine 运行 DeSmuME.exe，但该方法不一定有效。导出 DS 游戏数据需要一台已刷入最新版 CFW（自定义固件）的 3DS 主机。目前也存在其他导出 DS 游戏的方法，但本教程不作介绍。`}),`
