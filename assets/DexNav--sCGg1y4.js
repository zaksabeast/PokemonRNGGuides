import{ig as r,j as e}from"./index-BSl5j9_V.js";const i={title:"Omega Ruby and Alpha Sapphire DexNav RNG",navDrawerTitle:"DexNav RNG",description:"Learn how to RNG Pokémon using the DexNav feature in Omega Ruby and Alpha Sapphire.",slug:"emulator-oras-dexnav",category:"Omega Ruby and Alpha Sapphire",isRoughDraft:!0,section:"pokemon_rng",variant:"cfw-emu"};function a(n){const t={code:"code",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Tools"}),`
...
`,e.jsx(t.p,{children:"If this happens, write down the IVs and compare the delay with the one you’ve got. Adjust the delay, reload the save state, and repeat. You should eventually get your encounter. If not, keep adjusting."}),`
`,e.jsx(t.h2,{children:"Credits"}),`
`,e.jsxs(t.ul,{children:[`
`,e.jsx(t.li,{children:"Chinese translation: xuanyelin, Hakuhiro."}),`
`]})]})}function s(n={}){const{wrapper:t}={...r(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(a,{...n})}):a(n)}export{s as default,i as frontmatter};
