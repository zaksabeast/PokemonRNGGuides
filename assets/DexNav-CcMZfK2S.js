import{ga as r,j as e}from"./index-DJpXE56Z.js";const i={title:"Omega Ruby and Alpha Sapphire DexNav RNG",navDrawerTitle:"DexNav RNG",description:"Learn how to RNG Pokémon using the DexNav feature in Omega Ruby and Alpha Sapphire.",slug:"emulator-oras-dexnav",category:"Omega Ruby and Alpha Sapphire",isRoughDraft:!0,section:"pokemon_rng",variant:"cfw-emu"};function n(a){const t={code:"code",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...r(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Tools"}),`
...
`,e.jsx(t.p,{children:"If this happens, write down the IVs and compare the delay with the one you’ve got. Adjust the delay, reload the save state, and repeat. You should eventually get your encounter. If not, keep adjusting."})]})}function s(a={}){const{wrapper:t}={...r(),...a.components};return t?e.jsx(t,{...a,children:e.jsx(n,{...a})}):n(a)}export{s as default,i as frontmatter};
