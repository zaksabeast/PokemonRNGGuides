import{ih as i,j as n}from"./index-DGbmpVsq.js";const h=[{title:"第五世代AR搜寻器乱数",description:"乱数获取等级5梦境球隐藏特性的传说宝可梦",slug:"zh-emulator-b2w2-dream-radar",translation:{enSlug:"emulator-b2w2-dream-radar",language:"zh"}}];function l(r){const e={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...i(),...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
...
`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{children:`注意：RNG Reporter 中的 “Dream Radar” 标签页当前无法使用。本教程将介绍一种替代方法来查找种子以及所需的 IV/性格组合。
`})}),`
...
`]})]})}function d(r={}){const{wrapper:e}={...i(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(l,{...r})}):l(r)}export{d as default,h as frontmatter};
