import{E as i,j as n}from"./index-DTuxGDdZ.js";const d=[{title:"第五世代AR搜寻器乱数",description:"乱数获取等级5梦境球隐藏特性的传说宝可梦",slug:"zh-emulator-b2w2-dream-radar",translation:{enSlug:"emulator-b2w2-dream-radar",language:"zh"}}];function l(r){const e={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...i(),...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
