...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["If you have already used the daycare by having accepted or rejected eggs, and do not wish to use Homebrew or CFW, then you will have to do the ",e.jsx(n.a,{href:"https://www.pokemonrng.com/retail-usum-egg-seed-no-cfw",children:"127 Magikarp method"})," to find your egg seeds."]}),`
`,e.jsxs(n.li,{children:["If you have not used the daycare and do not wish to use Homebrew or CFW, you can use the ",e.jsx(n.a,{href:"https://www.pokemonrng.com/retail-usum-egg-seed-no-cfw",children:"8 egg method"})," to find your egg seeds."]}),`
