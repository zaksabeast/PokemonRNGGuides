import{u as r,j as e}from"./index-DOVRflpI.js";const o=[{title:"Ultra Sun and Ultra Moon Egg RNG with Masuda and/or Shiny Charm",navDrawerTitle:"MM/SC Egg RNG",description:"RNG for eggs using Masuda Method and/or with the Shiny Charm",slug:"retail-usum-egg-mmsc",category:"Ultra Sun and Ultra Moon",tag:"any"},{title:"Sun and Moon Egg RNG with Masuda and/or Shiny Charm",navDrawerTitle:"MM/SC Egg RNG",description:"RNG for eggs using Masuda Method and/or with the Shiny Charm",slug:"retail-sm-egg-mmsc",category:"Sun and Moon",tag:"any"}];function i(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Differences with Masuda Method and/or Shiny Charm"}),`
...
`,e.jsxs(n.li,{children:["Optional: A 3DS with PCalc (",e.jsx(n.a,{href:"/misc-3ds-installing-pcalc",children:"PCalc Install Guide"}),")"]}),`
`]}),`
...
`]}),`
`]}),`
`]})]})}function h(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{h as default,o as frontmatter};
