...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["If you've accepted or rejected eggs and don't want to use Homebrew or CFW, use the ",e.jsx(n.a,{href:"https://www.pokemonrng.com/retail-usum-egg-seed-no-cfw",children:"127 Magikarp method"}),"."]}),`
`,e.jsxs(n.li,{children:["If you haven't interacted with the daycare and don't want to use Homebrew or CFW, try the ",e.jsx(n.a,{href:"https://www.pokemonrng.com/retail-usum-egg-seed-no-cfw",children:"8 egg method"}),"."]}),`
