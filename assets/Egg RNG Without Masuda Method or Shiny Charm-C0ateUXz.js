import{ih as r,j as n}from"./index-DGbmpVsq.js";const d=[{title:"不使用 Masuda 法或闪耀护符的孵化乱数（ORAS）",description:"学习如何在《宝可梦 欧米伽红宝石／阿尔法蓝宝石》中通过培育屋进行孵化乱数，实现高个体或异色宝可梦孵化。",slug:"zh-retail-oras-egg-no-mmsc",translation:{enSlug:"retail-oras-egg-no-mmsc",language:"zh"}},{title:"不使用 Masuda 法或闪耀护符的孵化乱数（XY）",description:"学习如何在《宝可梦 X/Y》中通过培育屋进行孵化乱数，实现高个体或异色宝可梦孵化。",slug:"zh-retail-xy-egg-no-mmsc",translation:{enSlug:"retail-xy-egg-no-mmsc",language:"zh"}}];function s(e){const l={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...e.components},{ShowIf:i}=l;return i||c("ShowIf"),n.jsxs(n.Fragment,{children:[n.jsxs(i,{slug:"/zh-retail-oras-egg-no-mmsc",children:[n.jsxs(l.p,{children:["本教程适用于",n.jsx(l.strong,{children:"欧米伽红宝石／阿尔法蓝宝石"}),"。"]}),n.jsx(l.p,{children:"想查看其他版本的教程？请前往："}),n.jsxs(l.ul,{children:[`
`,n.jsx(l.li,{children:n.jsx(l.a,{href:"/zh-retail-xy-egg-no-mmsc",children:"XY 孵化乱数教程（无 Masuda/闪耀护符）"})}),`
`]})]}),`
`,n.jsxs(i,{slug:"/zh-retail-xy-egg-no-mmsc",children:[n.jsxs(l.p,{children:["本教程适用于",n.jsx(l.strong,{children:"X/Y"}),"。"]}),n.jsx(l.p,{children:"想查看其他版本的教程？请前往："}),n.jsxs(l.ul,{children:[`
`,n.jsx(l.li,{children:n.jsx(l.a,{href:"/zh-retail-oras-egg-no-mmsc",children:"ORAS 孵化乱数教程（无 Masuda/闪耀护符）"})}),`
`]})]}),`
...
`]})]})}function x(e={}){const{wrapper:l}={...r(),...e.components};return l?n.jsx(l,{...e,children:n.jsx(s,{...e})}):s(e)}function c(e,l){throw new Error("Expected component `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default,d as frontmatter};
