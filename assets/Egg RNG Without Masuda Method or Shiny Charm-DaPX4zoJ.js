import{ga as s,j as e}from"./index-uFjPzSoK.js";const h=[{title:"Omega Ruby and Alpha Sapphire Egg RNG Without Masuda or Shiny Charm",navDrawerTitle:"No MM/SC Egg RNG",description:"Learn how to RNG eggs from the Daycare in Omega Ruby and Alpha Sapphire for shiny, high-IV Pokémon.",slug:"retail-oras-egg-no-mmsc",category:"Omega Ruby and Alpha Sapphire",section:"guide",variant:"cfw-emu"},{title:"X and Y Egg RNG Without Masuda or Shiny Charm",navDrawerTitle:"No MM/SC Egg RNG",description:"Learn how to RNG eggs from the Daycare in X and Y for shiny, high-IV Pokémon.",slug:"retail-xy-egg-no-mmsc",category:"X and Y",section:"guide",variant:"cfw-emu",canonical:"retail-oras-egg-no-mmsc"}];function i(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...t.components},{ShowIf:r}=n;return r||o("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(r,{slug:"/retail-oras-egg-no-mmsc",children:[e.jsxs(n.p,{children:["This guide is for ",e.jsx(n.strong,{children:"Omega Ruby and Alpha Sapphire"}),"."]}),e.jsx(n.p,{children:"Looking for a different game? Check out these pages:"}),e.jsxs(n.ul,{children:[`
