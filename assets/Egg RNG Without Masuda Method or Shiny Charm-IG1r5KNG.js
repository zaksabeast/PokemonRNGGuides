import{g9 as s,j as e}from"./index-1b6yQU6r.js";const h=[{title:"Omega Ruby and Alpha Sapphire Egg RNG Without Masuda or Shiny Charm",navDrawerTitle:"No MM/SC Egg RNG",description:"Learn how to RNG eggs from the Daycare in Omega Ruby and Alpha Sapphire for shiny, high-IV Pokémon.",slug:"retail-oras-egg-no-mmsc",category:"Omega Ruby and Alpha Sapphire",section:"pokemon_rng",variant:"cfw-emu"},{title:"X and Y Egg RNG Without Masuda or Shiny Charm",navDrawerTitle:"No MM/SC Egg RNG",description:"Learn how to RNG eggs from the Daycare in X and Y for shiny, high-IV Pokémon.",slug:"retail-xy-egg-no-mmsc",category:"X and Y",section:"pokemon_rng",variant:"cfw-emu",canonical:"retail-oras-egg-no-mmsc"}];function i(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...t.components},{ShowIf:r}=n;return r||o("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(r,{slug:"/retail-oras-egg-no-mmsc",children:[e.jsxs(n.p,{children:["This guide is for ",e.jsx(n.strong,{children:"Omega Ruby and Alpha Sapphire"}),"."]}),e.jsx(n.p,{children:"Looking for a different game? Check out these pages:"}),e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"/retail-xy-egg-no-mmsc",children:"X and Y No MM/SC Egg RNG Guide"})}),`
`]})]}),`
`,e.jsxs(r,{slug:"/retail-xy-egg-no-mmsc",children:[e.jsxs(n.p,{children:["This guide is for ",e.jsx(n.strong,{children:"X and Y"}),"."]}),e.jsx(n.p,{children:"Looking for a different game? Check out these pages:"}),e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"/retail-oras-egg-no-mmsc",children:"Omega Ruby and Alpha Sapphire No MM/SC Egg RNG Guide"})}),`
`]})]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`This method differs from using Masuda or having the Shiny Charm. Here, you first RNG the egg traits, then RNG the ESV (and PID) when picking up the egg. This approach potentially results in shorter wait times than with Masuda or Shiny Charm.
`})}),`
...
`]})]})}function l(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}function o(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as default,h as frontmatter};
