import{u as r,j as e}from"./index-DH03H6uJ.js";const a=[{title:"Ultra Sun and Ultra Moon Egg RNG without Masuda and/or Shiny Charm",navDrawerTitle:"No MM/SC Egg RNG",description:"RNG for eggs without using Masuda Method and without the Shiny Charm",slug:"retail-usum-egg-no-mmsc",category:"Ultra Sun and Ultra Moon",tag:"cfw"},{title:"Sun and Moon Egg RNG without Masuda and/or Shiny Charm",navDrawerTitle:"No MM/SC Egg RNG",description:"RNG for eggs without using Masuda Method and without the Shiny Charm",slug:"retail-sm-egg-no-mmsc",category:"Sun and Moon",tag:"cfw"}];function i(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"How is this different from using the Masuda Method and/or Shiny Charm?"}),`
...
`,e.jsxs(n.li,{children:["3DS with PCalc (",e.jsx(n.a,{href:"/misc-3ds-installing-pcalc",children:"PCalc Install Guide"}),")"]}),`
