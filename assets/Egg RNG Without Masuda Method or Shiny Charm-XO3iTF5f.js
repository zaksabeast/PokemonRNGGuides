import{u as r,j as e}from"./index-m1Sd13gQ.js";const a=[{title:"Ultra Sun and Ultra Moon Egg RNG without Masuda and/or Shiny Charm",navDrawerTitle:"No MM/SC Egg RNG",description:"Learn how to RNG eggs from the Daycare in Ultra Sun and Ultra Moon for shiny, high-IV Pokémon.",slug:"retail-usum-egg-no-mmsc",category:"Ultra Sun and Ultra Moon",tag:"cfw"},{title:"Sun and Moon Egg RNG without Masuda and/or Shiny Charm",navDrawerTitle:"No MM/SC Egg RNG",description:"Learn how to RNG eggs from the Daycare in Sun and Moon for shiny, high-IV Pokémon.",slug:"retail-sm-egg-no-mmsc",category:"Sun and Moon",tag:"cfw"}];function i(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"How is this different from using the Masuda Method and/or Shiny Charm?"}),`
...
`]}),`
`,e.jsx(n.p,{children:"Congrats! You should now have the desired egg with the RNG’d TSV. If not, you can reset the game (if you saved before picking up the egg) and try again."})]})}function h(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{h as default,a as frontmatter};
