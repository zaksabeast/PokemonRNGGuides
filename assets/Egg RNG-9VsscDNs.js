import{u as l,j as e}from"./index-DOUBKsX3.js";const d={title:"Emerald Egg RNG",navDrawerTitle:"Egg RNG",description:"Learn how to RNG eggs in Pokémon Emerald using the Daycare. Get perfect IVs, natures, and shinies.",slug:"emulator-emerald-egg",category:"Emerald",tag:"emu",addedOn:"2025-03-09"};function s(n){const t={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...l(),...n.components},{EmeraldHeldEgg:r,EmeraldPickupEgg:i,YouTubeVideo:o}=t;return r||a("EmeraldHeldEgg"),i||a("EmeraldPickupEgg"),o||a("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Tools:"}),`
