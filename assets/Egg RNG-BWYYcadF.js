import{u as i,j as e}from"./index-uFSWPmqj.js";const a={title:"Egg RNG",description:"RNG Eggs from the Daycare",slug:"emulator-emerald-egg",subCategory:"Emulator",tag:"emu"};function r(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools:"}),`
...
`,e.jsx(n.p,{children:"If the IVs are not as desired, ensure you have correctly inputted info in PokeFinder and that the order of parents is not swapped."})]})}function d(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{d as default,a as frontmatter};
