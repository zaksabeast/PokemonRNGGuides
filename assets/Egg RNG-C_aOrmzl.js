import{q as l,j as e}from"./index-BSIUIrzC.js";const d={title:"Emerald Egg RNG",navDrawerTitle:"Egg RNG",description:"Learn how to RNG eggs in Pokémon Emerald using the Daycare. Get perfect IVs, natures, and shinies.",slug:"emulator-emerald-egg",category:"Emerald",tag:"emu",addedOn:"2025-03-09"};function s(n){const t={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...l(),...n.components},{EmeraldHeldEgg:i,EmeraldPickupEgg:r,YouTubeVideo:o}=t;return i||a("EmeraldHeldEgg"),r||a("EmeraldPickupEgg"),o||a("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Tools:"}),`
...
`]})]})}function c(n={}){const{wrapper:t}={...l(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}function a(n,t){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default,d as frontmatter};
