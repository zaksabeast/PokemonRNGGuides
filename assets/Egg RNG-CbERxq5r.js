import{u as r,j as e}from"./index-DlzSnQqK.js";const a={title:"Egg RNG",description:"RNG Eggs from the Daycare",slug:"emulator-rs-egg",subCategory:"Emulator"};function i(t){const n={a:"a",code:"code",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h3,{children:"Requirements:"}),`
...
`,e.jsx(n.p,{children:"The PID for the egg in Ruby/Sapphire is generated in two parts. You'll rng the first part when the egg is generated, and you'll rng the second part when picking up the egg."}),`
`,e.jsx(n.p,{children:"Egg RNG in Ruby/Sapphire can be done with both live and dead battery."}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`Note: In Ruby and Sapphire, the Everstone does not work in breeding to pass down natures. This mechanic was not added until later games.
`})}),`
...
`,e.jsx(n.li,{children:"Make sure the parents are not holding any items."}),`
`]}),`
`]}),`
...
`,e.jsxs(n.ol,{children:[`
`,e.jsx(n.li,{children:"Open PokeFinder and click on Gen 3 Egg. Make sure to be on the Ruby/Sapphire tab."}),`
...
`,e.jsxs(n.li,{children:["Once done, find your initial seed shown by the lua. Enter it and search for a spread.",`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Take note that the initial seed with a dead battery will be ",e.jsx(n.code,{children:"5A0"})," for Ruby/Sapphire."]}),`
`]}),`
`]}),`
`]}),`
...
`,e.jsx(n.p,{children:"If it's not matching, recheck the whole process. Don't hesitate to do save states."})]})}function o(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{o as default,a as frontmatter};
