import{u as t,j as e}from"./index-DXbxUTNi.js";const a={title:"FRLG Egg RNG",description:"RNG eggs in FRLG",slug:"emulator-frlg-egg",subCategory:"Emulator"};function i(s){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(n.p,{children:"If it doesn't match, recheck your steps and use savestates."})]})}function l(s={}){const{wrapper:n}={...t(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{l as default,a as frontmatter};
