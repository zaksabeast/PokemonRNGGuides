import{u as s,j as e}from"./index-HmCd-Vx5.js";const a={title:"FireRed and LeafGreen Egg RNG",navDrawerTitle:"Egg RNG",description:"RNG eggs in FRLG",slug:"emulator-frlg-egg",subCategory:"Emulator",tag:"emu"};function i(t){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(n.p,{children:"If it doesn't match, recheck your steps and use savestates."})]})}function l(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{l as default,a as frontmatter};
