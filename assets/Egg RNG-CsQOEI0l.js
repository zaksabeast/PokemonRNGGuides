import{u as d,j as e}from"./index-IZhoyR2j.js";const u=[{title:"Egg RNG",description:"RNG Eggs from the Daycare",slug:"emulator-emerald-egg",subCategory:"Emulator",tag:"emu",addedOn:"2025-03-09"},{title:"孵化乱数",description:"通过培育屋进行乱数孵蛋",slug:"zh-emulator-emerald-egg",subCategory:"Emulator",tag:"emu",addedOn:"2025-04-07",hideFromNavDrawer:!0}];function h(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...d(),...t.components},{EmeraldHeldEgg:r,EmeraldPickupEgg:a,LanguageButton:o,ShowIf:l,YouTubeVideo:s}=n;return r||i("EmeraldHeldEgg"),a||i("EmeraldPickupEgg"),o||i("LanguageButton"),l||i("ShowIf"),s||i("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(o,{enSlug:"/emulator-emerald-egg",zhSlug:"/zh-emulator-emerald-egg"}),`
`,e.jsxs(l,{slug:"/emulator-emerald-egg",children:[e.jsx(n.h2,{children:"Tools:"}),e.jsxs(n.ul,{children:[`
...
`]})]})]})}function x(t={}){const{wrapper:n}={...d(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(h,{...t})}):h(t)}function i(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default,u as frontmatter};
