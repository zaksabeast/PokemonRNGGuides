import{u as l,j as e}from"./index-RxFMJ-ku.js";const d=[{title:"FireRed and LeafGreen Egg RNG",navDrawerTitle:"Egg RNG",description:"RNG eggs in FRLG",slug:"emulator-frlg-egg",category:"FireRed and LeafGreen",tag:"emu"},{title:"火红叶绿孵化乱数",navDrawerTitle:"Egg RNG",description:"在火红/叶绿中进行蛋的乱数",slug:"zh-emulator-frlg-egg",category:"FireRed and LeafGreen",tag:"emu",translation:{enSlug:"emulator-frlg-egg",language:"zh"}}];function s(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...l(),...i.components},{ShowIf:r}=n;return r||t("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(r,{slug:"/emulator-frlg-egg",children:[e.jsx(n.h2,{children:"Tools"}),e.jsxs(n.ul,{children:[`
...
`]})]})]})}function h(i={}){const{wrapper:n}={...l(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}function t(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,d as frontmatter};
