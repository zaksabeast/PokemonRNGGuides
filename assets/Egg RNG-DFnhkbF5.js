import{ih as o,j as n}from"./index-DGbmpVsq.js";const t={title:"孵化乱数",description:"通过培育屋进行乱数孵蛋",slug:"zh-emulator-emerald-egg",translation:{enSlug:"emulator-emerald-egg",language:"zh"}};function c(i){const e={a:"a",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...o(),...i.components},{EmeraldHeldEgg:r,EmeraldPickupEgg:s,YouTubeVideo:d}=e;return r||l("EmeraldHeldEgg"),s||l("EmeraldPickupEgg"),d||l("YouTubeVideo"),n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
...
`]})]})}function x(i={}){const{wrapper:e}={...o(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(c,{...i})}):c(i)}function l(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default,t as frontmatter};
