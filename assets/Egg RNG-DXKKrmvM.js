import{u as t,j as e}from"./index-BWkkpZHG.js";const a=[{title:"Ruby and Sapphire Egg RNG",navDrawerTitle:"Egg RNG",description:"Learn how to RNG eggs from the Daycare in Ruby and Sapphire for shiny, high-IV Pokémon.",slug:"emulator-rs-egg",category:"Ruby and Sapphire",tag:"emu"},{title:"孵化乱数",description:"从培育屋乱数孵化宝可梦蛋",slug:"zh-emulator-rs-egg",category:"Ruby and Sapphire",tag:"emu",translation:{enSlug:"emulator-rs-egg",language:"zh"}}];function s(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...t(),...i.components},{ShowIf:r}=n;return r||l("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(r,{slug:"/emulator-rs-egg",children:[e.jsx(n.h2,{children:"Tools"}),e.jsxs(n.ul,{children:[`
