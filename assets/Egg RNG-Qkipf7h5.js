import{u as i,j as e}from"./index-rxcn4Qg7.js";const a={title:"Egg RNG",description:"RNG Eggs from the Daycare",slug:"emulator-rs-egg",subCategory:"Emulator"};function r(t){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(n.p,{children:"If it doesn't match, recheck the whole process, and feel free to use savestates."})]})}function o(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{o as default,a as frontmatter};
