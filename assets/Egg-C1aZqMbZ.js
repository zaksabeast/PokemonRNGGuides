import{ii as s,j as n}from"./index-CLgpAzd3.js";const d=[{title:"孵化乱数",description:"如何在育婴屋进行乱数孵化",slug:"zh-emulator-dppt-egg",translation:{enSlug:"emulator-dppt-egg",language:"zh"}}];function i(l){const e={a:"a",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...l.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
...
`,n.jsx(e.p,{children:`本教程介绍了如何推进乱数，以获得符合你想要的宝可梦。你应该已经掌握第四世代乱数的一些基础知识，例如如何开始乱数并推进它。在钻石、珍珠、白金中，孵化乱数较为复杂，因为游戏区域会产生随机干扰。
