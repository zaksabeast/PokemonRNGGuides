import{ii as t,j as e}from"./index-BGnyzrB1.js";const a=[{title:"HeartGold and Soulsilver Egg RNG",navDrawerTitle:"Egg RNG",description:"Learn how to RNG eggs from the Daycare in HeartGold and SoulSilver for shiny, high-IV Pokémon.",slug:"emulator-hgss-egg",category:"HeartGold and SoulSilver",section:"pokemon_rng",variant:"cfw-emu"},{title:"HeartGold and Soulsilver Egg RNG",navDrawerTitle:"Egg RNG",description:"Learn how to RNG eggs from the Daycare in HeartGold and SoulSilver for shiny, high-IV Pokémon.",slug:"emulator-hgss-breeding",category:"HeartGold and SoulSilver",section:"pokemon_rng",variant:"cfw-emu",hideFromNavDrawer:!0,canonical:"emulator-hgss-egg"}];function r(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
