import{q as s,j as e}from"./index-DoDgPwkW.js";const d={title:"RNG UOVA SMERALDO",navDrawerTitle:"RNG UOVA SMERALDO",description:"Learn how to RNG eggs in Pokémon Emerald using the Daycare. Get perfect IVs, natures, and shinies.",slug:"it-emulator-emerald-egg",translation:{enSlug:"emulator-emerald-egg",language:"it"}};function r(n){const i={a:"a",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...s(),...n.components},{EmeraldHeldEgg:a,EmeraldPickupEgg:l,YouTubeVideo:t}=i;return a||o("EmeraldHeldEgg"),l||o("EmeraldPickupEgg"),t||o("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(i.h2,{children:"Strumenti"}),`
...
`,e.jsx(t,{src:"https://www.youtube.com/embed/JtwSZgw6Q4U?si=Fvmg7KLqI9J06wAa"}),`
...
`]})]})}function u(n={}){const{wrapper:i}={...s(),...n.components};return i?e.jsx(i,{...n,children:e.jsx(r,{...n})}):r(n)}function o(n,i){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{u as default,d as frontmatter};
