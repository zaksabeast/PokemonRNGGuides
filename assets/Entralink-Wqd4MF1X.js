import{E as r,j as n}from"./index-DA07Za_D.js";const h=[{title:"连入之森乱数",description:"如何使用连入乱数获取心仪的宝可梦",slug:"zh-emulator-bw-entralink",translation:{enSlug:"emulator-bw-entralink",language:"zh"}}];function i(l){const e={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...l.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
