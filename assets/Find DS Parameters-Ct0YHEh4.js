import{u as l,j as e}from"./index-C82Cu2sC.js";const t=[{title:"How To Find DS Parameters in Generation 5",navDrawerTitle:"DS Parameters",description:"Get your DS Parameters for Generation 5 RNG.",slug:"emulator-bw-find-ds-parameters",category:"Black and White",tag:"emu"},{title:"如何在第五世代中寻找 DS 参数",description:"获取你的 DS 参数以进行第五世代乱数。",slug:"zh-emulator-bw-find-ds-parameters",category:"Black and White",tag:"emu",translation:{enSlug:"emulator-bw-find-ds-parameters",language:"zh"}}];function r(s){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...l(),...s.components},{ShowIf:i}=n;return i||d("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(i,{slug:"/emulator-bw-find-ds-parameters",children:[e.jsx(n.h2,{children:"Tools"}),e.jsxs(n.ul,{children:[`
