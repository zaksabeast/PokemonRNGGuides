import{t as e}from"./jsx-runtime-MrBVUj-r.js";import{d as t}from"./index-Cb79kjoL.js";var n=e(),r=[{title:`如何在第五世代中寻找 DS 参数`,description:`获取你的 DS 参数以进行第五世代乱数。`,slug:`zh-emulator-bw-find-ds-parameters`,translation:{enSlug:`emulator-bw-find-ds-parameters`,language:`zh`}}];function i(e){let r={a:`a`,code:`code`,h2:`h2`,img:`img`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h2,{children:`所需工具`}),`
