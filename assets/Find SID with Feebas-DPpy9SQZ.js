import{u as l,j as e}from"./index-B1iwSKk2.js";const h=[{title:"Find Emerald SID with Feebas",description:"How to find your Secret ID (SID) in Emerald using Feebas.",slug:"emerald-sid-feebas",category:"Emerald",tag:"retail",addedOn:"2025-03-03"},{title:"Find Ruby or Sapphire SID with Feebas",description:"How to find your Secret ID (SID) in Ruby or Sapphire using Feebas.",slug:"rs-sid-feebas",category:"Ruby and Sapphire",tag:"retail"}];function a(i){const n={a:"a",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...l(),...i.components},{Alert:t,Gen3Sid:o,YouTubeVideo:r}=n;return t||s("Alert"),o||s("Gen3Sid"),r||s("YouTubeVideo"),e.jsxs(e.Fragment,{children:[window.location.pathname==="/rs-sid-feebas"&&e.jsx(t,{showIcon:!0,type:"warning",message:"There's an easier method for Ruby and Sapphire!",description:e.jsxs(e.Fragment,{children:[`Follow the "If you're playing Ruby or Sapphire" section of`," ",e.jsx("a",{href:"/gen3-sid",children:"this guide"})," instead!"]})}),`
`,e.jsx(n.p,{children:"This method only works if:"}),`
...
`,e.jsx(r,{src:"https://www.youtube.com/embed/nOCbSmMRXLA"}),`
...
`]})]})}function c(i={}){const{wrapper:n}={...l(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}function s(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default,h as frontmatter};
