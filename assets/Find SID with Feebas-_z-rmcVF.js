import{u as l,j as e}from"./index-ufF5IZ5h.js";const h=[{title:"Find Emerald SID with Feebas",description:"How to find your Secret ID (SID) in Emerald using Feebas.",slug:"emerald-sid-feebas",category:"Emerald"},{title:"Find Ruby or Sapphire SID with Feebas",description:"How to find your Secret ID (SID) in Ruby or Sapphire using Feebas.",slug:"rs-sid-feebas",category:"Ruby and Sapphire"}];function a(i){const n={a:"a",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...l(),...i.components},{Alert:o,Gen3Sid:t,YouTubeVideo:r}=n;return o||s("Alert"),t||s("Gen3Sid"),r||s("YouTubeVideo"),e.jsxs(e.Fragment,{children:[window.location.pathname==="/rs-sid-feebas"&&e.jsx(o,{showIcon:!0,type:"warning",message:"There's an easier method for Ruby and Sapphire!",description:e.jsxs(e.Fragment,{children:[`Follow the "If you're playing Ruby or Sapphire" section of`," ",e.jsx("a",{href:"/gen3-sid",children:"this guide"})," instead!"]})}),`
...
`]}),`
`,e.jsx(t,{game:window.location.pathname==="/rs-sid-feebas"?"rs":"emerald"}),`
