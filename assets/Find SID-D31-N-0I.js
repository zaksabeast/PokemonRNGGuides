...
<details>
  <Summary>Se stai usando un emulatore o una flashcard GBA</Summary>

1. Carica il tuo salvataggio su [PKHex](https://github.com/kwsch/PKHeX/releases/latest) o [PKHeX Web](https://pkhex-web.github.io/) e controlla il tuo SID.

</details>

<details>
  <Summary>Se stai giocando Rubino e Zaffiro</Summary>
<br/>
...
<details>
  <Summary>Se hai già un cromatico</Summary>
...
<details>
  <Summary>Se giochi Smeraldo, se non hai alterato la Moda di Bluruvia, e hai una batteria scarica</Summary>
...
<details>
  <Summary>Se giochi Smeraldo, se non hai alterato la Moda di Bluruvia, e hai un salvataggio non più vecchio di un giorno</Summary>
...
<details>
  <Summary>Se hai modificato la tua Wii o GameCube e hai un cavo GBA-GC</Summary>
...
2. Carica il tuo salvataggio su [PKHex](https://github.com/kwsch/PKHeX/releases/latest) or [PKHeX Web](https://pkhex-web.github.io/) e controlla il tuo SID.

</details>

<details>
  <Summary>Se hai un DS e una flashcard DS</Summary>
...
<details>
  <Summary>Se hai trasferito un Pokémon a un DSi modificato, 3DS, o Switch</Summary>
...
3. Carica il tuo salvataggio su [PKHex](https://github.com/kwsch/PKHeX/releases/latest), [PKSM](https://github.com/FlagBrew/PKSM/releases/latest), or [PKHeX Web](https://pkhex-web.github.io/) e controlla il tuo SID.

</details>

<details>
  <Summary>Se hai un DS connesso al WiFi e un gioco di quarta Gen </Summary>
...
<details>
  <Summary>Se puoi trasferire un Pokemon su Pokemon Home</Summary>
...
<details>
  <Summary>Se ti va bene usare l'ACE e giocare a Smeraldo</Summary>
...
<details>
  <Summary>Se ti va bene ricominciare un nuovo salvataggio su Smeraldo</Summary>
...
<details>
  <Summary>Se ti va bene ricominciare un nuovo salvataggio su Rosso Fuoco e Verde Foglia</Summary>
...
<details>
  <Summary>Se nessuna di questi dovesse essere il tuo caso</Summary>
