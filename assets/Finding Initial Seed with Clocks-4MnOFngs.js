import{u as o,j as e}from"./index-DlzSnQqK.js";const l={title:"Finding your initial seed in Gen 7 with clocks",description:"This guide allows you to find your initial seed without using Custom Firmware",slug:"retail-sm-initial-seed-clocks",subCategory:"Retail"};function t(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...o(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/images/Sun-Moon/Initial-Seed/Clocks.png",alt:"Clocks"})}),`
...
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/images/Sun-Moon/Initial-Seed/Result.png",alt:"Result"})}),`
`,e.jsxs(n.ul,{children:[`
