import{ga as s,j as e}from"./index-C0QdZ5Ks.js";const l=[{title:"Ultra Sun and Ultra Moon finding your initial seed with clocks",navDrawerTitle:"Find Initial Seed",description:"Learn how to find your initial seed in Ultra Sun and Ultra Moon using clock patterns — no custom firmware required.",slug:"retail-usum-initial-seed-clocks",category:"Ultra Sun and Ultra Moon",section:"guide",variant:"retail"},{title:"Sun and Moon finding your initial seed in with clocks",navDrawerTitle:"Find Initial Seed",description:"Learn how to find your initial seed in Sun and Moon using clock patterns — no custom firmware required.",slug:"retail-sm-initial-seed-clocks",category:"Sun and Moon",section:"guide",variant:"retail",canonical:"retail-usum-initial-seed-clocks"}];function t(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/images/UltraSun-UltraMoon/Initial-Seed/ClockNeedles.gif",alt:"Clocks Needles"})}),`
...
`]}),`
`,e.jsxs(n.p,{children:["Your seed should appear in the ",e.jsx(n.code,{children:"Results"})," field if you did everything correctly."]})]})}function r(i={}){const{wrapper:n}={...s(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{r as default,l as frontmatter};
