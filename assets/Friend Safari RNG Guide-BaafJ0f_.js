import{u as t,j as e}from"./index-R5JkGJWU.js";const l={title:"Friend Safari RNG",description:"Get shiny 6IV friend safari Pokémon, like Ditto!",slug:"pcalc-xy-friend-safari",subCategory:"Custom Firmware",tag:"cfw"};function s(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://github.com/wwwwwwzx/3DSRNGTool/wiki/Gen6-TinyMT-Timeline-Calibration",children:"TinyMT Timeline"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://www.pokemonrng.com/ntr-helper-usage",children:"NTR Helper Usage"}),"."]}),`
`]}),`
...
`})})]})}function a(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{a as default,l as frontmatter};
