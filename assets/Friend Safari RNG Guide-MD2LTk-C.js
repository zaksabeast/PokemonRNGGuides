import{ic as s,j as n}from"./index-CM0OUTar.js";const r={title:"X/Y 朋友狩猎区乱数指南",description:"学习如何在《宝可梦 X/Y》中通过朋友狩猎区乱数获取异色六V宝可梦，包括百变怪和其他稀有种类。",slug:"zh-pcalc-xy-friend-safari",translation:{enSlug:"pcalc-xy-friend-safari",language:"zh"}};function e(l){const i={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...l.components};return n.jsxs(n.Fragment,{children:[n.jsx(i.h2,{children:"所需工具"}),`
