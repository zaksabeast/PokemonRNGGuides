import{ii as s,j as n}from"./index-CeZrrXNR.js";const r={title:"X/Y 朋友狩猎区乱数教程",description:"学习如何在《宝可梦 X/Y》中通过朋友狩猎区乱数获取异色六V宝可梦，包括百变怪和其他稀有种类。",slug:"zh-pcalc-xy-friend-safari",translation:{enSlug:"pcalc-xy-friend-safari",language:"zh"}};function e(l){const i={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...l.components};return n.jsxs(n.Fragment,{children:[n.jsx(i.h2,{children:"所需工具"}),`
...
`,n.jsx(i.li,{children:n.jsx(i.a,{href:"/ntr-helper-usage",children:"NTR 助手使用教程"})}),`
`]}),`
...
`,n.jsxs(i.ul,{children:[`
`,n.jsx(i.li,{children:"你可以进行测试运行，或重启游戏使用本教程后面介绍的重抽种子方法寻找目标帧。"}),`
`]}),`
`]}),`
`]}),`
`,n.jsx(i.pre,{children:n.jsx(i.code,{children:`注意：本教程假定你已掌握第六世代的基本乱数流程。建议先从如孵化乱数这类更简单的目标入门。
`})}),`
...
`,n.jsxs(i.li,{children:["具体操作请参考 ",n.jsx(i.a,{href:"/ntr-helper-usage",children:"NTR 助手使用教程"}),"。"]}),`
`]}),`
`]}),`
