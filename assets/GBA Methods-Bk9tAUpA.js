import{ga as h,j as e}from"./index-DJpXE56Z.js";const o={title:"Methods 1-4 in Emerald",navDrawerTitle:"Methods 1-4",description:"What is a Method, the reason why Methods 1-4 exist, and how they impact Pokémon generation.",slug:"gba-methods",category:"GBA Technical Documentation",section:"technical_info",addedOn:"2025-04-08"};function i(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...h(),...t.components},{Gist:s,Text:r}=n;return s||d("Gist"),r||d("Text"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:e.jsx(n.p,{children:`Gist: What is a Method, the reason why Methods 1-4 exist, and how they impact
Pokémon generation.`})}),`
...
`,e.jsx(n.p,{children:"It is also theorically possible for Vblanks to occur during a very specific instruction in the RNG update, causing the RNG update to be skipped."}),`
`,e.jsx(n.h3,{children:"Learn more"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/gba-methods-lead-impact",children:"Lead Impact on Wild Methods in Emerald"}),": Understanding why the lead impacts which Wild method is triggered"]}),`
`]}),`
...
`]})]})}function c(t={}){const{wrapper:n}={...h(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}function d(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default,o as frontmatter};
