import{u as h,j as e}from"./index-D-8zJ8GY.js";const l={title:"Methods 1-4",description:"What is a Method, the reason why Methods 1-4 exist, and how they impact Pokémon generation.",slug:"gba-methods",category:"GBA Technical Documentation",tag:"any",addedOn:"2025-04-08"};function d(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...h(),...t.components},{Gist:s,Text:r}=n;return s||i("Gist"),r||i("Text"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:e.jsx(n.p,{children:`Gist: What is a Method, the reason why Methods 1-4 exist, and how they impact
Pokémon generation.`})}),`
