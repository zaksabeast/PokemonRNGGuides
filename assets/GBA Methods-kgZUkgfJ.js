import{ie as i,j as n}from"./index-PGnkG4AG.js";const c={title:"绿宝石中的方式 1-4",description:"什么是方式、为什么会存在方式 1-4，以及它们如何影响宝可梦的生成。",slug:"zh-gba-methods",translation:{enSlug:"gba-methods",language:"zh"}};function l(e){const d={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...e.components},{Gist:s,Text:r}=d;return s||h("Gist"),r||h("Text"),n.jsxs(n.Fragment,{children:[n.jsx(s,{children:"要点：什么是方式，为什么存在方式 1-4，以及它们如何影响宝可梦生成。"}),`
...
`,n.jsxs(d.table,{children:[n.jsx(d.thead,{children:n.jsxs(d.tr,{children:[n.jsx(d.th,{children:"步骤"}),n.jsx(d.th,{children:"在该步骤开始时推进的乱数帧"})]})}),n.jsxs(d.tbody,{children:[n.jsxs(d.tr,{children:[n.jsx(d.td,{children:"生成 PID 的前半部分"}),n.jsx(d.td,{children:"1"})]}),n.jsxs(d.tr,{children:[n.jsx(d.td,{children:"生成 PID 的后半部分"}),n.jsx(d.td,{children:"2"})]}),n.jsxs(d.tr,{children:[n.jsx(d.td,{children:n.jsx(r,{color:"Green",strong:!0,children:"VBLANK：乱数推进"})}),n.jsx(d.td,{children:n.jsx(r,{color:"Green",strong:!0,children:"3"})})]}),n.jsxs(d.tr,{children:[n.jsx(d.td,{children:"生成防御、攻击、HP 的 IV"}),n.jsx(d.td,{children:n.jsx(r,{strong:!0,children:"4"})})]}),n.jsxs(d.tr,{children:[n.jsx(d.td,{children:"生成特防、特攻、速度的 IV"}),n.jsx(d.td,{children:n.jsx(r,{strong:!0,children:"5"})})]})]})]}),`
...
`,n.jsxs(d.table,{children:[n.jsx(d.thead,{children:n.jsxs(d.tr,{children:[n.jsx(d.th,{children:"步骤"}),n.jsx(d.th,{children:"在该步骤开始时推进的乱数帧"})]})}),n.jsxs(d.tbody,{children:[n.jsxs(d.tr,{children:[n.jsx(d.td,{children:"生成 PID 的前半部分"}),n.jsx(d.td,{children:"1"})]}),n.jsxs(d.tr,{children:[n.jsx(d.td,{children:"生成 PID 的后半部分"}),n.jsx(d.td,{children:"2"})]}),n.jsxs(d.tr,{children:[n.jsx(d.td,{children:"生成防御、攻击、HP 的 IV"}),n.jsx(d.td,{children:"3"})]}),n.jsxs(d.tr,{children:[n.jsx(d.td,{children:n.jsx(r,{color:"Green",strong:!0,children:"VBLANK：乱数推进"})}),n.jsx(d.td,{children:n.jsx(r,{color:"Green",strong:!0,children:"4"})})]}),n.jsxs(d.tr,{children:[n.jsx(d.td,{children:"生成特防、特攻、速度的 IV"}),n.jsx(d.td,{children:n.jsx(r,{strong:!0,children:"5"})})]})]})]}),`
...
`]})]})}function x(e={}){const{wrapper:d}={...i(),...e.components};return d?n.jsx(d,{...e,children:n.jsx(l,{...e})}):l(e)}function h(e,d){throw new Error("Expected component `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default,c as frontmatter};
