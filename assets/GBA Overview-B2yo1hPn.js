import{ii as s,j as e}from"./index-CXw3cuDA.js";const d={title:"GBA Overview",navDrawerTitle:"GBA Overview",description:"Particularities, key RNG concepts, and version differences of GBA games.",slug:"gba-overview",category:["Ruby and Sapphire","FireRed and LeafGreen","Emerald"],section:"getting_started",addedOn:"2025-04-08"};function r(i){const n={a:"a",h2:"h2",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...i.components},{Gist:t}=n;return t||a("Gist"),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:e.jsx(n.p,{children:"Gist: Particularities, key RNG concepts, and version differences of GBA games."})}),`
...
`]}),`
`,e.jsx(n.p,{children:"Pokémon can be transfered from GBA to DS games, but not the other way around."}),`
...
`]})]})}function l(i={}){const{wrapper:n}={...s(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}function a(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as default,d as frontmatter};
