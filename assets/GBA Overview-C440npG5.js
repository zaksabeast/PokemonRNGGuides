import{u as s,j as e}from"./index-OHtGuHlA.js";const d={title:"Overview",description:"Particularities, key RNG concepts, and version differences of GBA games.",slug:"gba-overview",category:"GBA Overview",tag:"any",addedOn:"2025-04-08"};function r(t){const n={a:"a",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...t.components},{Gist:i}=n;return i||a("Gist"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:e.jsx(n.p,{children:"Gist: Particularities, key RNG concepts, and version differences of GBA games."})}),`
...
`]}),`
`,e.jsx(n.p,{children:"Pokémon can be transfered from GBA to DS games, but not the other way around."})]})}function h(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}function a(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,d as frontmatter};
