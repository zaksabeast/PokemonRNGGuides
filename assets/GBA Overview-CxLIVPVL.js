import{A as s,j as e}from"./index-DfFHvFlP.js";const d={title:"GBA Overview",navDrawerTitle:"Overview",description:"Particularities, key RNG concepts, and version differences of GBA games.",slug:"gba-overview",category:"GBA Overview",tag:"any",addedOn:"2025-04-08"};function r(t){const n={a:"a",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...t.components},{Gist:i}=n;return i||a("Gist"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:e.jsx(n.p,{children:"Gist: Particularities, key RNG concepts, and version differences of GBA games."})}),`
