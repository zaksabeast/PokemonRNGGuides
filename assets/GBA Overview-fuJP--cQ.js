import{w as i,j as n}from"./index-m1a04MGk.js";const t={title:"GBA概述",description:"GBA游戏的特性、关键乱数概念与版本差异",slug:"zh-gba-overview",translation:{enSlug:"gba-overview",language:"zh"}};function h(r){const e={a:"a",h2:"h2",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...r.components},{Gist:s}=e;return s||d("Gist"),n.jsxs(n.Fragment,{children:[n.jsx(s,{children:"要点：GBA游戏的特性、关键乱数概念与版本差异。"}),`
