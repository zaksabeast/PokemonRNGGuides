import{ig as o,j as e}from"./index-DOVOXoz6.js";const a=[{title:"Wild Searcher",description:"Wild Searcher",slug:"emerald-wild",category:"Emerald",section:"pokemon_rng",variant:"retail",isRoughDraft:!0}];function i(t){const n={h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...o(),...t.components},{Wild3SearcherFindTarget:r}=n;return r||s("Wild3SearcherFindTarget"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Searcher"}),`
...
`]})]})}function d(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}function s(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as default,a as frontmatter};
