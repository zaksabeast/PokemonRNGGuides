import{ii as a,j as e}from"./index-CLgpAzd3.js";const d=[{title:"Wild Searcher",description:"Wild Searcher",slug:"emerald-wild",category:"Emerald",section:"pokemon_rng",variant:"retail",isRoughDraft:!0}];function o(i){const n={h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...a(),...i.components},{Wild3Calib:t,Wild3SearcherFindTarget:r}=n;return t||l("Wild3Calib"),r||l("Wild3SearcherFindTarget"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Searcher"}),`
...
`]})]})}function c(i={}){const{wrapper:n}={...a(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(o,{...i})}):o(i)}function l(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default,d as frontmatter};
