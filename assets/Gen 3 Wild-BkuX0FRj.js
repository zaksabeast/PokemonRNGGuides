import{g9 as s,j as e}from"./index-1b6yQU6r.js";const d=[{title:"Emerald Wild Searcher",description:"Emerald Wild Searcher",slug:"emerald-wild",category:"Emerald",section:"pokemon_rng",variant:"retail",isRoughDraft:!0}];function r(t){const n={h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...t.components},{Wild3MethodDistribution:i,Wild3SearcherFindTarget:o}=n;return i||l("Wild3MethodDistribution"),o||l("Wild3SearcherFindTarget"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Searcher"}),`
...
`]})]})}function c(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}function l(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default,d as frontmatter};
