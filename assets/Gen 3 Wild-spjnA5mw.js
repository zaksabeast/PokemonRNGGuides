import{g7 as a,j as e}from"./index-B1wHGEg7.js";const s=[{title:"Emerald Wild Searcher",description:"Emerald Wild Searcher",slug:"emerald-wild",category:"Emerald",tag:"retail",isRoughDraft:!0}];function i(t){const n={h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...a(),...t.components},{Wild3MethodDistribution:o,Wild3SearcherFindTarget:r}=n;return o||l("Wild3MethodDistribution"),r||l("Wild3SearcherFindTarget"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Searcher"}),`
...
`]})]})}function c(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}function l(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default,s as frontmatter};
