import{ie as i,j as n}from"./index-DBJVNOlg.js";const c={title:"Connect Dolphin to VBA",description:"Learn how to redeem Jirachi or transfer your RNGs to a GBA game.",slug:"misc-dolphin-connect-vba",category:"GBA Tools",section:"tool",hideFromNavDrawer:!0};function t(o){const e={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...i(),...o.components},{Alert:s}=e;return s||r("Alert"),n.jsxs(n.Fragment,{children:[n.jsx(s,{showIcon:!0,type:"warning",message:"This guide is outdated!",description:n.jsx(e.a,{href:"/connect-dolphin-to-gba",children:"Use the Connect Dolphin to mGBA Guide instead."})}),`
...
`]}),`
`,n.jsx(e.p,{children:n.jsx(e.img,{src:"/images/Tools-and-Emulators/VBA-to-Dolphin/Success.png",alt:"Success"})})]})}function a(o={}){const{wrapper:e}={...i(),...o.components};return e?n.jsx(e,{...o,children:n.jsx(t,{...o})}):t(o)}function r(o,e){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}export{a as default,c as frontmatter};
