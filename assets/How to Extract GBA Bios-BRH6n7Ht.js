import{u as s,j as e}from"./index-Dz3fli10.js";const l={title:"How to extract GBA BIOS",description:"Guide to extracting the GBA BIOS file for use on emulators",slug:"misc-dolphin-gba-bios",subCategory:"GBA"};function o(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Some games need a GBA BIOS file to load on emulators. If you see an error about the BIOS, you need a GBA BIOS to load that game. This guide has two methods for extracting the GBA BIOS file yourself."}),`
...
`]})]})}function r(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{r as default,l as frontmatter};
