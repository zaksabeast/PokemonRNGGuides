import{u as s,j as e}from"./index-DL1uiKxF.js";const l={title:"How to extract GBA BIOS",navDrawerTitle:"GBA Bios",description:"Step-by-step guide to extracting the GBA BIOS file for use with emulators like mGBA and VBA.",slug:"misc-dolphin-gba-bios",category:"GBA Tools",tag:"cfw"};function t(o){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Some games need a GBA BIOS file to load on emulators. If you see an error about the BIOS, you need a GBA BIOS to load that game. This guide has two methods for extracting the GBA BIOS file yourself."}),`
...
`]})]})}function d(o={}){const{wrapper:n}={...s(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{d as default,l as frontmatter};
