import{ic as t,j as e}from"./index-DgP8hX9Y.js";const l={title:"GBA BIOS File - What It Is and How to Extract It for Emulators",navDrawerTitle:"GBA Bios",description:"Learn what the GBA BIOS is, why emulators like mGBA and VBA need it, and how to legally extract it from real hardware. Step-by-step guide included.",slug:"misc-dolphin-gba-bios",category:"GBA Tools",section:"tool"};function s(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"What is the GBA BIOS?"}),`
`,e.jsx(n.p,{children:"The GBA BIOS is a small file (16 KB) that contains the Game Boy Advance's built-in firmware. It handles low-level system tasks like:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Starting the game."}),`
`,e.jsx(n.li,{children:"Running certain graphical and sound functions."}),`
`,e.jsx(n.li,{children:"Handling save types and resets."}),`
`]}),`
`,e.jsx(n.p,{children:"Many emulators need the GBA BIOS file to run games correctly. Without it, you may get errors, missing graphics, or incorrect behavior. This guide shows two legal ways to extract the GBA BIOS yourself."}),`
...
`]})]})}function r(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{r as default,l as frontmatter};
