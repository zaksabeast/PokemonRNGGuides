...
`]}),`
`,n.jsx(e.p,{children:"许多模拟器需要 GBA BIOS 文件才能正确运行游戏。如果没有它，可能会遇到错误、缺失的图形或异常行为。本教程展示了两种合法方法自行提取 GBA BIOS。"}),`
...
`,n.jsxs(e.li,{children:[n.jsx(e.a,{href:"https://3ds.hacks.guide/",children:"https://3ds.hacks.guide/"})," 有安装 CFW 的详细教程。"]}),`
...
`]})]})}function h(i={}){const{wrapper:e}={...l(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(s,{...i})}):s(i)}export{h as default,c as frontmatter};
