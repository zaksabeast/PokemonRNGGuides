import{ih as s,j as n}from"./index-DGbmpVsq.js";const c=[{title:"究极日月 实机获取孵蛋种子",description:"使用鲤鱼王法在《究极日月》中获取孵蛋乱数种子，无需破解。",slug:"zh-retail-usum-egg-seed-no-cfw",translation:{enSlug:"retail-usum-egg-seed-no-cfw",language:"zh"}},{title:"日月 实机获取孵蛋种子",description:"使用鲤鱼王法在《日月》中获取孵蛋乱数种子，无需破解。",slug:"zh-retail-sm-egg-seed-no-cfw",translation:{enSlug:"retail-sm-egg-seed-no-cfw",language:"zh"}}];function i(e){const l={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...s(),...e.components};return n.jsxs(n.Fragment,{children:[n.jsx(l.pre,{children:n.jsx(l.code,{children:`本教程适用于无法使用破解或自制系统（Homebrew）的玩家。如果你可以使用破解或 Homebrew，可以直接开始乱数，请参考相关教程。
`})}),`
...
`]}),`
`]}),`
`,n.jsxs(l.li,{children:["软重置后即可参照 ",n.jsx(l.a,{href:"/zh-retail-usum-egg-mmsc",children:"不同语言/闪耀呼符孵蛋乱数教程"})," 开始孵蛋乱数。"]}),`
`]}),`
