import{u as r,j as e}from"./index-B79ezZeD.js";const h=[{title:"Initial Seed Botting",description:"How to use the Initial Seed Bot for more control in your RNGs",slug:"frlg-seeding-bot",subCategory:"Emulator",tag:"emu"},{title:"初始种子自动刷取",description:"使用初始种子自动脚本，实现更高自由度的乱数控制",slug:"zh-frlg-seeding-bot",subCategory:"Emulator",tag:"emu",translation:{enSlug:"frlg-seeding-bot",language:"zh"}}];function s(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...i.components},{ShowIf:l}=n;return l||t("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(l,{slug:"/frlg-seeding-bot",children:[e.jsx(n.h3,{children:"Tools:"}),e.jsxs(n.ul,{children:[`
...
`]})]})]})}function o(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}function t(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{o as default,h as frontmatter};
