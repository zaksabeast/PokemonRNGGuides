import{u as r,j as n}from"./index-CsrGO9EE.js";const d={title:"初始种子自动刷取",description:"使用初始种子自动脚本，实现更高自由度的乱数控制",slug:"zh-frlg-seeding-bot",translation:{enSlug:"frlg-seeding-bot",language:"zh"}};function l(i){const e={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h3,{children:"所需工具："}),`
...
`,n.jsxs(e.ol,{children:[`
`,n.jsx(e.li,{children:"运行 Lua 脚本，在模拟器中按下 2 键进入初始种子自动刷取模式。"}),`
`,n.jsx(e.li,{children:"暂停模拟器。"}),`
`,n.jsx(e.li,{children:"重启模拟器。"}),`
`,n.jsx(e.li,{children:"按住 Select 键的同时，推进一帧（Ctrl + N）。"}),`
`,n.jsx(e.li,{children:"然后取消暂停，脚本将自动控制游戏，尝试命中你指定的初始种子。"}),`
`]}),`
