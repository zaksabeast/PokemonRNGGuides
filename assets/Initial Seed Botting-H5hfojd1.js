import{u as s,j as e}from"./index-Dz3fli10.js";const l={title:"Initial Seed Botting",description:"How to use the Initial Seed Bot for more control in your RNGs",slug:"frlg-seeding-bot",subCategory:"Emulator"};function i(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h3,{children:"Tools:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Latest version of the Lua Script"}),`
