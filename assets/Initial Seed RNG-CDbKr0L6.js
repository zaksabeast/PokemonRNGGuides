...
`,e.jsxs(n.p,{children:['Choose "New Game", then press ',e.jsx(n.code,{children:"B"})," to cancel and go back to the continue screen, which will switch the delay from even to odd, or vice versa."]})]})}function r(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{r as default,o as frontmatter};
