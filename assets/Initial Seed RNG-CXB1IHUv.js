import{ih as s,j as n}from"./index-VUQDAV2z.js";const h=[{title:"初始种子乱数",description:"如何在《钻石, 珍珠, 白金》中进行初始种子乱数",slug:"zh-dppt-initial-seed",translation:{enSlug:"dppt-initial-seed",language:"zh"}}];function l(i){const e={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...s(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.pre,{children:n.jsx(e.code,{children:`本教程假设你已经找到目标种子，在进行本教程前你需要知道目标种子和目标延迟。
`})}),`
...
`]})]})}function d(i={}){const{wrapper:e}={...s(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(l,{...i})}):l(i)}export{d as default,h as frontmatter};
