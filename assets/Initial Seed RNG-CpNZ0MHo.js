import{u as t,j as e}from"./index-W2y165gb.js";const h=[{title:"Diamond, Pearl, and Platinum Initial Seed RNG",navDrawerTitle:"Initial Seed RNG",description:"Learn how to RNG your initial seed in Diamond, Pearl, and Platinum.",slug:"dppt-initial-seed",category:"Diamond, Pearl, and Platinum",tag:"emu"},{title:"初始种子乱数",description:"如何在《钻石, 珍珠, 白金》中进行初始种子乱数",slug:"zh-dppt-initial-seed",category:"Diamond, Pearl, and Platinum",tag:"emu",translation:{enSlug:"dppt-initial-seed",language:"zh"}}];function l(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...t(),...i.components},{ShowIf:s}=n;return s||r("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(s,{slug:"/dppt-initial-seed",children:[e.jsx(n.pre,{children:e.jsx(n.code,{children:`This guide assumes you have found a target seed already. You need your target seed and delay before following this guide.
...
`]})]})]})}function a(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(l,{...i})}):l(i)}function r(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{a as default,h as frontmatter};
