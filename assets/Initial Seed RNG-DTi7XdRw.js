import{u as i,j as e}from"./index-D0Qe-G4V.js";const a={title:"Initial Seed RNG",description:"How to RNG an initial seed in Diamond, Pearl, and Platinum",slug:"dppt-initial-seed",subCategory:"Basic Knowledge"};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.pre,{children:e.jsx(n.code,{children:`This guide assumes you have found a target seed already. You need your target seed and delay before following this guide.
`})}),`
...
`,e.jsx(n.li,{children:"Set the date and time to hit your seed as shown in PokeFinder."}),`
...
`,e.jsx(n.li,{children:"Unpause your game and run until close to your target delay."}),`
...
`,e.jsxs(n.p,{children:['Choose "New Game", then press ',e.jsx(n.code,{children:"B"})," to cancel and go back to the continue screen, which will switch the delay from even to odd, or vice versa."]})]})}function r(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{r as default,a as frontmatter};
