...
`,e.jsx(n.p,{children:"At the screen to choose to continue your game, press the down arrow on the bottom touch screen to move the screen down, then press the up arrow to move it back up. This will switch the delay from even to odd, or vice versa."})]})}function r(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{r as default,a as frontmatter};
