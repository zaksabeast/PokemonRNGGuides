import{t as e}from"./jsx-runtime-DE3yYTa1.js";import{m as t}from"./index-CDIk4gy6.js";var n=e(),r={title:`心金魂银初始种子乱数`,description:`学习如何在《心金》和《魂银》中进行初始种子乱数。`,slug:`zh-hgss-initial-seed`,translation:{enSlug:`hgss-initial-seed`,language:`zh`}};function i(e){let r={a:`a`,code:`code`,h2:`h2`,h3:`h3`,img:`img`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.pre,{children:(0,n.jsx)(r.code,{children:`本教程假设你已经找到了目标种子。开始前请准备好目标种子和对应延迟值。
`})}),`
