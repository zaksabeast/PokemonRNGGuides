...
`,e.jsx(n.p,{children:'Choosing "New Game", then pressing B to cancel and go back to the continue screen will switch the delay from even to odd, or vice versa.'})]})}function r(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{r as default,a as frontmatter};
