import{u as r,j as e}from"./index-DgCEoGgy.js";const o={title:"Live Battery TID/SID RNG",description:"RNG for a specific TID/SID combination with more options than dead battery",slug:"emulator-rs-live-battery-tid",subCategory:"Emulator",tag:"emu"};function t(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.pre,{children:e.jsx(n.code,{children:`This guide will help you get cool TIDs for your RNG. If you don't care about TID, consider the Dead Battery TID/SID Abuse for fewer steps and simplicity.
`})}),`
