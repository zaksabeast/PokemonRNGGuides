import{ih as i,j as e}from"./index-7kvXYaHY.js";const a={title:"Ruby and Sapphire TID RNG",navDrawerTitle:"TID RNG",description:"Learn how to obtain your desired Trainer ID (TID) and Secret ID (SID) combo in Ruby and Sapphire.",slug:"emulator-rs-live-battery-tid",category:"Ruby and Sapphire",section:"other_rng",variant:"cfw-emu",guideKey:"rs-tid"};function s(r){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
