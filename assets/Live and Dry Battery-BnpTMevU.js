import{ii as i,j as n}from"./index-CLgpAzd3.js";const h={title:"红蓝宝石 电池有电 vs 无电 乱数对比",description:"了解红宝石与蓝宝石在电池有电和电池耗尽情况下的乱数方法差异，以及这些差异如何影响宝可梦结果。",slug:"zh-rs-battery",translation:{enSlug:"rs-battery",language:"zh"}};function s(l){const e={a:"a",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...i(),...l.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"前言"}),`
`,n.jsx(e.p,{children:"本教程解释了红宝石与蓝宝石在电池有电和无电状态下的乱数原理，适用于模拟器和实机用户，同时解答新手常见疑问。"}),`
