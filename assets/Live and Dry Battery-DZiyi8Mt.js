import{u as o,j as e}from"./index-B79ezZeD.js";const r={title:"Difference between Live and Dry Battery",description:"Discover the two ways to RNG on Ruby/Sapphire and learn their differences",slug:"rs-battery",subCategory:"Basic Knowledge",tag:"any"};function i(n){const t={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"This guide introduces Ruby/Sapphire RNG. It applies to all RNGers: Emu and Retail. It answers common questions for those new to RNG abuse."}),`
