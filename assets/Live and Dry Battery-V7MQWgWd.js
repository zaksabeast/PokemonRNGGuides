import{t as e}from"./jsx-runtime-CM7NP55Z.js";import{d as t}from"./index-Do7z222g.js";var n=e(),r={title:`红蓝宝石 电池有电 vs 无电 乱数对比`,description:`了解红宝石与蓝宝石在电池有电和电池耗尽情况下的乱数方法差异，以及这些差异如何影响宝可梦结果。`,slug:`zh-rs-battery`,translation:{enSlug:`rs-battery`,language:`zh`}};function i(e){let r={a:`a`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,strong:`strong`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h2,{children:`前言`}),`
...
`,(0,n.jsx)(r.li,{children:`不能使用对战录像功能`}),`
`]}),`
`,(0,n.jsxs)(r.p,{children:[`现在你也可以使用`,(0,n.jsx)(r.a,{href:`/emerald-painting-reseeding`,children:`绘画种子法`}),`改变初始种子。这使得你可以像有电池那样自由选择种子。`]}),`
