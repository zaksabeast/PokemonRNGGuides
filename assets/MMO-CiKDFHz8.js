import{ga as r,j as e}from"./index-B4_S8hb9.js";const a={title:"Legends Arceus MMO RNG",navDrawerTitle:"MMO RNG",description:"Learn how to RNG MMOs in Legends Arceus using Sysbot and PermuteMMO for shiny Pokémon.",slug:"sysbot-lpa-mmo",category:"Legends Arceus",section:"guide",variant:"cfw-emu"};function i(s){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`]}),`
`,e.jsx(n.p,{children:"Follow these steps to meet your target at the right time!"})]})}function o(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{o as default,a as frontmatter};
