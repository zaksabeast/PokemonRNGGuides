import{u as r,j as e}from"./index-D-8zJ8GY.js";const s=[{title:"Mystery Gift (Event) RNG",description:"RNG your events to have 6 IVs",slug:"retail-usum-mystery-gift",category:"Ultra Sun and Ultra Moon",tag:"cfw"},{title:"Mystery Gift (Event) RNG",description:"RNG your events to have 6 IVs",slug:"retail-sm-myster-gift",category:"Sun and Moon",tag:"cfw"}];function i(t){const n={a:"a",code:"code",em:"em",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
