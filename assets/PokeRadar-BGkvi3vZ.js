import{ih as h,j as n}from"./index-BhQmefpm.js";const c={title:"X 与 Y PokéRadar 乱数",description:"学习如何在《宝可梦 X / Y》中使用 PokéRadar 进行乱数，以获取异色宝可梦。",slug:"zh-xy-pokeradar",translation:{enSlug:"xy-pokeradar",language:"zh"}};function s(i){const e={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...h(),...i.components},{XyPokeRadar:l,YouTubeVideo:r}=e;return l||d("XyPokeRadar"),r||d("YouTubeVideo"),n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"视频指南"}),`
