import{A as l,j as e}from"./index-HRv3BEyr.js";const h={title:"X and Y PokeRadar RNG",navDrawerTitle:"PokeRadar RNG",description:"Learn how to RNG using the PokéRadar in X and Y for shiny Pokémon.",slug:"xy-pokeradar",category:"X and Y",tag:"cfw",addedOn:"2025-03-24"};function s(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...i.components},{XyPokeRadar:o,YouTubeVideo:r}=n;return o||t("XyPokeRadar"),r||t("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Video Guide"}),`
