import{ie as l,j as n}from"./index-Db5_DYnx.js";const h={title:"X and Y PokeRadar RNG",navDrawerTitle:"PokeRadar RNG",description:"Learn how to RNG using the PokéRadar in X and Y for shiny Pokémon.",slug:"xy-pokeradar",category:"X and Y",section:"pokemon_rng",variant:"cfw-emu",addedOn:"2025-03-24"};function s(i){const e={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...i.components},{XyPokeRadar:o,YouTubeVideo:r}=e;return o||t("XyPokeRadar"),r||t("YouTubeVideo"),n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"Video Guide"}),`
...
`,n.jsxs(e.li,{children:["Knock out or catch the Pokémon to start the chain of 1 and lock the species.",`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:"Chain 0 patches are not determined the same as chain 1 or higher. You must randomly encounter a Pokemon or use Wild RNG to get your species."}),`
`]}),`
`]}),`
`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{children:`Note: Avoid using roller skates, running into the wrong species, or stepping into empty patches - these will break your chain.
`})}),`
...
`]})]})}function c(i={}){const{wrapper:e}={...l(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(s,{...i})}):s(i)}function t(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default,h as frontmatter};
