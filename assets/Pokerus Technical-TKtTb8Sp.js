import{q as s,j as t}from"./index-C35y_d2F.js";const h={title:"Pokérus",navDrawerTitle:"Pokérus",description:"How Pokérus infection is triggered",slug:"gba-pokerus-technical",category:"GBA Technical Documentation",tag:"info",addedOn:"2025-05-13"};function r(n){const e={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...n.components},{Gist:i}=e;return i||a("Gist"),t.jsxs(t.Fragment,{children:[t.jsx(i,{children:t.jsx(e.p,{children:`Gist: Technical info about how Pokérus is triggered and understanding its
...
`]})]})}function l(n={}){const{wrapper:e}={...s(),...n.components};return e?t.jsx(e,{...n,children:t.jsx(r,{...n})}):r(n)}function a(n,e){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as default,h as frontmatter};
