import{id as o,j as e}from"./index-f4fDcrkY.js";const t=[{title:"绿宝石的宝可病毒",description:"如何感染宝可病毒",slug:"zh-emerald-pokerus-emu",translation:{enSlug:"emerald-pokerus-emu",language:"zh"}},{title:"红蓝宝石的宝可病毒",description:"如何感染宝可病毒",slug:"zh-rs-pokerus-emu",translation:{enSlug:"rs-pokerus-emu",language:"zh"}}];function d(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...o(),...i.components},{Gist:r,ShowIf:s,YouTubeVideo:c}=n;return r||l("Gist"),s||l("ShowIf"),c||l("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"要点：如何感染宝可病毒"}),`
