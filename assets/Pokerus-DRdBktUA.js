import{x as o,j as e}from"./index-B0psp3OQ.js";const t=[{title:"绿宝石的宝可病毒",description:"如何感染宝可病毒",slug:"zh-emerald-pokerus-emu",translation:{enSlug:"emerald-pokerus-emu",language:"zh"}},{title:"红蓝宝石的宝可病毒",description:"如何感染宝可病毒",slug:"zh-rs-pokerus-emu",translation:{enSlug:"rs-pokerus-emu",language:"zh"}}];function d(s){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...o(),...s.components},{Gist:l,ShowIf:i,YouTubeVideo:c}=n;return l||r("Gist"),i||r("ShowIf"),c||r("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"要点：如何感染宝可病毒"}),`
