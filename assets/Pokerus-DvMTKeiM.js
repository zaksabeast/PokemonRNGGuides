import{ie as a,j as e}from"./index-C1hgsWDD.js";const c=[{title:"Pokérus in Emerald",navDrawerTitle:"Pokérus",description:"How to be infected by Pokérus",slug:"emerald-pokerus-emu",category:"Emerald",section:"other_rng",variant:"cfw-emu",addedOn:"2025-05-09"},{title:"Pokérus in Ruby & Sapphire",navDrawerTitle:"Pokérus",description:"How to be infected by Pokérus",slug:"rs-pokerus-emu",category:"Ruby and Sapphire",section:"other_rng",variant:"cfw-emu",guideKey:"rs-pokerus",addedOn:"2025-05-09"}];function l(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...a(),...i.components},{Gist:s,ShowIf:t,YouTubeVideo:o}=n;return s||r("Gist"),t||r("ShowIf"),o||r("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Gist: Be infected by Pokérus"}),`
...
`]})]})}function h(i={}){const{wrapper:n}={...a(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(l,{...i})}):l(i)}function r(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,c as frontmatter};
