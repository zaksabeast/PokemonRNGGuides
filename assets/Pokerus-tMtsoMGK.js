import{u as a,j as e}from"./index-dW9s5FoR.js";const c=[{title:"Pokérus in Emerald",navDrawerTitle:"Pokérus",description:"How to be infected by Pokérus",slug:"emerald-pokerus-emu",category:"Emerald",tag:"emu",addedOn:"2025-05-09"},{title:"Pokérus in Ruby & Sapphire",navDrawerTitle:"Pokérus",description:"How to be infected by Pokérus",slug:"rs-pokerus-emu",category:"Ruby and Sapphire",tag:"emu",addedOn:"2025-05-09"}];function l(t){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...a(),...t.components},{Gist:s,ShowIf:i,YouTubeVideo:o}=n;return s||r("Gist"),i||r("ShowIf"),o||r("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Gist: Be infected by Pokérus"}),`
...
`,e.jsx(i,{slug:"/emerald-pokerus-emu",children:"Open mGBA."}),`
`,e.jsx(i,{slug:"/rs-pokerus-emu",children:e.jsx(n.p,{children:`Open mGBA. Make sure that "Reatime clock" is disabled (Tools -> Game
overrides...).`})}),`
`]}),`
...
`]}),`
`,e.jsx(o,{src:"https://www.youtube.com/embed/ySpe6-4xCNc"})]})}function h(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(l,{...t})}):l(t)}function r(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,c as frontmatter};
