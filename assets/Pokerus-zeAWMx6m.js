import{ii as o,j as e}from"./index-CEitD9YF.js";const t=[{title:"绿宝石的宝可病毒",description:"如何感染宝可病毒",slug:"zh-emerald-pokerus-emu",translation:{enSlug:"emerald-pokerus-emu",language:"zh"}},{title:"红蓝宝石的宝可病毒",description:"如何感染宝可病毒",slug:"zh-rs-pokerus-emu",translation:{enSlug:"rs-pokerus-emu",language:"zh"}}];function d(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...o(),...i.components},{Gist:r,ShowIf:s,YouTubeVideo:c}=n;return r||l("Gist"),s||l("ShowIf"),c||l("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"要点：如何感染宝可病毒"}),`
...
`,e.jsx(s,{slug:"/zh-emerald-pokerus-emu",children:"打开 mGBA。"}),`
`,e.jsx(s,{slug:"/zh-rs-pokerus-emu",children:e.jsx(n.p,{children:"打开 mGBA。请确保关闭了“实时时钟”（路径为 Tools -> Game overrides...）。"})}),`
`]}),`
...
`]}),`
`,e.jsx(c,{id:"ySpe6-4xCNc"}),`
`,e.jsx(n.h2,{children:"特别鸣谢"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"教程与脚本：RainingChain."}),`
...
`]})]})}function x(i={}){const{wrapper:n}={...o(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(d,{...i})}):d(i)}function l(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default,t as frontmatter};
