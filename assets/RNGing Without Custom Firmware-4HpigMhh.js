import{u as r,j as e}from"./index-BSisJWvV.js";const o=[{title:"RNGing without Custom Firmware",description:"Get your perfect Pokémon without custom firmware",slug:"retail-usum-no-cfw",category:"Ultra Sun and Ultra Moon",tag:"retail"},{title:"RNGing without Custom Firmware",description:"Get your perfect Pokémon without custom firmware",slug:"retail-sm-no-cfw",category:"Sun and Moon",tag:"retail"}];function i(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://www.dropbox.com/s/tqf13ht2f4bxt66/EonTimer-1_6.zip?dl=0#download",children:"EonTimer 1.6"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://emtimer.mizdra.net/SimpleTimer",children:"Emtimer"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://www.dropbox.com/s/aurp9y34j5rdbhv/ZomgTimer-V2_21.jar#download",children:"ZomgTimer 2.21"}),"."]}),`
`]}),`
`]}),`
...
`,e.jsx(n.p,{children:'"F" refers to real time: 1F = 1/60 second, which is the notation in Gen 3 and in EonTimer.'}),`
...
`,e.jsx(n.li,{children:`Target Frame: in F (1/60 seconds). For example, 3600 means 60 seconds. EonTimer may not be accurate since it's designed for Gen 3 consoles. This number is different from the target frame in 3DSRNGTool. We need to convert the Gen 7 frame into real time ("F") using 3DSRNGTool.`}),`
...
`,e.jsxs(n.li,{children:['A message box will pop up with "Set EonTimer for XXXXF. (YY.YYs) Z". Set XXXX as the Target Frame of EonTimer. ',e.jsx(n.code,{children:"Z"})," is how long this target frame will exist. For Blink Frame, it should be above 30."]}),`
`]}),`
...
`,e.jsxs(n.li,{children:["Put ",e.jsx(n.code,{children:"Target Frame + 12"})," into Frame Hit, click Update, and EonTimer will do the math and subtract 200 from Lag."]}),`
`]}),`
`]}),`
`]}),`
`]}),`
