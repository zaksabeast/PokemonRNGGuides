...
`,n.jsx(e.p,{children:"在本教程中，3DSRNGTool 结果列表中的一行称为一帧。当你在某一帧触发战斗或领取宝可梦时，称为命中该帧。"}),`
...
`,n.jsx(e.p,{children:"本教程使用 Mystic Timer 的第三世代模式。"}),`
`,n.jsxs(e.ul,{children:[`
