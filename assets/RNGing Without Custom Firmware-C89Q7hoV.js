...
- title: "Ultra Sun and Ultra Moon RNGing on retail"
  ...
  description: "RNG perfect Pokémon in Ultra Sun and Ultra Moon without using custom firmware."
  slug: "retail-usum-no-cfw"
  category: "Ultra Sun and Ultra Moon"
  tag: "retail"
- title: "Sun and Moon RNGing on retail"
  navDrawerTitle: "Retail RNG"
  description: "RNG perfect Pokémon in Sun and Moon without using custom firmware."
...
"F" refers to real time: 1F = 1/60 second, which is the notation in Gen 3 and in Mystic Timer.
...
1. Check [here](/retail-usum-initial-seed-clocks).
...
2. A message box will pop up with "Set EonTimer for XXXXF. (YY.YYs) Z". Set XXXX as the Target Frame of Mystic Timer. \`Z\` is how long this target frame will exist. For Blink Frame, it should be above 30.
