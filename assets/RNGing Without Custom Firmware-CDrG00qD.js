import{u as r,j as e}from"./index-BW1P0pDd.js";const o={title:"RNGing without Custom Firmware",description:"Get your perfect Pokémon without custom firmware",slug:"retail-sm-no-cfw",subCategory:"Retail",tag:"retail"};function i(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:["Check ",e.jsx(n.a,{href:"https://www.pokemonrng.com/retail-sm-initial-seed-clocks",children:"here"}),"."]}),`
