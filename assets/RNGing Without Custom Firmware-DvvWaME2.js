import{ga as r,j as e}from"./index-B4_S8hb9.js";const o=[{title:"Ultra Sun and Ultra Moon RNGing on retail",navDrawerTitle:"Retail RNG",description:"RNG perfect Pokémon in Ultra Sun and Ultra Moon without using custom firmware.",slug:"retail-usum-no-cfw",category:"Ultra Sun and Ultra Moon",section:"guide",variant:"retail"},{title:"Sun and Moon RNGing on retail",navDrawerTitle:"Retail RNG",description:"RNG perfect Pokémon in Sun and Moon without using custom firmware.",slug:"retail-sm-no-cfw",category:"Sun and Moon",section:"guide",variant:"retail",canonical:"retail-usum-no-cfw"}];function i(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
