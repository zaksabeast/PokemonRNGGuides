import{x as t,j as e}from"./index-Ko424vZg.js";const l={title:"Ruby and Sapphire Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokémon in Ruby and Sapphire for shiny and high-IV results.",slug:"emulator-rs-wild",category:"Ruby and Sapphire",isRoughDraft:!0,tag:"emu"};function i(r){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"This guide covers Fixed Initial Seed in Gen 3, specifically for RS dry and Emerald."}),`
