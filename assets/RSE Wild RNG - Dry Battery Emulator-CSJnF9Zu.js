import{u as t,j as e}from"./index-oUXE0eUa.js";const l={title:"Wild RNG",description:"Wild RNG",slug:"emulator-rs-wild",subCategory:"Emulator",isRoughDraft:!0};function i(r){const n={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"This guide covers Fixed Initial Seed in Gen 3, specifically for RS dry and Emerald."}),`
`,e.jsx(n.h2,{children:"Tools"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"VBA"}),`
`,e.jsx(n.li,{children:"Lua scripts (noob or project Pokémon one)"}),`
