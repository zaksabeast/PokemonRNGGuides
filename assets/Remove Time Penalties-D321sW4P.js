import{u as t,j as e}from"./index-xbVE49t9.js";const l={title:"Remove Time Penalties",description:"Change your Omega Ruby or Alpha Sapphire time without penalities!",slug:"oras-remove-time-penalty",category:"Omega Ruby and Alpha Sapphire",tag:"cfw",addedOn:"2025-03-14"};function s(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"The game will lock time based events for 24 hours when any of these happen:"}),`
