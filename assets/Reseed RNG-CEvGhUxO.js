import{u as h,j as e}from"./index-W2y165gb.js";const o=[{title:"Reseed the RNG using paintings",navDrawerTitle:"Painting RNG",description:"Learn how to reseed the RNG using paintings in Pokémon Emerald to get the Pokémon you want quickly, without the long wait.",slug:"emerald-painting-rng",category:"Emerald",tag:"any"},{title:"利用绘画重置种子",description:"利用绘画重置乱数，从而快速获得目标宝可梦，而无需长时间等待",slug:"zh-emerald-painting-rng",category:"Emerald",tag:"any",translation:{enSlug:"emerald-painting-rng",language:"zh"}}];function s(i){const n={a:"a",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...h(),...i.components},{PaintingReseed:t,ShowIf:r}=n;return t||l("PaintingReseed"),r||l("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(r,{slug:"/emerald-painting-rng",children:[e.jsx(n.h2,{children:"Tools"}),e.jsxs(n.ul,{children:[`
...
`]})]})]})}function d(i={}){const{wrapper:n}={...h(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}function l(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as default,o as frontmatter};
