import{u as l,j as e}from"./index-BnuqMJBs.js";const d=[{title:"Reseed using paintings",description:"Reseed the RNG using paintings to obtain the Pokémon wanted without the long wait",slug:"emerald-painting-rng",subCategory:"Emulator",tag:"any"},{title:"利用绘画重置种子",description:"利用绘画重置乱数，从而快速获得目标宝可梦，而无需长时间等待",slug:"zh-emerald-painting-rng",subCategory:"Emulator",tag:"any",hideFromNavDrawer:!0}];function s(i){const n={a:"a",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...l(),...i.components},{LanguageButton:r,ShowIf:t}=n;return r||h("LanguageButton"),t||h("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsx(r,{enSlug:"/emerald-painting-rng",zhSlug:"/zh-emerald-painting-rng"}),`
`,e.jsxs(t,{slug:"/emerald-painting-rng",children:[e.jsx(n.h2,{children:"Tools"}),e.jsxs(n.ul,{children:[`
...
`]})]})]})}function a(i={}){const{wrapper:n}={...l(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}function h(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{a as default,d as frontmatter};
