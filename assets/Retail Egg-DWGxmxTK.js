...
4. Make sure both parent Pokemon are over 400xp away from leveling up. **The RNG will fail if they level up in the daycare!**
5. Stand in front of the top right edge of the white path on Route 118.
6. Use the first repel.
...
4. Walk back and forth on the two tiles in front of the PokeCenter for 9 steps. **DO NOT** move anywhere else.
   - <Flex gap={16}>
       <Image
         pixelated
         alt="Tile 1"
...
5. Open and close the Pokedex this many times: **<RetailEmeraldEggStateText item="pokedex" />**
...
1. Pick up your egg from the daycare man and hatch it. If it's shiny, proceed to the next step.
2. If the egg wasn't shiny, fill in the tool below with the match call and egg nature.
3. Press "Find advances matching eggs" to view a list of possible eggs.
4. Press "Calibrate" on the egg with the offset closest to 0 to adjust the timer.
5. Restart the PID RNG process.

> [!TIP]
> No results? You may be outside the search window or miscounted Pokedex opens.
>
> - **Advance range:** expands how far from your target the tool searches.
> - **Pokedex range:** checks nearby counts if you miscounted openings.
...
1. Fill in the tool below. Leave any parent IV empty if you do not know it.
2. Press "Generate" to get a list of possible IVs.
3. Press "Select" on the target Pokemon you want to hatch.
...
- German translation: Parasite on Discord.
`;export{e as default};