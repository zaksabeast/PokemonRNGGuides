import{u as i,j as e}from"./index-D0vdH2gW.js";const t={title:"Entralink (Retail)",description:"A step-by-step guide for RNG manipulation using the C-Gear method in Pokémon Black and White.",slug:"retail-bw-entralink",category:"Black and White",isRoughDraft:!0,tag:"retail"};function r(s){const n={a:"a",code:"code",em:"em",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:e.jsx(n.em,{children:"Guide originally written by NickPlayeZ on Discord."})}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://github.com/DasAmpharos/EonTimer/releases",children:"Eon Timer"})}),`
`]}),`
...
`})}),`
`,e.jsx(n.h2,{children:"Step 3: Setting Up Eon Timer"}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:["Open ",e.jsx(n.strong,{children:"Eon Timer"}),", select the ",e.jsx(n.strong,{children:"Gen 5 tab"}),"."]}),`
...
`,e.jsxs(n.li,{children:["Start ",e.jsx(n.strong,{children:"Eon Timer"}),", then confirm time in console settings."]}),`
...
`,e.jsxs(n.li,{children:["If off by more than 5 delay, enter hit values in ",e.jsx(n.strong,{children:"Eon Timer"})," and update."]}),`
...
`]}),`
`,e.jsx(n.p,{children:"Congrats! You've now got your Pokémon!"})]})}function d(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}export{d as default,t as frontmatter};
