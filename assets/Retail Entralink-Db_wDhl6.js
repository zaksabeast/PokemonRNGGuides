import{u as i,j as e}from"./index-DDwjI0CZ.js";const t={title:"Entralink (Retail)",description:"A step-by-step guide for RNG manipulation using the C-Gear method in Pokémon Black and White.",slug:"retail-bw-entralink",subCategory:"Gen 5 RNG",isRoughDraft:!0,tag:"retail"};function r(s){const n={a:"a",code:"code",em:"em",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:e.jsx(n.em,{children:"Guide originally written by NickPlayeZ on Discord."})}),`
