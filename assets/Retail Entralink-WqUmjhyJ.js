import{ic as i,j as e}from"./index-BDxuoNMl.js";const l={title:"Black and White Retail Entralink RNG",navDrawerTitle:"Entralink RNG",description:"Learn how to RNG Pokémon exclusive to the Entralink in Black and White, including event-only encounters like Arceus.",slug:"retail-bw-entralink",category:"Black and White",isRoughDraft:!0,section:"pokemon_rng",variant:"retail"};function r(s){const n={a:"a",code:"code",em:"em",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:e.jsx(n.em,{children:"Guide originally written by NickPlayeZ on Discord."})}),`
