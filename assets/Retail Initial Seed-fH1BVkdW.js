import{ii as s,j as n}from"./index-CEitD9YF.js";const c={title:"钻石珍珠白金 实机初始种子乱数",description:"学习如何在实机上对钻石、珍珠与白金的初始种子进行乱数。",slug:"zh-dppt-initial-seed-retail",translation:{enSlug:"dppt-initial-seed-retail",language:"zh"}};function l(i){const e={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...s(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.pre,{children:n.jsx(e.code,{children:`本教程默认你已经找到目标种子。开始前请准备好目标种子和延迟值。
`})}),`
...
`,n.jsxs(e.ol,{children:[`
`,n.jsx(e.li,{children:"根据你正在使用的乱数流程教程，校准种子。"}),`
