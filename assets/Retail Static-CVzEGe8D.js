...
<Stepper titles={["Set up", "Pick a Pokemon", "Get the Pokemon", "Calibrate Advances"]}>
...
1. Immediately open your party menu when the save loads.
2. Open Chatot's summary screen **<Static4ChatotCount />** times. This advances the RNG to the correct position.
3. Exit the party menu and catch or receive your target Pokémon.

<Alert
  type="info"
  showIcon
  message="Switching between two Chatot summaries is faster than repeatedly opening and closing the same summary!"
/>
...
<Alert
  type="info"
  showIcon
  message="If you can't find the Pokémon you hit, increase the advance range, delay range, and/or seconds range in the calibrator to expand your search."
/>
