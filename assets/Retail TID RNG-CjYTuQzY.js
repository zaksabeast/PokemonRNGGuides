import{ii as h,j as e}from"./index-CLtitZ5z.js";const j={title:"红蓝宝石实机TID乱数教程",description:"学习如何在红宝石和蓝宝石中获取你想要的TID和SID组合。",slug:"zh-retail-rubysapphire-tid",translation:{enSlug:"retail-rubysapphire-tid",language:"zh"}};function o(i){const n={code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",ul:"ul",...h(),...i.components},{RsTidSearcher:l,RsTidSidGenerator:t,RsTidTimer:c,Step:s,Stepper:d}=n;return l||r("RsTidSearcher"),t||r("RsTidSidGenerator"),c||r("RsTidTimer"),s||r("Step"),d||r("Stepper"),e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"在第三世代中进行乱数操作，可以让你获得精确的TID与SID组合。这在想要获取特定异色宝可梦时非常有用，因为你可以预知自己的SID。"}),`
`,e.jsx(n.p,{children:"本教程适用于红宝石/蓝宝石电池已耗尽的卡带。如果你的卡带电池仍正常运作，本方法将无法使用。"}),`
...
`,e.jsx(n.li,{children:"Shiny_Sylveon：撰写本教程"}),`
