...
1. 将主机日期设置为 **<Gen4ConsoleSetDateString format="date" />**。
2. 进入设置时间界面，将时间设置为 **<Gen4ConsoleSetDateString format="time" />**，但不要立刻确认。
...
2. <Gen4ShowIf is3dsNormalSettings>
   ...
   <Gen4ShowIf isNdsDsi>退出主机上的设置并重启主机。</Gen4ShowIf>
3. 第一声计时器响起时，<Gen4ShowIf is3dsNormalSettings is3dsAltSettings>按 \`L + R + Start + Select\` 软重启游戏</Gen4ShowIf><Gen4ShowIf isNdsDsi>按 \`A\` 启动游戏</Gen4ShowIf>。
