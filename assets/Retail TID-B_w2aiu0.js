...
Fill out the tool below. If you want random max shiny odds during your playthrough, leave the default settings.
...
> [!TIP]
> If you don't have enough time to reach the last screen before the timer goes off, go to the previous step and search for a TID with a higher "Max Delay" to give more time.
...
2. Type your TID into the box below and click "Generate".
3. Click "Calibrate" on the TID with the smallest delay offset (should be the first result).
4. If the "Flip Delay" column is checked, you'll need to swap between the player name characters one extra time, e.g. lower to upper case. Japanese games will need to switch to a different kana, eg. from Hiragana to Katakana.
5. Try to hit your target again. This can take multiple attempts.
...
> [!WARNING]
> Write down your TID and SID! Both are needed to RNG shiny Pokemon!
>
> **Your TID and SID: <Id4Tid /> / <Id4Sid />**

Target TID: <Id4Tid /> / SID: <Id4Sid />
