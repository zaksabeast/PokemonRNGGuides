import{q as g,j as e}from"./index-CHQRQ4fA.js";const y=[{title:"HeartGold and SoulSilver Cute Charm Glitch TID/SID RNG",navDrawerTitle:"Cute Charm & TID/SID RNG",description:"Learn how to use the Cute Charm Glitch and obtain a specific Trainer ID (TID) and Secret ID (SID) combo on Retail for HeartGold and SoulSilver.",slug:"hgss-tid-sid",category:"HeartGold and SoulSilver",tag:"retail",addedOn:"2025-06-08"},{title:"HeartGold and SoulSilver Cute Charm Glitch TID/SID RNG",navDrawerTitle:"Cute Charm & TID/SID RNG",description:"Learn how to use the Cute Charm Glitch and obtain a specific Trainer ID (TID) and Secret ID (SID) combo on Retail for HeartGold and SoulSilver.",slug:"dppt-tid-sid",category:"Diamond, Pearl, and Platinum",tag:"retail",addedOn:"2025-06-08"}];function p(i){const t={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...g(),...i.components},{Alert:o,CalibrateId4:a,Gen4IdSetup:l,Gist:d,Id4ConsoleSetDateString:s,Id4Searcher:h,Id4ShowIf:c,Id4Timer:u,Metronome3dsNotice:x,Step:r,Stepper:m,YouTubeVideo:j}=t;return o||n("Alert"),a||n("CalibrateId4"),l||n("Gen4IdSetup"),d||n("Gist"),s||n("Id4ConsoleSetDateString"),h||n("Id4Searcher"),c||n("Id4ShowIf"),u||n("Id4Timer"),x||n("Metronome3dsNotice"),r||n("Step"),m||n("Stepper"),j||n("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Video Guide"}),`
`,e.jsx(j,{src:"https://www.youtube.com/embed/4mLxKXYWgvs?si=TCxi_1teMmMLdra9"}),`
...
`,e.jsxs(m,{titles:["Set up","Pick a TID","Hit Target","Calibrate"],children:[e.jsxs(r,{step:0,children:[e.jsx(t.h2,{children:"Set up"}),e.jsx(t.p,{children:"Choose the game you're playing below then continue to the next step."}),e.jsx(l,{})]}),e.jsxs(r,{step:1,children:[e.jsx(t.h2,{children:"Pick a TID"}),e.jsx(t.p,{children:"Fill our the tool below. If you want random max shiny odds during your playthrough, leave the default settings."}),e.jsx(h,{})]}),e.jsxs(r,{step:2,children:[e.jsx(t.h2,{children:"Prepare"}),e.jsxs(t.ol,{children:[`
...
`]})]})}function S(i={}){const{wrapper:t}={...g(),...i.components};return t?e.jsx(t,{...i,children:e.jsx(p,{...i})}):p(i)}function n(i,t){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{S as default,y as frontmatter};
