import{q as j,j as e}from"./index-C7PTtfVT.js";const g=[{title:"HeartGold and SoulSilver Cute Charm Glitch TID/SID RNG",navDrawerTitle:"Cute Charm & TID/SID RNG",description:"Learn how to use the Cute Charm Glitch and obtain a specific Trainer ID (TID) and Secret ID (SID) combo on Retail for HeartGold and SoulSilver.",slug:"hgss-tid-sid",category:"HeartGold and SoulSilver",tag:"retail",addedOn:"2025-06-08"},{title:"HeartGold and SoulSilver Cute Charm Glitch TID/SID RNG",navDrawerTitle:"Cute Charm & TID/SID RNG",description:"Learn how to use the Cute Charm Glitch and obtain a specific Trainer ID (TID) and Secret ID (SID) combo on Retail for HeartGold and SoulSilver.",slug:"dppt-tid-sid",category:"Diamond, Pearl, and Platinum",tag:"retail",addedOn:"2025-06-08"}];function x(i){const t={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...j(),...i.components},{Alert:o,CalibrateId4:a,Gen4IdSetup:l,Gist:d,Id4ConsoleSetDateString:s,Id4Searcher:h,Id4Timer:c,Step:r,Stepper:u,YouTubeVideo:m}=t;return o||n("Alert"),a||n("CalibrateId4"),l||n("Gen4IdSetup"),d||n("Gist"),s||n("Id4ConsoleSetDateString"),h||n("Id4Searcher"),c||n("Id4Timer"),r||n("Step"),u||n("Stepper"),m||n("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Video Guide"}),`
`,e.jsx(m,{src:"https://www.youtube.com/embed/4mLxKXYWgvs?si=TCxi_1teMmMLdra9"}),`
...
`]})]})}function y(i={}){const{wrapper:t}={...j(),...i.components};return t?e.jsx(t,{...i,children:e.jsx(x,{...i})}):x(i)}function n(i,t){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{y as default,g as frontmatter};
