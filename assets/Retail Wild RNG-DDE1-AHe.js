import{ii as r,j as e}from"./index-CLtitZ5z.js";const o={title:"Emerald Retail Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokémon in Pokémon Emerald on a retail console for perfect IVs, natures, and shinies.",slug:"retail-emerald-wild",category:"Emerald",section:"pokemon_rng",variant:"retail"};function t(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Requirements:"}),`
...
`]}),`
`,e.jsx(n.h2,{children:"Step 2: Set Up Mystic Timer"}),`
`,e.jsxs(n.ol,{children:[`
