import{u as t,j as e}from"./index-CpyEa1Z6.js";const i={title:"Gen 5 Roamers",description:"RNG Gen 5 Roamers with an Emulator",slug:"emulator-bw-roamers",subCategory:"Emulator"};function s(r){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(n.li,{children:"Set the Encounter Type to Roaming Pokemon and Method as IVs (Standard Seed)"}),`
`,e.jsx(n.li,{children:"Make sure to set a nice IV Spread and do NOT worry about Shininess right now"}),`
`]}),`
...
`,e.jsx(n.p,{children:"Before we only searched for an IV spread because TID Abuse is recommend for Shiny Roamers with good IVS."}),`
...
`})}),`
`,e.jsx(n.p,{children:"Choose a Frame (recommended: at least 1500 Frames, perhaps 2000 if you are using a month other than 2 or 11.) Note the PID and of course, the Frame."}),`
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/images/Black-and-White/Roamer/Pandora.png",alt:"Pandora's Box"})}),`
`,e.jsx(n.h2,{children:"Step 3: Save preperation"}),`
...
`,e.jsx(n.li,{children:"Make sure to get your TID/SID and get to the point at which you can release the roamer."}),`
...
`,e.jsx(n.p,{children:"On the original RNG Reporter Screen, you got a Frame Number, most likely between 1-6."}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:["Advance frames by walking around in the house.",`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"It advances every 128 Steps multiplied by the amount of Pokemon in your Party."}),`
`]}),`
`]}),`
...
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`Note: It will most likely not have hit your Frame. You can check your PokeDex to see if you succeeded. (Assuming you are aiming for a Shiny)
`})}),`
...
`,e.jsx(n.li,{children:"In the main screen, enter your Seed and make sure it searches Generation 5 PIDRNG Abuse."}),`
...
`,e.jsxs(n.li,{children:["Try and hit this new target frame. If you do not hit your Pokemon",`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Repeat these steps once more."}),`
`]}),`
`]}),`
`,e.jsx(n.li,{children:"You will need to repeat this multiple times, but you will prevail eventually."}),`
`,e.jsxs(n.li,{children:["Keep track of what Frames you have hit and what Frame you have pressed ",e.jsx(n.code,{children:"A"})," on before in Notepad or Google Docs."]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"/images/Black-and-White/Roamer/Success.png",alt:"Success"})}),`
`,e.jsx(n.h2,{children:"Celebrate!"}),`
`,e.jsx(n.p,{children:"Catch your Roamer with a Master Ball or use a Mean Look/Arena Trap/Shadow Tag Trapper. Then, share your success with your friends or the PCalc Discord's bragging channel."})]})}function o(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(s,{...r})}):s(r)}export{o as default,i as frontmatter};
