import{u as s,j as e}from"./index-BfZU7Jyg.js";const o={title:"Black and White Roamer RNG",navDrawerTitle:"Roamer RNG",description:"Learn how to RNG Tornadus and Thundurus in Black and White for shiny and high-IV results.",slug:"emulator-bw-roamers",category:"Black and White",tag:"emu"};function t(r){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...s(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(n.p,{children:"Catch your roamer with a Master Ball or use a Mean Look/Arena Trap/Shadow Tag Trapper. Then share your success with your friends or the Pokemon RNG Discord's bragging channel."})]})}function i(r={}){const{wrapper:n}={...s(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{i as default,o as frontmatter};
