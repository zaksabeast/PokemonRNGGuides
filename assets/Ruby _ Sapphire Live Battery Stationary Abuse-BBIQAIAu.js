import{x as s,j as n}from"./index-B0psp3OQ.js";const c={title:"有电电池定点乱数",description:"在红宝石和蓝宝石中轻松乱数完美异色传说宝可梦",slug:"zh-emulator-rs-stationary",translation:{enSlug:"emulator-rs-stationary",language:"zh"}};function l(i){const e={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...s(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
