import{u as s,j as e}from"./index-C7pESl3A.js";const a={title:"Live Battery Stationary RNG",description:"RNG stationary Pokemon with more options than dead battery",slug:"emulator-rs-stationary",subCategory:"Emulator"};function t(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
