import{u as s,j as e}from"./index-Df4k8dKg.js";const a=[{title:"Ultra Sun and Ultra Moon SOS RNG",navDrawerTitle:"SOS RNG",description:"Master one of the most challenging Gen 7 RNGs for fun rewards",slug:"retail-usum-sos",category:"Ultra Sun and Ultra Moon",tag:"cfw"},{title:"Sun and Moon SOS RNG",navDrawerTitle:"SOS RNG",description:"Master one of the most challenging Gen 7 RNGs for fun rewards",slug:"retail-sm-sos",category:"Sun and Moon",tag:"cfw"}];function t(i){const n={a:"a",code:"code",em:"em",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...i.components},{ShowIf:l}=n;return l||r("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
