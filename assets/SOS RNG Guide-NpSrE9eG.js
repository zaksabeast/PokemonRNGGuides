import{u as s,j as e}from"./index-Cs618k7T.js";const a=[{title:"SOS RNG",description:"Master one of the most challenging Gen 7 RNGs for fun rewards",slug:"retail-usum-sos",category:"Ultra Sun and Ultra Moon",tag:"cfw"},{title:"SOS RNG",description:"Master one of the most challenging Gen 7 RNGs for fun rewards",slug:"retail-sm-sos",category:"Sun and Moon",tag:"cfw"}];function t(i){const n={a:"a",code:"code",em:"em",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...i.components},{ShowIf:l}=n;return l||r("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["A 3DS with PCalc (",e.jsx(n.a,{href:"https://www.pokemonrng.com/misc-3ds-installing-pcalc",children:"PCalc Installation Guide"}),")"]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["For a guide to Gen 7 wild RNG, check ",e.jsx(n.a,{href:"https://www.pokemonrng.com/retail-usum-wild",children:"here"}),"."]}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
