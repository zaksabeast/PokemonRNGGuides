import{u as l,j as e}from"./index-CGmfAh1t.js";const o={title:"SOS RNG",description:"One of the most challenging Gen 7 RNGs with fun rewards",slug:"retail-sm-sos",subCategory:"Custom Firmware"};function t(i){const n={a:"a",code:"code",em:"em",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`]}),`
`]}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://gist.github.com/RichardPaulAstley/42fbabe24250969f22d18fe8b919c520",children:"Encounter slots Sun"})}),`
`,e.jsx(n.li,{children:"Encounter Slots for Moon are missing. However you should be able to figure out the differences without any issue. We'll try to provide a guide later."}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`Note: The screen you'll see below are based on USUM but SOS RNG for SM is exactly the same. Just use your profile and follow the guide without worrying about any difference!
`})}),`
