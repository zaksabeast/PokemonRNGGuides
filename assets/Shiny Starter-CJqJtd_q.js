import{ig as h,j as e}from"./index-DzE52BtD.js";const c=[{title:"Shiny Starter",description:"Determine your SID by catching a shiny starter",slug:"emerald-shiny-starter",category:"Emerald",section:"pokemon_rng",variant:"retail",orderPriority:0,addedOn:"2025-05-03"}];function l(n){const t={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...h(),...n.components},{GenerateHoennTidSid:r,Gist:s,ShinyHoennStarter:o}=t;return r||i("GenerateHoennTidSid"),s||i("Gist"),o||i("ShinyHoennStarter"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Gist: Determine your SID by catching a shiny starter"}),`
...
`,e.jsx(t.li,{children:"Guide and interactive tool: RainingChain."}),`
`,e.jsx(t.li,{children:"Gen3 static generator tool: EzPz."}),`
`,e.jsx(t.li,{children:"Chinese translation: xuanyelin, Hakuhiro."}),`
`]})]})}function d(n={}){const{wrapper:t}={...h(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(l,{...n})}):l(n)}function i(n,t){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as default,c as frontmatter};
