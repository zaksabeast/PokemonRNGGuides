import{id as h,j as n}from"./index-f4fDcrkY.js";const t=[{title:"异色御三家",description:"通过捕捉异色御三家确定你的 SID",slug:"zh-emerald-shiny-starter",translation:{enSlug:"emerald-shiny-starter",language:"zh"}}];function c(i){const e={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...h(),...i.components},{GenerateHoennTidSid:s,Gist:r,ShinyHoennStarter:d}=e;return s||l("GenerateHoennTidSid"),r||l("Gist"),d||l("ShinyHoennStarter"),n.jsxs(n.Fragment,{children:[n.jsx(r,{children:"要点：通过捕捉异色御三家确定你的 SID"}),`
...
`]})]})}function x(i={}){const{wrapper:e}={...h(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(c,{...i})}):c(i)}function l(i,e){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default,t as frontmatter};
