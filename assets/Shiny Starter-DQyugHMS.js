import{ii as h,j as e}from"./index-LvUs4p4f.js";const a=[{title:"Shiny Starter",navDrawerTitle:"Shiny Starter",description:"Bestimme deine SID, indem du einen Shiny Starter fängst",slug:"de-emerald-shiny-starter",translation:{enSlug:"emerald-shiny-starter",language:"de"}}];function l(i){const n={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...h(),...i.components},{GenerateHoennTidSid:t,Gist:s,ShinyHoennStarter:d}=n;return t||r("GenerateHoennTidSid"),s||r("Gist"),d||r("ShinyHoennStarter"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Bestimme deine SID, indem du einen Shiny Starter fängst."}),`
