import{u as s,j as e}from"./index-DLt_I1kn.js";const r={title:"Shiny WISHMKR Jirachi RNG using wishmaker-calc",description:"RNG Jirachi from the Colosseum bonus disc",slug:"emulator-rs-wishmaker",subCategory:"Emulator"};function a(n){const i={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.h2,{children:"Tools"}),`
`,e.jsxs(i.ul,{children:[`
`,e.jsx(i.li,{children:e.jsx(i.a,{href:"https://github.com/TASVideos/vba-rerecording/releases",children:"VBA-RR"})}),`
`,e.jsxs(i.li,{children:["Lua .dll files",`
`,e.jsxs(i.ul,{children:[`
`,e.jsx(i.li,{children:e.jsx(i.a,{href:"https://www.dropbox.com/s/2o4hdphn7j9z349/lua-dll-x86.zip?dl=0",children:"x86.dll"})}),`
`,e.jsx(i.li,{children:e.jsx(i.a,{href:"https://www.dropbox.com/s/t8yttukleqserzp/lua-dll-x64.rar?dl=0",children:"x64.dll"})}),`
`]}),`
`]}),`
`,e.jsx(i.li,{children:e.jsx(i.a,{href:"https://zaksabeast.github.io/wishmaker-calc/build/",children:"wishmaker-calc"})}),`
`,e.jsx(i.li,{children:e.jsx(i.a,{href:"https://github.com/beatlynx/lua-stuff/blob/master/scripts/wishmakerlua.lua",children:"wishmaker lua script"})}),`
`]}),`
...
`,e.jsx(i.li,{children:"Open Ruby/Sapphire on VBA-RR and load the wishmaker lua script."}),`
...
`,e.jsx(i.li,{children:"In VBA-RR, export your battery file and upload it to wishmaker-calc by clicking on Jirachi."}),`
...
`,e.jsx(i.h2,{children:"Methods to redeem Jirachi"}),`
`,e.jsx(i.p,{children:"You can redeem your Jirachi by moving your save file to a real cartridge and using a real bonus disc, or by emulating the bonus disc with Dolphin."}),`
`,e.jsxs(i.p,{children:["A guide on connecting VBA to Dolphin can be found ",e.jsx(i.a,{href:"https://pokemonrng.com/guides/tools/en/How%20to%20Connect%20Dolphin%20to%20VBA/",children:"here"}),"."]})]})}function l(n={}){const{wrapper:i}={...s(),...n.components};return i?e.jsx(i,{...n,children:e.jsx(a,{...n})}):a(n)}export{l as default,r as frontmatter};
