import{ih as a,j as e}from"./index-VUQDAV2z.js";const i={title:"HeartGold and SoulSilver Special Wild RNG",navDrawerTitle:"Special Wild RNG",description:"Special Wild RNG",slug:"emulator-hgss-special-wild",category:"HeartGold and SoulSilver",isRoughDraft:!0,section:"pokemon_rng",variant:"cfw-emu"};function o(n){const t={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...a(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"This covers:"}),`
...
`,e.jsxs(t.ul,{children:[`
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/desmume-setup",children:"Desmume"}),"."]}),`
...
`})}),`
`,e.jsx(t.p,{children:"Update 3: The seed seems random. Sometimes you'll have to do the -1 frame, and sometimes you won't."})]})}function s(n={}){const{wrapper:t}={...a(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{s as default,i as frontmatter};
