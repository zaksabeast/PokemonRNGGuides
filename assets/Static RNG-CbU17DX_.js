import{u as s,j as e}from"./index-B79ezZeD.js";const h=[{title:"Static RNG",description:"Get shiny 6IV legendaries from FRLG",slug:"emulator-flrg-stationary-and-gift",subCategory:"Emulator",tag:"emu"},{title:"固定宝可梦乱数",description:"在《火红·叶绿》中获取闪光六项个体值的传说宝可梦",slug:"zh-emulator-flrg-stationary-and-gift",subCategory:"Emulator",tag:"emu",translation:{enSlug:"emulator-flrg-stationary-and-gift",language:"zh"}}];function r(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",ul:"ul",...s(),...i.components},{ShowIf:l}=n;return l||t("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(l,{slug:"/emulator-flrg-stationary-and-gift",children:[e.jsx(n.h2,{children:"Tools"}),e.jsxs(n.ul,{children:[`
