import{ga as a,j as e}from"./index-B4_S8hb9.js";const s={title:"FireRed and LeafGreen Static RNG",navDrawerTitle:"Static RNG",description:"Static v2 RNG",slug:"emulator-frlg-stationary",category:"FireRed and LeafGreen",isRoughDraft:!0,section:"guide",variant:"cfw-emu"};function r(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(n.p,{children:"Congrats! You're done!"})]})}function i(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{i as default,s as frontmatter};
