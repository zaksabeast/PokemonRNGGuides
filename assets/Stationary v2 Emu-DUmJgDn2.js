import{u as o,j as e}from"./index-DItXQha8.js";const s={title:"Stationary v2 RNG",description:"Stationary v2 RNG",slug:"emulator-frlg-stationary",subCategory:"Emulator",isRoughDraft:!0,tag:"emu"};function t(r){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...o(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(n.p,{children:"Congrats! You're done!"})]})}function i(r={}){const{wrapper:n}={...o(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{i as default,s as frontmatter};
