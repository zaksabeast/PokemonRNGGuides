import{ie as s,j as e}from"./index-DBJVNOlg.js";const a={title:"Brilliant Diamond and Shining Pearl Static RNG",navDrawerTitle:"Static RNG",description:"Learn how to RNG flawless or shiny legendaries in Brilliant Diamond and Shining Pearl using CFW.",slug:"cfw-bdsp-stationary",category:"Brilliant Diamond and Shining Pearl",section:"pokemon_rng",variant:"cfw-emu"};function i(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["A Switch with CaptureSight (",e.jsx(n.a,{href:"/install-capturesight",children:"CaptureSight Install Guide"}),")"]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["See the ",e.jsx(n.a,{href:"/bdsp-advance-rng",children:"Advancing the RNG guide"})," for the different ways the RNG can be advanced to reach a target advance."]}),`
`]}),`
`]}),`
