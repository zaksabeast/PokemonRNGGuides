import{q as r,j as n}from"./index-C7PTtfVT.js";const d={title:"定点乱数",description:"如何在钻石珍珠和白金中对固定遇敌的宝可梦进行乱数",slug:"zh-emulator-dppt-stationary",translation:{enSlug:"emulator-dppt-stationary",language:"zh"}};function i(l){const e={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...l.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
