import{ih as r,j as n}from"./index-DGbmpVsq.js";const h={title:"定点乱数",description:"如何在钻石珍珠和白金中对固定遇敌的宝可梦进行乱数",slug:"zh-emulator-dppt-stationary",translation:{enSlug:"emulator-dppt-stationary",language:"zh"}};function l(i){const e={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
...
`,n.jsxs(e.p,{children:["请参考",n.jsx(e.a,{href:"/dppt-initial-seed",children:"此教程"}),"来进行初始种子乱数。"]}),`
`,n.jsx(e.h2,{children:"推进帧数"}),`
`,n.jsxs(e.p,{children:["请参考",n.jsx(e.a,{href:"/dppt-advance-rng",children:"此教程"}),"来推进帧数。"]}),`
...
`]})]})}function d(i={}){const{wrapper:e}={...r(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(l,{...i})}):l(i)}export{d as default,h as frontmatter};
