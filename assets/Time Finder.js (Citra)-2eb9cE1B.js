import{u as a,j as e}from"./index-BSisJWvV.js";const d=[{title:"Time Finder (Citra)",description:"Finding times to get specific RNG seeds",slug:"emulator-usum-time-finder",category:"Ultra Sun and Ultra Moon",tag:"emu"},{title:"Time Finder (Citra)",description:"Finding times to get specific RNG seeds",slug:"emulator-sm-time-finder",category:"Sun and Moon",tag:"emu"}];function r(t){const n={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...a(),...t.components},{ShowIf:i}=n;return i||s("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
