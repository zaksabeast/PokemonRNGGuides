import{ih as l,j as n}from"./index-BsTu5YyI.js";const d=[{title:"究极日月 模拟器初始种子时间查找器（Citra）",description:"通过时间查找特定初始乱数种子的方法。",slug:"zh-emulator-usum-time-finder",translation:{enSlug:"emulator-usum-time-finder",language:"zh"}},{title:"日月 模拟器初始种子时间查找器（Citra）",description:"通过时间查找特定初始乱数种子的方法。",slug:"zh-emulator-sm-time-finder",translation:{enSlug:"emulator-sm-time-finder",language:"zh"}}];function t(i){const e={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...l(),...i.components},{ShowIf:r}=e;return r||s("ShowIf"),n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
