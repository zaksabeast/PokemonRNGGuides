import{t as e}from"./jsx-runtime-4Jp-jQG6.js";import{d as t}from"./index-DzYB2I0T.js";var n=e(),r=[{title:`究极日月 模拟器初始种子时间查找器（Citra）`,description:`通过时间查找特定初始乱数种子的方法。`,slug:`zh-emulator-usum-time-finder`,translation:{enSlug:`emulator-usum-time-finder`,language:`zh`}},{title:`日月 模拟器初始种子时间查找器（Citra）`,description:`通过时间查找特定初始乱数种子的方法。`,slug:`zh-emulator-sm-time-finder`,translation:{enSlug:`emulator-sm-time-finder`,language:`zh`}}];function i(e){let r={code:`code`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,ul:`ul`,...t(),...e.components},{ShowIf:i}=r;return i||o(`ShowIf`,!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h2,{children:`所需工具`}),`
