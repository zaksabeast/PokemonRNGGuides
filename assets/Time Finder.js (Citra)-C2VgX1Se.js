import{ga as a,j as e}from"./index-B4_S8hb9.js";const d=[{title:"Ultra Sun and Ultra Moon Time Finder (Citra)",navDrawerTitle:"Time Finder",description:"Finding times to get specific RNG seeds.",slug:"emulator-usum-time-finder",category:"Ultra Sun and Ultra Moon",section:"guide",variant:"cfw-emu"},{title:"Sun and Moon Time Finder (Citra)",navDrawerTitle:"Time Finder",description:"Finding times to get specific RNG seeds.",slug:"emulator-sm-time-finder",category:"Sun and Moon",section:"guide",variant:"cfw-emu",canonical:"emulator-usum-time-finder"}];function r(t){const n={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...a(),...t.components},{ShowIf:i}=n;return i||s("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(i,{slug:"/emulator-usum-time-finder",children:e.jsx(n.p,{children:"The default offset and tick values may not match. These values differ by the version of Citra and are just suggestions. For example, Citra Nightly 1543 has an offset of 3730114 and a tick of 55."})}),`
`,e.jsx(i,{slug:"/emulator-sm-time-finder",children:e.jsx(n.p,{children:"The default offset and tick values may not match. These values differ by the version of Citra and are just suggestions. For example, Citra Nightly 1543 has an offset of 4470937 and a tick of 56."})}),`
`,e.jsxs(n.ol,{children:[`
...
`,e.jsx(n.li,{children:"In the Offset Range, enter a small number like 10."}),`
`,e.jsx(n.li,{children:"In the Tick Range, enter a large number, like 50,000,000."}),`
...
`})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`Note: If you find a result, its counterpart will have the same profile, so you can copy it for each game.
`})}),`
...
`})})]})}function l(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}function s(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as default,d as frontmatter};
