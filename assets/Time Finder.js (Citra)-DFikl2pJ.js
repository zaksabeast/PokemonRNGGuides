import{u as r,j as e}from"./index-BW1P0pDd.js";const s={title:"Time Finder (Citra)",description:"Finding times to get specific RNG seeds",slug:"emulator-usum-time-finder",subCategory:"Emulator",tag:"emu"};function i(t){const n={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
