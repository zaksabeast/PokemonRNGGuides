import{u as r,j as e}from"./index-D1RsBzMR.js";const s={title:"Time Finder (Citra)",description:"Finding times to get specific RNG seeds",slug:"emulator-sm-time-finder",subCategory:"Emulator"};function i(t){const n={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Requirements"}),`
...
`,e.jsx(n.p,{children:"The default offset and tick values won't match. These values change depending on the version of Citra you're using and are only suggestions. For example, Citra Nightly 1543 has an offset of 3730114 and tick of 55."}),`
`,e.jsxs(n.ol,{children:[`
...
`,e.jsx(n.li,{children:"In the Tick Range, put a small number like 10."}),`
`,e.jsx(n.li,{children:"In the Offset Range, put a big number, such as 50,000,000."}),`
...
`})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`Note: If you find a result for Sun, Moon will have the same profile, so you can just copy it for each game.
`})}),`
