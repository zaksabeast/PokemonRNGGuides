import{u as r,j as e}from"./index-kiS-4Gi3.js";const s={title:"Time Finder (Citra)",description:"Finding times to get specific RNG seeds",slug:"emulator-sm-time-finder",subCategory:"Emulator",tag:"emu"};function i(t){const n={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(n.p,{children:"The default offset and tick values may not match. These values differ by the version of Citra and are just suggestions. For example, Citra Nightly 1543 has an offset of 4470937 and a tick of 56."}),`
`,e.jsxs(n.ol,{children:[`
...
`})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`Note: If you find a result for Ultra Sun, Ultra Moon will have the same profile, so you can copy it for each game.
`})}),`
