import{u as a,j as e}from"./index-BdPS1_5z.js";const l=[{title:"Ultra Sun and Ultra Moon Timeline RNG",navDrawerTitle:"Timeline RNG",description:"Learn how to create a timeline in Ultra Sun and Ultra Moon.",slug:"retail-usum-timeline",category:"Ultra Sun and Ultra Moon",tag:"cfw"},{title:"Sun and Moon Timeline RNG",navDrawerTitle:"Timeline RNG",description:"Learn how to create a timeline in Sun and Moon.",slug:"retail-sm-timeline",category:"Sun and Moon",tag:"cfw"}];function t(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...a(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["A 3DS with installed PCalc (",e.jsx(n.a,{href:"/misc-3ds-installing-pcalc",children:"PCalc Install Guide"}),")"]}),`
...
`})})]})}function s(i={}){const{wrapper:n}={...a(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{s as default,l as frontmatter};
