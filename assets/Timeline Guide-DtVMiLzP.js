import{u as r,j as e}from"./index-wr_-CJZl.js";const l=[{title:"Ultra Sun and Ultra Moon Timeline RNG",navDrawerTitle:"Timeline RNG",description:"Key skill for Gen 7 RNG with custom firmware",slug:"retail-usum-timeline",category:"Ultra Sun and Ultra Moon",tag:"cfw"},{title:"Sun and Moon Timeline RNG",navDrawerTitle:"Timeline RNG",description:"Key skill for Gen 7 RNG with custom firmware",slug:"retail-sm-timeline",category:"Sun and Moon",tag:"cfw"}];function t(i){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`})})]})}function s(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{s as default,l as frontmatter};
