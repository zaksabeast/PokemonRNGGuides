import{u as s,j as e}from"./index-Df4k8dKg.js";const a={title:"Transporter RNG using the Offline Patch",navDrawerTitle:"Offline Patch RNG",description:"Ensure a stable delay for easier RNG",slug:"transporter-rng-offline",category:"Transporter",tag:"cfw"};function t(r){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...s(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["A 3DS with PokeReader (",e.jsx(n.a,{href:"/install-pokereader",children:"PokeReader Install Guide"}),")"]}),`
...
`,e.jsxs(n.p,{children:["Set up the offline Transporter patch to ensure a stable delay by following the instructions ",e.jsx(n.a,{href:"/transporter-patches",children:"here"}),"."]}),`
...
`})})]})}function i(r={}){const{wrapper:n}={...s(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{i as default,a as frontmatter};
