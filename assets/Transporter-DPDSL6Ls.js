import{ga as a,j as n}from"./index-B4_S8hb9.js";const l={title:"Transporter RNG for Gen 1 and 2",navDrawerTitle:"Transporter RNG",description:"Learn how to RNG your Virtual Console Pokémon so they transfer to Gen 7 with perfect 6IVs.",slug:"transporter-rng",category:"Transporter and Dream Radar",section:"guide",variant:"cfw-emu",addedOn:"2025-05-08"};function o(r){const e={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...a(),...r.components},{Transporter:t}=e;return t||s("Transporter"),n.jsxs(n.Fragment,{children:[n.jsx(e.p,{children:"This guide allows for RNGing the IVs of Pokemon transferred from Gen 1/2 using Transporter. Shininess and nature are predetermined in the Gen 1/2 game the Pokemon are coming from."}),`
