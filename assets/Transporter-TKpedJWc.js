import{u as o,j as e}from"./index-CrJ_wQNO.js";const i={title:"Transporter RNG for Gen 1 and 2",navDrawerTitle:"Transporter RNG",description:"Learn how to RNG your Virtual Console Pokémon so they transfer to Gen 7 with perfect 6IVs.",slug:"transporter-rng",category:"Transporter",tag:"cfw"};function t(r){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...o(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsx(n.li,{children:"Load Pokémon Transporter with PokeReader on your 3DS."}),`
`,e.jsx(n.li,{children:"Open 3DSRNGTool on your computer."}),`
`,e.jsx(n.li,{children:`Change 3DSRNGTool's "Game Version" to "Transporter."`}),`
`,e.jsx(n.li,{children:`Change 3DSRNGTool's "Seed" to the Initial Seed PokeReader shows.`}),`
...
`,e.jsx(n.li,{children:"Search for the exact IVs PokeReader indicates using 3DSRNGTool to find your hit frame."}),`
...
`,e.jsxs(n.ol,{children:[`
`,e.jsx(n.li,{children:"Wait at the game selection screen until you get close to your wanted frame."}),`
...
`,e.jsx(n.li,{children:"Search for spreads using the initial seed PokeReader shows."}),`
...
`]})]})}function a(r={}){const{wrapper:n}={...o(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{a as default,i as frontmatter};
