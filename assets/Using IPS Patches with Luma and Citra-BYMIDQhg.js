import{u as l,j as e}from"./index-DweVeu07.js";const o={title:"Using IPS Patches with Luma and Citra",description:"Use game patches for instant text, no outlines, and extra fun",slug:"misc-3ds-ips-luma-citra",subCategory:"3DS"};function i(s){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...l(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Using IPS files with Luma"}),`
