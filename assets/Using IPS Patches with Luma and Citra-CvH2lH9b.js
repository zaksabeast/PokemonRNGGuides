import{u as r,j as e}from"./index-D-8zJ8GY.js";const d={title:"Using IPS Patches with Luma and Azahar/Lime3DS/Citra",description:"Use game patches for instant text, no outlines, and extra fun",slug:"misc-3ds-ips-luma-citra",category:"3DS Tools",tag:"cfw"};function t(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",ul:"ul",...r(),...i.components},{IpsMerger:s,YouTubeVideo:o}=n;return s||l("IpsMerger"),o||l("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Using IPS files with Luma"}),`
