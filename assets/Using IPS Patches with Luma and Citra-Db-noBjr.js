import{g9 as l,j as e}from"./index-iFRrEfrl.js";const c={title:"How to Use IPS Patches on a 3DS or Emulator (Luma3DS, Azahar, Citra)",navDrawerTitle:"Using IPS Patches",description:"Learn how to apply IPS patches like instant text and no outlines using Luma3DS, Azahar, or Citra. Includes 3DS setup, emulator mods, and a merge tool.",slug:"misc-3ds-ips-luma-citra",category:"3DS Tools",section:"supporting_info"};function r(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",ul:"ul",...l(),...s.components},{IpsMerger:t,YouTubeVideo:i}=n;return t||o("IpsMerger"),i||o("YouTubeVideo"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"What are IPS Patches?"}),`
...
`,e.jsxs(n.p,{children:["Use Transporter Offline! ",e.jsx(n.a,{href:"/transporter-patches",children:"Offline Transporter Patch"})]})]})}function h(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}function o(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,c as frontmatter};
