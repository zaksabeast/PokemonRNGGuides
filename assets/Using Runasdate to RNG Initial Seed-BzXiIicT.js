import{ic as l,j as n}from"./index-oHVXayJ2.js";const t=[{title:"黑白2初始seed乱数",description:"学习如何在黑白2中乱数你的初始seed",slug:"zh-emulator-b2w2-runasdate-inital-seed",translation:{enSlug:"emulator-b2w2-runasdate-inital-seed",language:"zh"}},{title:"黑白初始seed乱数",description:"学习如何在黑白中乱你的初始seed",slug:"zh-emulator-bw-runasdate-initial-seed",translation:{enSlug:"emulator-bw-runasdate-initial-seed",language:"zh"}}];function i(s){const e={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...l(),...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.pre,{children:n.jsx(e.code,{children:`本指南假设你已经选好目标种子。在跟随本指南操作之前，请确保已确认目标种子。
`})}),`
