import{ii as l,j as n}from"./index-CEitD9YF.js";const t=[{title:"黑白2初始seed乱数",description:"学习如何在黑白2中乱数你的初始seed",slug:"zh-emulator-b2w2-runasdate-inital-seed",translation:{enSlug:"emulator-b2w2-runasdate-inital-seed",language:"zh"}},{title:"黑白初始seed乱数",description:"学习如何在黑白中乱你的初始seed",slug:"zh-emulator-bw-runasdate-initial-seed",translation:{enSlug:"emulator-bw-runasdate-initial-seed",language:"zh"}}];function i(s){const e={a:"a",code:"code",h2:"h2",h3:"h3",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...l(),...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.pre,{children:n.jsx(e.code,{children:`本教程假设你已经选好目标种子。在跟随本教程操作之前，请确保已确认目标种子。
`})}),`
...
`,n.jsx(e.p,{children:"RunAsDate 是 Nirsoft 开发的一款工具，可以让程序以用户指定的时间启动。在第五世代乱数中，它可以帮助你更轻松地命中目标种子。本教程仅聚焦于 RunAsDate 的使用。"}),`
