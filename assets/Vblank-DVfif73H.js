import{t as e}from"./jsx-runtime-MrBVUj-r.js";import{d as t}from"./index-sRQoma-p.js";var n=e(),r={title:`绿宝石中的垂直空白（VBlank）`,description:`什么是 VBlank 以及它在宝可梦生成中的影响。`,slug:`zh-gba-vblank`,translation:{enSlug:`gba-vblank`,language:`zh`}};function i(e){let r={a:`a`,h2:`h2`,li:`li`,p:`p`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...t(),...e.components},{Gist:i,Text:a}=r;return i||o(`Gist`,!0),a||o(`Text`,!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(i,{children:`要点：什么是 VBlank，以及它在宝可梦生成中的影响。`}),`
