import{u as o,j as e}from"./index-IZhoyR2j.js";const d={title:"VBlank",description:"What are Vblanks and their impact on Pokémon generation.",slug:"gba-vblank",category:"GBA Technical Documentation",tag:"any",addedOn:"2025-04-08"};function a(t){const n={a:"a",h2:"h2",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...o(),...t.components},{Gist:s,Text:r}=n;return s||i("Gist"),r||i("Text"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Gist: What are Vblanks and their impact on Pokémon generation."}),`
