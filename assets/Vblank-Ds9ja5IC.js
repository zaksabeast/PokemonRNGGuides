import{ie as o,j as e}from"./index-C1hgsWDD.js";const d={title:"VBlank in Emerald",navDrawerTitle:"VBlank",description:"What are Vblanks in Emerald and their impact on Pokémon generation.",slug:"gba-vblank",category:["Ruby and Sapphire","FireRed and LeafGreen","Emerald"],section:"technical_info",orderPriority:0,addedOn:"2025-04-08"};function s(t){const n={a:"a",h2:"h2",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...o(),...t.components},{Gist:a,Text:r}=n;return a||i("Gist"),r||i("Text"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Gist: What are Vblanks and their impact on Pokémon generation."}),`
...
`,e.jsxs(n.p,{children:["Fortunately, in most cases, vblanks occurring during the Pokémon generation don't actually impact the resulting Pokémon. But sometimes, they do impact and cause what we call ",e.jsx(n.a,{href:"/gba-methods",children:"Methods 2-4"}),"."]}),`
`,e.jsx(n.h2,{children:"Credits"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Chinese translation: xuanyelin, Hakuhiro."}),`
`]})]})}function l(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}function i(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as default,d as frontmatter};
