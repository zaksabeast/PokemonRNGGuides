import{w as i,j as n}from"./index-BmhIYDEc.js";const c={title:"绿宝石中的垂直空白（VBlank）",description:"什么是 VBlank 以及它在宝可梦生成中的影响。",slug:"zh-gba-vblank",translation:{enSlug:"gba-vblank",language:"zh"}};function t(l){const e={a:"a",h2:"h2",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...l.components},{Gist:s,Text:r}=e;return s||d("Gist"),r||d("Text"),n.jsxs(n.Fragment,{children:[n.jsx(s,{children:"要点：什么是 VBlank，以及它在宝可梦生成中的影响。"}),`
