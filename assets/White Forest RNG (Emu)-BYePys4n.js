import{E as l,j as n}from"./index-B7X06lKS.js";const t=[{title:"白森林乱数",description:"白森林乱数",slug:"zh-emulator-bw-white-forest",translation:{enSlug:"emulator-bw-white-forest",language:"zh"}}];function i(r){const e={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...l(),...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.pre,{children:n.jsx(e.code,{children:`注意：本指南假设你已具备基础知识。你应当能够建立配置文件、进行野生乱数，并理解种子生成过程中的噪音推进。
`})}),`
