import{ih as l,j as n}from"./index-DGbmpVsq.js";const t=[{title:"白森林乱数",description:"白森林乱数",slug:"zh-emulator-bw-white-forest",translation:{enSlug:"emulator-bw-white-forest",language:"zh"}}];function i(r){const e={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...l(),...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.pre,{children:n.jsx(e.code,{children:`注意：本教程假设你已具备基础知识。你应当能够建立配置文件、进行野生乱数，并理解种子生成过程中的噪音推进。
`})}),`
...
`]}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{children:`注意：你可以使用 PokeCGear 工具（http://projectpokemon.org/forums/attachment.php?attachmentid=10632&d=1362758021）编辑白森林中的训练家/可遇宝可梦，但本教程不会涉及此内容。
`})}),`
...
`]})]})}function h(r={}){const{wrapper:e}={...l(),...r.components};return e?n.jsx(e,{...r,children:n.jsx(i,{...r})}):i(r)}export{h as default,t as frontmatter};
