import{x as o,j as e}from"./index-DS5oTPfz.js";const h=[{title:"Black 2 and White 2 Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokémon in Black 2 and White 2 for shiny and high-IV results.",slug:"emulator-b2w2-wild",category:"Black 2 and White 2",isRoughDraft:!0,tag:"emu"},{title:"Black and White Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokémon in Black and White for shiny and high-IV results.",slug:"emulator-bw-wild",category:"Black and White",isRoughDraft:!0,tag:"emu",canonical:"emulator-b2w2-wild"}];function t(r){const n={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...r.components},{ShowIf:i}=n;return i||s("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(i,{slug:"/emulator-b2w2-wild",children:[e.jsxs(n.p,{children:["This guide is for ",e.jsx(n.strong,{children:"Black 2 and White 2"}),"."]}),e.jsx(n.p,{children:"Looking for a different game? Check out these pages:"}),e.jsxs(n.ul,{children:[`
