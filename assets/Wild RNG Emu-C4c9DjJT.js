...
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:"Walking 128 steps increases the IVRNG by 1 + the number of Pokémon in your party (e.g. 6 Pokémon advances by 7)."}),`
`,n.jsx(e.li,{children:"Depositing a Pokémon in the PC advances the IVRNG by 7."}),`
...
`,n.jsx(e.li,{children:"Fiask for finalizing the guide"}),`
`]})]})}function l(t={}){const{wrapper:e}={...s(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(r,{...t})}):r(t)}function o(t,e){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as default,a as frontmatter};
