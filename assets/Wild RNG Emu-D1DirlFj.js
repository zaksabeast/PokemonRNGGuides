...
- Walking 128 steps increases the IVRNG by 1 + the number of Pokémon in your party (e.g. 6 Pokémon advances by 7).
- Depositing a Pokémon in the PC advances the IVRNG by 7.
...
- Fiask for finalizing the guide
`;export{e as default};
