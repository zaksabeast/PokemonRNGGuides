...
1. Follow our guide to <ShowIf slug="/emulator-b2w2-wild">[RNG your target seed](/emulator-b2w2-runasdate-inital-seed)</ShowIf><ShowIf slug="emulator-bw-wild">[RNG your target seed](/emulator-bw-runasdate-initial-seed)</ShowIf>.
2. Use \`runasdate.exe\` from the [Desmume Guide](/desmume-setup) to launch the game at the correct date and time.
3. Enter the game quickly.
4. Open the menu immediately.
