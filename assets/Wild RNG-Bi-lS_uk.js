...
- title: "Ultra Sun and Ultra Moon Wild RNG"
  ...
  description: "Learn how to RNG wild Pokémon in Ultra Sun and Ultra Moon for shiny and high-IV results."
...
- title: "Sun and Moon Wild RNG"
  navDrawerTitle: "Wild RNG"
  description: "Learn how to RNG wild Pokémon in Sun and Moon for shiny and high-IV results."
  slug: "retail-sm-wild"
...
For Sun/Moon games, refer to this list of [encounter slots with 0 NPC or the least number of NPC spots](/misc-sm-wild-spots).

## Step 1: Set Up 3DSRNGTool

1. In the upper right, input your game version and TSV.
2. Input the initial seed in the upper right. You can find this in the main RNG view as \`Init Seed:\`.
...
1. Follow the [timeline guide](/retail-usum-timeline) to create a timeline and find a target frame. Open the in-game menu with \`X\` and hover over the bag before making the timeline.

## Step 2 (with 0 NPCs):

1. Do not check the "Blink F Only" box.
2. Open the in-game menu with \`X\` and hover over the bag. Input your current frame in the frame range. You can pause the game by pressing \`Start + Select\`.
