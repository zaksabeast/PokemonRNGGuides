import{u as l,j as e}from"./index-DYtIK9hq.js";const o=[{title:"FireRed and LeafGreen Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokémon in FireRed and LeafGreen using the Sweet Scent method.",slug:"emulator-frlg-wild",category:"FireRed and LeafGreen",tag:"emu"},{title:"火红叶绿野生乱数",navDrawerTitle:"Wild RNG",description:"在《火红·叶绿》中使用甜甜香气进行野生宝可梦的乱数",slug:"zh-emulator-frlg-wild",category:"FireRed and LeafGreen",tag:"emu",translation:{enSlug:"emulator-frlg-wild",language:"zh"}}];function s(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...l(),...i.components},{ShowIf:r}=n;return r||d("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(r,{slug:"/emulator-frlg-wild",children:[e.jsx(n.h2,{children:"Tools"}),e.jsxs(n.ul,{children:[`
