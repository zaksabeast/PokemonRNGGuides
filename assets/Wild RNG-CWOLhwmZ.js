import{id as r,j as e}from"./index-f4fDcrkY.js";const s=[{title:"FireRed and LeafGreen Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokemon in FireRed and LeafGreen using the Sweet Scent method.",slug:"emulator-frlg-wild",category:"FireRed and LeafGreen",section:"pokemon_rng",variant:"cfw-emu"},{title:"FireRed and LeafGreen Wild RNG",description:"Learn how to RNG wild Pokemon in FireRed and LeafGreen using the Sweet Scent method.",slug:"emulator-frlg-wild-v2",category:"FireRed and LeafGreen",section:"pokemon_rng",variant:"cfw-emu",hideFromNavDrawer:!0,canonical:"emulator-frlg-wild"}];function t(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
