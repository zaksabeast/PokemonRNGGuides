import{u as s,j as e}from"./index-RrtH3J_N.js";const o=[{title:"FireRed and LeafGreen Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokemon in FireRed and LeafGreen using the Sweet Scent method.",slug:"emulator-frlg-wild",category:"FireRed and LeafGreen",tag:"emu"},{title:"FireRed and LeafGreen Wild RNG",description:"Learn how to RNG wild Pokemon in FireRed and LeafGreen using the Sweet Scent method.",slug:"emulator-frlg-wild-v2",category:"FireRed and LeafGreen",tag:"emu",hideFromNavDrawer:!0,canonical:"emulator-frlg-wild"},{title:"火红叶绿野生乱数",navDrawerTitle:"Wild RNG",description:"在《火红·叶绿》中使用甜甜香气进行野生宝可梦的乱数",slug:"zh-emulator-frlg-wild",category:"FireRed and LeafGreen",tag:"emu",translation:{enSlug:"emulator-frlg-wild",language:"zh"}}];function r(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...s(),...i.components},{ShowIf:l}=n;return l||d("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(l,{slugs:["/emulator-frlg-wild","/emulator-frlg-wild-v2"],children:[e.jsx(n.h2,{children:"Tools"}),e.jsxs(n.ul,{children:[`
...
`]}),`
`]}),`
`]}),e.jsx(n.h2,{children:"Step 2: Finding the initial seed (Manually)"}),e.jsxs(n.ol,{children:[`
...
`]}),e.jsx(n.p,{children:e.jsx(n.img,{src:"/images/FireRed-LeafGreen/Wild/Initial-Seed.png",alt:"Initial Seed"})}),e.jsx(n.h2,{children:"Step 2: Finding the initial seed (Botting)"}),e.jsx(n.p,{children:"An alternative method to finding an initial seed is to use a bot to reset for seeds until a desired one is found."}),e.jsx(n.p,{children:e.jsx(n.a,{href:"/frlg-seeding-bot",children:"Initial Seed Botting Guide"})}),e.jsx(n.h2,{children:"Step 3: Find a target advance"}),e.jsxs(n.ol,{children:[`
...
`})}),e.jsx(n.h2,{children:"Step 4: RNG for the Pokemon"}),e.jsxs(n.ol,{children:[`
...
`]})]}),`
`,e.jsxs(l,{slug:"/zh-emulator-frlg-wild",children:[e.jsx(n.h2,{children:"所需工具"}),e.jsxs(n.ul,{children:[`
...
`]})]})]})}function h(i={}){const{wrapper:n}={...s(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}function d(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default,o as frontmatter};
