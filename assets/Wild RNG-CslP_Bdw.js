...
`})}),`
`,n.jsxs(e.ol,{children:[`
`,n.jsxs(e.li,{children:["按照",n.jsx(e.a,{href:"/zh-retail-usum-timeline",children:"时间线教程"}),"制作时间线并寻找目标帧数。在制作时间线前，请按下 ",n.jsx(e.code,{children:"X"})," 打开菜单，并将光标停留在「包包」上。"]}),`
`]}),`
...
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:"若重启游戏，请从本教程最开始重新操作。"}),`
`]}),`
`]}),`
`]}),`
