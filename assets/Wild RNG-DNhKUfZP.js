import{u as l,j as e}from"./index-CUl5RIKO.js";const h=[{title:"FireRed and LeafGreen Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokémon in FireRed and LeafGreen using the Sweet Scent method.",slug:"emulator-frlg-wild",category:"FireRed and LeafGreen",tag:"emu"},{title:"火红叶绿野生乱数",navDrawerTitle:"Wild RNG",description:"在《火红·叶绿》中使用甜甜香气进行野生宝可梦的乱数",slug:"zh-emulator-frlg-wild",category:"FireRed and LeafGreen",tag:"emu",translation:{enSlug:"emulator-frlg-wild",language:"zh"}}];function r(i){const n={a:"a",code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...l(),...i.components},{ShowIf:s}=n;return s||t("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(s,{slug:"/emulator-frlg-wild",children:[e.jsx(n.h2,{children:"Tools"}),e.jsxs(n.ul,{children:[`
