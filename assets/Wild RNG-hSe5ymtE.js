import{ga as r,j as e}from"./index-uFjPzSoK.js";const a=[{title:"Ultra Sun and Ultra Moon Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokémon in Ultra Sun and Ultra Moon for shiny and high-IV results.",slug:"retail-usum-wild",category:"Ultra Sun and Ultra Moon",section:"guide",variant:"cfw-emu"},{title:"Sun and Moon Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokémon in Sun and Moon for shiny and high-IV results.",slug:"retail-sm-wild",category:"Sun and Moon",section:"guide",variant:"cfw-emu",canonical:"retail-usum-wild"}];function i(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
