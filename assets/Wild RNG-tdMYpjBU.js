import{u as o,j as e}from"./index-BDZjbtGI.js";const s=[{title:"Wild RNG",description:"RNG for wild Pokémon using honey in Sun and Moon",slug:"retail-usum-wild",category:"Ultra Sun and Ultra Moon",tag:"cfw"},{title:"Wild RNG",description:"RNG for wild Pokémon using honey in Sun and Moon",slug:"retail-sm-wild",category:"Sun and Moon",tag:"cfw"}];function i(t){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`,e.jsxs(n.li,{children:["In the upper right, input your game version and TSV. Your TSV is found in PCalc by pressing ",e.jsx(n.code,{children:"Start + Up"})," to open the Game View window."]}),`
`,e.jsxs(n.li,{children:["Input the initial seed in the upper right. You can find this in the Game View window as ",e.jsx(n.code,{children:"Init Seed:"}),"."]}),`
...
`})}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:["Follow the ",e.jsx(n.a,{href:"https://www.pokemonrng.com/retail-usum-timeline",children:"timeline guide"})," to create a timeline and find a target frame. Open the in-game menu with ",e.jsx(n.code,{children:"X"})," and hover over the bag before making the timeline."]}),`
`]}),`
`,e.jsx(n.h2,{children:"Step 2 (with 0 NPCs):"}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsx(n.li,{children:'Do not check the "Blink F Only" box.'}),`
`,e.jsxs(n.li,{children:["Open the in-game menu with ",e.jsx(n.code,{children:"X"})," and hover over the bag. Input your current frame in the frame range, located in the PCalc Game Info window (",e.jsx(n.code,{children:"Start + Up"}),"). You can pause the game by pressing ",e.jsx(n.code,{children:"Start + Select"}),"."]}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:"Note: You can view the wild Pokémon's info using PCalc. Press `Start + Left` to open the Wild View window.\n"})}),`
...
`]}),`
`,e.jsx(n.p,{children:"Once you find the correct correction value, it remains stable for future RNG attempts, as long as you don't move your character. Moving may require further adjustments."})]})}function a(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{a as default,s as frontmatter};
