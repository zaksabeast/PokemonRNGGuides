import{u as s,j as e}from"./index-B0jhLgro.js";const h=[{title:"Diamond, Pearl, and Platinum Wild RNG",navDrawerTitle:"Wild RNG",description:"Learn how to RNG wild Pokémon in Diamond, Pearl, and Platinum for shiny and high-IV results.",slug:"dppt-wild",category:"Diamond, Pearl, and Platinum",tag:"any"},{title:"野生乱数",description:"野生乱数",slug:"zh-dppt-wild",category:"Diamond, Pearl, and Platinum",tag:"any",translation:{enSlug:"dppt-wild",language:"zh"}}];function t(l){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...l.components},{ShowIf:i}=n;return i||r("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsxs(i,{slug:"/dppt-wild",children:[e.jsx(n.h2,{children:"Intro"}),e.jsx(n.p,{children:"This guide assumes you have basic knowledge of Gen 4 RNG, such as hitting an initial seed and advancing the RNG."}),e.jsx(n.h2,{children:"General"}),e.jsxs(n.p,{children:["Before getting into specifics, determine your target frame and set up ",e.jsx(n.a,{href:"/pokefinder",children:"PokeFinder"})," like this:"]}),e.jsxs(n.ol,{children:[`
...
`]})]}),`
`,e.jsxs(i,{slug:"/zh-dppt-wild",children:[e.jsx(n.h2,{children:"介绍"}),e.jsx(n.p,{children:"本指南假设你已经掌握了第四世代乱数的基础知识，如命中初始种子和推进帧数。"}),e.jsx(n.h2,{children:"通用准备"}),e.jsxs(n.p,{children:["在进行具体乱数前，先设置",e.jsx(n.a,{href:"/pokefinder",children:"PokeFinder"}),"并确定目标帧："]}),e.jsxs(n.ol,{children:[`
...
`]})]})]})}function c(l={}){const{wrapper:n}={...s(),...l.components};return n?e.jsx(n,{...l,children:e.jsx(t,{...l})}):t(l)}function r(l,n){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as default,h as frontmatter};
