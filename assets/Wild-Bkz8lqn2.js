import{u as d,j as e}from"./index-DGZZ56bh.js";const c=[{title:"Wild RNG",description:"Wild RNG",slug:"dppt-wild",subCategory:"Basic Knowledge",tag:"any"},{title:"野生乱数",description:"野生乱数",slug:"zh-dppt-wild",subCategory:"Basic Knowledge",tag:"any",hideFromNavDrawer:!0}];function s(t){const n={code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...d(),...t.components},{LanguageButton:i,ShowIf:l}=n;return i||r("LanguageButton"),l||r("ShowIf"),e.jsxs(e.Fragment,{children:[e.jsx(i,{enSlug:"/dppt-wild",zhSlug:"/zh-dppt-wild"}),`
`,e.jsxs(l,{slug:"/dppt-wild",children:[e.jsx(n.h2,{children:"Intro"}),e.jsx(n.p,{children:"This guide assumes you have basic knowledge of Gen 4 RNG, such as hitting an initial seed and advancing the RNG."}),e.jsx(n.h2,{children:"General"}),e.jsx(n.p,{children:"Before getting into specifics, determine your target frame and set up PokeFinder like this:"}),e.jsxs(n.ol,{children:[`
...
`]})]}),`
`,e.jsxs(l,{slug:"/zh-dppt-wild",children:[e.jsx(n.h2,{children:"介绍"}),e.jsx(n.p,{children:"本指南假设你已经掌握了第四世代乱数的基础知识，如命中初始种子和推进帧数。"}),e.jsx(n.h2,{children:"通用准备"}),e.jsx(n.p,{children:"在进行具体乱数前，先设置PokeFinder并确定目标帧："}),e.jsxs(n.ol,{children:[`
...
`]})]})]})}function x(t={}){const{wrapper:n}={...d(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}function r(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default,c as frontmatter};
