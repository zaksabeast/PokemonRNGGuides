import{u as l,j as e}from"./index-BlCYVtih.js";const r={title:"Wild RNG",description:"Wild RNG",slug:"dppt-wild",subCategory:"Basic Knowledge",tag:"any"};function i(t){const n={code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...l(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Intro"}),`
`,e.jsx(n.p,{children:"This guide assumes you have basic knowledge of Gen 4 RNG, such as hitting an initial seed and advancing the RNG."}),`
`,e.jsx(n.h2,{children:"General"}),`
`,e.jsx(n.p,{children:"Before getting into specifics, determine your target frame and set up PokeFinder like this:"}),`
...
`,e.jsx(n.p,{children:"For a wild encounter, go to the area with your target Pokémon. You need a Pokémon with Sweet Scent or honey. Follow these steps:"}),`
`,e.jsxs(n.ol,{children:[`
...
`]}),`
`,e.jsx(n.p,{children:"Sweet Scent and honey animations won't affect RNG advancement unlike in Gen 5."}),`
`,e.jsx(n.h2,{children:"GBA Insertions"}),`
`,e.jsx(n.p,{children:"GBA insertions follow the same RNG process as basic wild RNG. They use Encounter Slot 8 and 9. If your profile is set up correctly, PokeFinder will show all relevant information automatically."}),`
...
`]}),`
`,e.jsx(n.p,{children:"On an emulator, a significant advancement indicates a successful hook and possibly reaching your target encounter. PokeFinder shows which advances lead to an encounter."}),`
`,e.jsx(n.h3,{children:"Feebas"}),`
`,e.jsx(n.p,{children:"Feebas encounters are trickier. Here's what to do:"}),`
`,e.jsxs(n.ol,{children:[`
...
`]}),`
`,e.jsx(n.p,{children:"Feebas has an element of randomness that isn't fully supported yet."}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`Note: You might be off by one due to indexing differences between tools. Adjust if needed.
`})}),`
...
`,e.jsx(n.p,{children:"This process is similar to the Trophy Garden and uses Encounter Slot 6 and 7."}),`
`,e.jsxs(n.ol,{children:[`
...
`]})]})}function d(t={}){const{wrapper:n}={...l(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{d as default,r as frontmatter};
