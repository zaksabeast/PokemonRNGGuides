import{t as e}from"./jsx-runtime-HNbymCCE.js";import{d as t}from"./index-C81NP84z.js";var n=e(),r={title:`X 与 Y TID 乱数`,description:`学习如何在《宝可梦 X／Y》中获取目标的训练家 ID（TID）与秘密 ID（SID）组合。`,slug:`zh-pcalc-xy-tid`,translation:{enSlug:`pcalc-xy-tid`,language:`zh`}};function i(e){let r={a:`a`,code:`code`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h2,{children:`简介`}),`
