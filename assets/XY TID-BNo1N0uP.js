import{v as s,j as e}from"./index-CW02-5CY.js";const a={title:"X and Y TID RNG",navDrawerTitle:"TID RNG",description:"Learn how to obtain your desired Trainer ID (TID) and Secret ID (SID) combo in X and Y.",slug:"pcalc-xy-tid",category:"X and Y",tag:"cfw"};function t(r){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Intro"}),`
