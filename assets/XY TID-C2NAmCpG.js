import{ic as i,j as e}from"./index-BjNzrIyR.js";const d={title:"X 与 Y TID 乱数",description:"学习如何在《宝可梦 X／Y》中获取目标的训练家 ID（TID）与秘密 ID（SID）组合。",slug:"zh-pcalc-xy-tid",translation:{enSlug:"pcalc-xy-tid",language:"zh"}};function s(l){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...i(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"简介"}),`
