import{ie as i,j as e}from"./index-BkpeH8au.js";const a={title:"X and Y TID RNG",navDrawerTitle:"TID RNG",description:"Learn how to obtain your desired Trainer ID (TID) and Secret ID (SID) combo in X and Y.",slug:"pcalc-xy-tid",category:"X and Y",section:"other_rng",variant:"cfw-emu"};function t(r){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Intro"}),`
...
`,e.jsx(n.li,{children:'Input the 4 TinyMT seeds from PokeReader into the 4 boxes in 3DSRNGTool. Use the numbers directly listed under "Tiny u32 seed".'}),`
`]}),`
...
`,e.jsxs(n.li,{children:["If the target frame is too high or the TID/SID/TSV combination is not possible with your initial seed, press ",e.jsx(n.code,{children:"Start + Select + L + R"})," to soft reset for a different initial seed."]}),`
`]}),`
...
`]})]})}function l(r={}){const{wrapper:n}={...i(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{l as default,a as frontmatter};
