import{t as e}from"./jsx-runtime-DE3yYTa1.js";import{d as t}from"./index-CCHoIWcm.js";var n=e(),r={title:`X and Y TID RNG`,navDrawerTitle:`TID RNG`,description:`Learn how to obtain your desired Trainer ID (TID) and Secret ID (SID) combo in X and Y.`,slug:`pcalc-xy-tid`,category:`X and Y`,section:`other_rng`,variant:`cfw-emu`};function i(e){let r={a:`a`,code:`code`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h2,{children:`Intro`}),`
