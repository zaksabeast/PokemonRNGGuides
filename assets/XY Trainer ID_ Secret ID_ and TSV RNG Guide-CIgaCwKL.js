import{u as s,j as e}from"./index-uFSWPmqj.js";const a={title:"Trainer ID, Secret ID, and/or TSV RNG",description:"RNG for a specific Trainer ID, SID, or TSV",slug:"pcalc-xy-tid",subCategory:"Custom Firmware",tag:"cfw"};function t(r){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Intro"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://www.pokemonrng.com/install-pokereader",children:"A 3DS with PokeReader"})," OR ",e.jsx(n.a,{href:"https://www.pokemonrng.com/citrarng-setup",children:"Lime3DS with PokeReader"})]}),`
