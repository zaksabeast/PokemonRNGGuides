import{u as s,j as e}from"./index-wr_-CJZl.js";const r={title:"mGBA Setup",description:"Setup mGBA for RNG",slug:"mgba-setup",category:"GBA Tools",tag:"emu",addedOn:"2025-03-03"};function o(n){const t={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h2,{children:"Tools"}),`
...
`,e.jsx(t.p,{children:"Make sure to use the development build of mGBA linked above. Other versions of mGBA will show this error."}),`
`,e.jsxs(t.h3,{children:["Error: ",e.jsx(t.code,{children:"attempt to index a nil value (global 'emu')"})]}),`
`,e.jsx(t.p,{children:"Make sure you have loaded a rom before attempting to run your lua script."})]})}function i(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{i as default,r as frontmatter};
