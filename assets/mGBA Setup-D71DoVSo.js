import{ic as s,j as e}from"./index-BDxuoNMl.js";const r={title:"mGBA Setup",description:"Learn how to set up mGBA for GBA Pokémon RNG, including lua scripting support.",slug:"mgba-setup",category:"GBA Tools",section:"tool",addedOn:"2025-03-03"};function t(o){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Tools"}),`
...
`]})]})}function i(o={}){const{wrapper:n}={...s(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{i as default,r as frontmatter};
