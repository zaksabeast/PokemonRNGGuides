import{ie as i,j as n}from"./index-BqKm8yzf.js";const r=[{title:"mGBA Setup",description:"Learn how to set up mGBA for GBA Pokémon RNG, including lua scripting support.",slug:"zh-mgba-setup",translation:{enSlug:"mgba-setup",language:"zh"}}];function s(l){const e={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",ul:"ul",...i(),...l.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
...
`]})]})}function h(l={}){const{wrapper:e}={...i(),...l.components};return e?n.jsx(e,{...l,children:n.jsx(s,{...l})}):s(l)}export{h as default,r as frontmatter};
