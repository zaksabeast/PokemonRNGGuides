import{q as t,j as n}from"./index-DDrxH26t.js";const r=[{title:"mGBA Setup",description:"Learn how to set up mGBA for GBA Pokémon RNG, including lua scripting support.",slug:"zh-mgba-setup",translation:{enSlug:"mgba-setup",language:"zh"}}];function s(l){const e={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",ul:"ul",...t(),...l.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:"所需工具"}),`
...
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:"中文翻译：Hakuhiro/白希洛。"}),`
