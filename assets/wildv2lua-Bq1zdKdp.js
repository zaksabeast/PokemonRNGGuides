import{u as t,j as e}from"./index-Bw5EQjsw.js";const o={title:"FireRed and LeafGreen Wild RNG",navDrawerTitle:"Wild RNG",description:"Wild v2 RNG",slug:"emulator-frlg-wild-v2",category:"FireRed and LeafGreen",isRoughDraft:!0,tag:"emu"};function i(r){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.pre,{children:e.jsx(n.code,{children:`This guide uses the new lua scripts from noob.
`})}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Last thing:"})," If you don't get the target, double-check your own delay and make sure to do the Trainer Flip."]})]})}function l(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(i,{...r})}):i(r)}export{l as default,o as frontmatter};
