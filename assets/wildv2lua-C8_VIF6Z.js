import{u as i,j as e}from"./index-BDZjbtGI.js";const o={title:"Wild v2 RNG",description:"Wild v2 RNG",slug:"emulator-frlg-wild-v2",subCategory:"Emulator",isRoughDraft:!0,tag:"emu"};function t(r){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.pre,{children:e.jsx(n.code,{children:`This guide uses the new lua scripts from noob.
`})}),`
