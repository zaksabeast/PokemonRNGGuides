import{u as r,j as e}from"./index-C7pESl3A.js";const s={title:"Wild v2 RNG",description:"Wild v2 RNG",slug:"emulator-frlg-wild-v2",subCategory:"Emulator",isRoughDraft:!0};function o(n){const t={a:"a",br:"br",li:"li",p:"p",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"/!\\ This guide uses the NEW lua scripts from noob /!\\"}),`
