import{u as o,j as e}from"./index-CO9ioSnB.js";const s={title:"Wild v2 RNG",description:"Wild v2 RNG",slug:"emulator-frlg-wild-v2",subCategory:"Emulator",isRoughDraft:!0};function t(r){const n={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.pre,{children:e.jsx(n.code,{children:`This guide uses the new lua scripts from noob.
`})}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Last thing:"})," If you don't get the target, double-check your own delay and make sure to do the Trainer Flip."]})]})}function l(r={}){const{wrapper:n}={...o(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{l as default,s as frontmatter};
