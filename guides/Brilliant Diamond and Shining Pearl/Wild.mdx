...
description: "RNG wild Pokémon in BDSP using CFW"
slug: "cfw-bdsp-wild"
...
If you're a PokeFinder user (Gen 8 Tab => Wild), the Encounter Tables are available. Fill in necessary information (like the route) to see available Pokémon. Remember to edit your profile for swarms or similar events.
