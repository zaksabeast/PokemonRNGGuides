...
<ShowIf slugs={["/rs-sid-feebas", "/zh-rs-sid-feebas"]}>
  <LanguageButton enSlug="/rs-sid-feebas" zhSlug="/zh-rs-sid-feebas" />
</ShowIf>

<ShowIf slugs={["/emerald-sid-feebas", "/zh-emerald-sid-feebas"]}>
  <LanguageButton
    enSlug="/emerald-sid-feebas"
    zhSlug="/zh-emerald-sid-feebas"
  />
</ShowIf>
