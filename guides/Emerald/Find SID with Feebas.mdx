...
{window.location.pathname === '/rs-sid-feebas' &&
...
- You have a dead battery{window.location.pathname === '/emerald-sid-feebas' ? ' or have played for less than 1 day' : ''}.
...
<Gen3Sid
  game={window.location.pathname === "/rs-sid-feebas" ? "rs" : "emerald"}
/>
