...
<details>
  <summary><b>If you play Ruby or Sapphire, didn't alter Dewford Trends, and have a dead battery</b></summary>

1. [Follow this guide](/rs-sid-feebas)
...
1. Start a new save
2. Open [PokeFinder](https://github.com/Admiral-Fish/PokeFinder/releases) and click the "IDs" button in the "Gen 3" tab.
3. Select the "RS" tab in the new window that appears.
4. Check "Dead Battery" if you have a dead battery (likely), otherwise fill in the time and date you started the save.
5. Check your TID as soon as you can, and enter it in PokeFinder's filters.
6. Click "Generate" to get a list of possible SIDs.
7. If you have multiple possible SIDs, save your game before choosing your starter.
8. Attempt to RNG your starter for each SID. If you get a shiny, you found your SID.
