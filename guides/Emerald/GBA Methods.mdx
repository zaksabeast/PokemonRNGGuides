...
| Generate 1st half PID                                                      | 1                                                        |
| Generate 2nd half PID                                                      | 2                                                        |
| <span style={{color:'green',fontWeight:'bold'}}>VBLANK: Advance RNG</span> | <span style={{color:'green',fontWeight:'bold'}}>3</span> |
...
| Generate 2nd half PID                                                      | 2                                                        |
| Generate Def, Atk, HP IVs                                                  | 3                                                        |
| <span style={{color:'green',fontWeight:'bold'}}>VBLANK: Advance RNG</span> | <span style={{color:'green',fontWeight:'bold'}}>4</span> |
| Generate SpD, SpA, Spe IVs                                                 | <span style={{fontWeight:'bold'}}>5</span>               |
