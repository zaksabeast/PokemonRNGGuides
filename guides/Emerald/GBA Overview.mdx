...
<Gist>
  Gist: Understanding the particularities, the key RNG concepts, and version
  differences of GBA games.
</Gist>
...
- • Static Pokémon (ex: Starters, Stationary)
- • Wild Pokémon
- • Egg Pokémon
...
- • Only way to get Shiny Mewtwo and Unown
