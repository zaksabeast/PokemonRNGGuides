...
<ShowIf slug="/rs-shiny-starter">
  The strategy to determine the SID is to attempt a timing of 1632 advances. By knowing the TID and that the actual hit advance is near 1632,
we can generate a list of possible SIDs (one SID for each advance near 1632).
</ShowIf>
