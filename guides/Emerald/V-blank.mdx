...
| ----------------- | -------|
| Generate PID      | 1      |
| Update RNG frame  | 1 -> 2 |
| Generate IVs      | 2      |
| Update RNG frame  | 2 -> 3 |
...
| Generate IVs               | 3      |
| Update RNG frame           | 3 -> 4 |

```
Generate PID  (frame 1)
Update RNG frame (frame 1->2)
Update RNG frame caused by v-blank (frame 2->3)
Generate IVs  (frame 3)
Update RNG frame (frame 3->4)
```
