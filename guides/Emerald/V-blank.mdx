...
In GBA Pokemon games, the vblank associated code updates the RNG frame by 1. This means that every 1/60th of a second, the RNG frame updates by 1.
...
The generation of a stationary Pokemon takes few instructions, which makes vblank rare.
