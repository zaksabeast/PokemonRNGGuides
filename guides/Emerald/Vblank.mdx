...
Gist: Understanding what are Vblanks and their impact on Pokémon generation.
...
| ------------------------ | ------------------- |
| Generate PID             | 1                   |
| <span style={{color:'green',fontWeight:'bold'}}>VBLANK: Update RNG frame</span> | <span style={{color:'green',fontWeight:'bold'}}>2</span>                   |
| Generate IVs             | <span style={{color:'red',fontWeight:'bold'}}>3</span>                   |
