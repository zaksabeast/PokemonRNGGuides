...
2. Under Filters select TID and in the box to the right enter any 5 digit number you would like it to be
...
4. In this example, I hit 19 late. Go back to you save state and then hit your delay but minus 19 frames.
...
2. Going up or down a year, will switch you between even and odd delays.
