...
2. Open Ruby/Sapphire on VBA-RR and load the wishmaker lua script.
...
3. In VBA-RR, export your battery file and upload it to wishmaker-calc by clicking on Jirachi.
