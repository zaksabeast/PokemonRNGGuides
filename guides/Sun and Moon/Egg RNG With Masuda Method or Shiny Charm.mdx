...
- If you aren't using PCalc and don't know your egg seeds, try these methods.
  - If you've accepted or rejected eggs and don't want to use Homebrew or CFW, use the [127 Magikarp method](https://www.pokemonrng.com/retail-sm-egg-seed-no-cfw).
  - If you haven't interacted with the daycare and don't want to use Homebrew or CFW, try the [8 egg method](https://www.pokemonrng.com/retail-sm-egg-seed-no-cfw).
