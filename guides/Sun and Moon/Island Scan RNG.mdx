...
1. Follow the [timeline guide](https://www.pokemonrng.com/retail-sm-timeline) using the `NPC Count` from PCalc. Wait at least 30 seconds after opening the window to allow the NPC counter to calibrate.
