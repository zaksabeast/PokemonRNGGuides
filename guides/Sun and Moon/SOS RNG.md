...
- [Encounter slots Sun](https://gist.github.com/RichardPaulAstley/42fbabe24250969f22d18fe8b919c520)
- Encounter Slots for Moon are missing. However you should be able to figure out the differences without any issue. We'll try to provide a guide later.

```
Note: The screen you'll see below are based on USUM but SOS RNG for SM is exactly the same. Just use your profile and follow the guide without worrying about any difference!
```
