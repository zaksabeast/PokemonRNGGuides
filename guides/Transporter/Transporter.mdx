...
1. Change 3DSRNGTool's "Seed" to the Initial Seed PokeReader shows.
...
1. Search for the exact IVs PokeReader indicates using 3DSRNGTool to find your hit frame.
