...
3. In the Tick Range, enter a small number like 10.
4. In the Offset Range, enter a large number, like 50,000,000.
...
```
Note: If you find a result for Sun, Moon will have the same profile, so you can copy it for each game.
```
