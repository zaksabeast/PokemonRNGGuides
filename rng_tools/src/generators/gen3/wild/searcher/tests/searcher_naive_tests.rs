...
#[test]
fn test_search_wild3_naive_no_filter() {
...
#[test]
fn test_search_wild3_naive_with_filter() {
...
#[test]
fn test_search_wild3_naive_shiny() {
    let options = Wild3SearcherOptions {
...
#[test]
fn test_search_wild3_naive_synchronize() {
    let options = Wild3SearcherOptions {
        initial_seed: 0x14a22065,
        methods: vec![Gen3Method::Wild1],
        max_advances: 2,
...
#[test]
fn test_search_wild3_naive_all_methods() {
    let options = Wild3SearcherOptions {
        tid: 0x1234,
        sid: 0x4321,
        methods: vec![
...
#[test]
fn test_search_wild3_naive_hidden_power() {
    let options = Wild3SearcherOptions {
        methods: vec![Gen3Method::Wild1],
...
#[test]
fn test_search_wild3_naive_max_size() {
    let options = Wild3SearcherOptions {
        methods: vec![Gen3Method::Wild1],
...
#[test]
fn test_search_wild3_naive_debug() {
    let options = Wild3SearcherOptions {
        initial_seed: 0,
        tid: 0,
        sid: 0,
    ...
    let results = search_wild3_naive( &options);
