...
export const guides = {
  ...
  "/dppt-pokeradar-rng/": {
    meta: {
      ...
      guideGroupId: "en:false-PokéRadar RNG:Diamond, Pearl, and Platinum",
      guideVariantLinks: {
  ...
  "/zh-dppt-pokeradar-rng/": {
    meta: {
      ...
      guideGroupId: "zh:false-PokéRadar RNG:Diamond, Pearl, and Platinum",
      guideVariantLinks: null,
      displayAttributes: [],
    },
    Guide: React.lazy(
