...
export const guides = {
  ...
  "/fr-bdsp-advance-rng/": {
    meta: {
      ...
      description:
        "Comment les avances de RNG fonctionnent dans pokemon Diamand Etincelant et Perle Scintillante. Apprennez comment controler ces avances pour rencontrer des pokemon parfaits!",
