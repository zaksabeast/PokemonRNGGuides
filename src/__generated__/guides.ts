...
export const guides = {
  ...
  "/de-emerald-painting-rng/": {
    meta: {
      ...
      guideGroupId: "de:false-Painting RNG:Emerald",
      guideVariantLinks: null,
  ...
  "/emerald-painting-rng/": {
    meta: {
      ...
      guideGroupId: "en:false-Painting RNG:Emerald",
      guideVariantLinks: {
        retail: null,
  ...
  "/zh-emerald-painting-rng/": {
    meta: {
      ...
      guideGroupId: "zh:false-Painting RNG:Emerald",
      guideVariantLinks: null,
      displayAttributes: ["web_tool"],
    },
    Guide: React.lazy(
