export const guideMarkdown = `# Egg RNG Guide without Masuda and/or Shiny Charm

##### Guide contributed by [/u/Shiny_Sylveon]()
##### Edited by [/u/zaksabeast]() and other [contributors]()
...
> Note: You can use PCalc to check the egg's info. Press Start + Left to bring up Party View and then Select + Right to cycle through the different slots.`;
