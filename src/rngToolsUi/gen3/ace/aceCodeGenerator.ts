import { charset, isCodeAvailable } from "./aceBoxNameFormatter";
...
const certificateExit = (
  ...
  const variants: Record<EmeraldLang, ExitInstruction[]> = {
    English: [
    ...
    Japanese: [], // TODO : Support Japanese language.
  };
...
const getEmeraldBoxNamesForCommands = (
  ...
  return {
    success: true,
    raw_boxes: fitCodesIntoBoxes(commands, cs.lang),
  };
};
