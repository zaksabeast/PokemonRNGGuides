...
export const Wild3CycleAtMoments = ({ cycleAtMomentsFromTool }: Props) => {
  ...
  const uiResult = createUiResult(json, cycleAtMomentsFromTool);
  ...
  const resultFields: Field[] = [
    {
      ...
      input: `${uiResult.cycleAtSweetScent}`,
    },
    {
    ...
    {
      label: "Method hit estimated by Webtool",
