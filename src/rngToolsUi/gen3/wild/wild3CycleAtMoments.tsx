...
export const Wild3CycleAtMoments = ({ cycleAtMoments }: Props) => {
  ...
  const fields:Field[] = React.useMemo(() => {
    return [
      ...
      ...(displayDebuggingOptions ? [{
        label: <>
          Copy-paste the JSON generated by this <a href="https://raw.githubusercontent.com/RainingChain/pk_emu_scripts/refs/heads/main/Gen3/wild3_cycle_at_moments.lua">lua script</a> after a wild encounter to compare with the tool results.
        </>,
  ...
  return (
    <>
      ...
      {displayDebuggingOptions && <div>
        <strong>Use case:</strong> Detect when the tool miscalculates cycles and simplify its calibration by developpers. 
      </div>}
      {displayDebuggingOptions && <ResultTable<UiResultCycleAtMoment>
