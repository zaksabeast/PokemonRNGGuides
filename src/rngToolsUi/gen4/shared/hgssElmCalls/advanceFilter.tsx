...
import { Alert, type ResultColumn, RngToolForm } from "~/components";
...
import { ElmCallFilterButtons } from "./elmCallButtons";
import {
...
const getColumns = (t: Translations): ResultColumn<Result>[] => [
  ...
  },
  {
    title: t["Elm Calls"],
    dataIndex: "elm_call",
    render: (elmCall: ElmCall) => elmCall,
  },
];

export const HgssElmCallAdvanceFilter = () => {
