...
export const One = ({ x, y }: OneProps) => {
  return (
    <g transform={`translate(${x}, ${y})`}>
      ...
      <Pixel x={4} y={2} fill={colors.white2} />
      ...
      <Pixel x={4} y={4} fill={colors.white2} />

      <Pixel x={1} y={5} fill={colors.white2} />
      <Pixel x={2} y={5} fill={colors.black1} />
      <Pixel x={3} y={5} fill={colors.black1} />
      <Pixel x={4} y={5} fill={colors.white2} />
      ...
      <Pixel x={5} y={6} fill={colors.gray} />
      ...
      <Pixel x={5} y={7} fill={colors.white2} />
      ...
      <Pixel x={5} y={8} fill={colors.white2} />
      ...
      <Pixel x={5} y={9} fill={colors.gray} />
    </g>
  );
};
