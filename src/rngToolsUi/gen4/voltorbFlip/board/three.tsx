...
export const Three = ({ x, y }: ThreeProps) => {
  return (
    <g transform={`translate(${x}, ${y})`}>
      ...
      <Pixel x={3} y={4} fill={colors.black1} />
      <Pixel x={4} y={4} fill={colors.black1} />
      <Pixel x={5} y={4} fill={colors.black1} />
      <Pixel x={6} y={4} fill={colors.black1} />
      <Pixel x={7} y={4} fill={colors.white2} />

      <Pixel x={0} y={5} fill={colors.gray} />
      <Pixel x={1} y={5} fill={colors.white2} />
      ...
      <Pixel x={6} y={5} fill={colors.black1} />
      <Pixel x={7} y={5} fill={colors.white2} />
      ...
      <Pixel x={4} y={6} fill={colors.white2} />
      <Pixel x={5} y={6} fill={colors.black1} />
      <Pixel x={6} y={6} fill={colors.black1} />
      <Pixel x={7} y={6} fill={colors.white2} />
      ...
      <Pixel x={0} y={8} fill={colors.gray} />
      <Pixel x={1} y={8} fill={colors.white2} />
      ...
      <Pixel x={7} y={8} fill={colors.gray} />

      <Pixel x={1} y={9} fill={colors.gray} />
      ...
      <Pixel x={6} y={9} fill={colors.gray} />
    </g>
  );
};
