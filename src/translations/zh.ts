...
export const translations: Partial<Translations> = {
  ...
  November: "十一月",
  December: "十二月",
  "Lead PID Speed Calculator": "队首PID速度计算器",
  Fastest: "最快",
  Slowest: "最慢",
  "Very Fast": "非常快",
  Slow: "较慢",
  "Very Slow": "非常慢",
  Common: "普通速度",
  "Speed: {speed} cycles ({cycles})": "速度：{speed}周期（{cycles}）",
  "Faster than {percent} of PIDs": "超越了{percent}的 PIDs。",
  "Slower than {percent} of PIDs": "落后于{percent}的 PIDs。",
  "Lead PID": "队首 PID",
  "Is Target": "Is Target",
  Lead: "队首",
  "Min Advance": "最小帧数",
