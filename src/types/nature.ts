...
export const getNaturesFromStatMoreLess = (statMore:NatureStat | "", statLess:NatureStat | "") : Nature[] => {
...
export const getStatMoreLessFromNature = (nature:Nature) : [NatureStat | "", NatureStat | ""] => {
